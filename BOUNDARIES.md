...
When the current public validator does not cover the touched surface, use `ToS/doctrine/REVIEW_CHECKLIST.md` to review boundary-sensitive changes explicitly.
