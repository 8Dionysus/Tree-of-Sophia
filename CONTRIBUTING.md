...
When the touched surface falls outside that validator coverage, use `ToS/doctrine/REVIEW_CHECKLIST.md` as the manual validation route and include a short review note in the PR when the change is boundary-sensitive.
