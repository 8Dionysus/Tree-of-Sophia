...
move from TOS-D-0062 to TOS-D-0067: the landed TOS-D-0062 identifies independent
software, corpus and integration releases. Only identity metadata and current
references change; rationale, original date, acceptance and temporal semantics
remain unchanged. The prior path remains in commit
`7f59dc9147690f767e332a41dcd1503c996bbed0`.
