...
TOS-D-0043 made graph composition backend-defined, but native source kinds and
...
- Extends TOS-D-0043's backend-defined LensSpec with stable semantic types and
