# TOS-D-0065 Bounded Segmented KAG Provider Pin

## Index Metadata

- Decision ID: TOS-D-0065
...
move from TOS-D-0060 to TOS-D-0065: the landed TOS-D-0060 identifies the
backend-defined knowledge lenses decision. Only identity metadata and current
references change; the original rationale, date and acceptance are preserved.
