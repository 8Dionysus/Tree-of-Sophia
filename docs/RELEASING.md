...
| `aoa-kag` → `Tree-of-Sophia` | `aoa-kag@v0.5.0`, commit `9150326d7a7ea1cb54714064979affc7d42c7dbd` | `8Dionysus/aoa-kag/.github/actions/repo-local-kag-index@25cd6263ae2c860c58f86cf3a0747f2070eb45ff` | Keep the published provider body and workflow action as distinct immutable identities; the current compatibility guard proves their separate ABI roles. |
