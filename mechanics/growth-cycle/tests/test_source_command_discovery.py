...
class SourceCommandDiscoveryTests(unittest.TestCase):
    def test_catalogue_is_the_exact_connected_handler_grammar(self):
        ...
        self.assertEqual(schemas, {
            ...
            *source.PROFILE_CREATION_CONFIGS, *source.CORPUS_CREATION_CONFIGS, *source.CLAIM_FORM_CONFIGS,
            *source.CANONICAL_FORM_CONFIGS,
            source.REVISION_CONFIG, *source.PROFILE_REVISION_CONFIGS, source.CORPUS_REVISION_CONFIG,
