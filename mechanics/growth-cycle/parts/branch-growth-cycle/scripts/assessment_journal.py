                ...
                with os.fdopen(descriptor, 'rb') as stream:
                    ...
                    while True:
                        ...
                        if len(line) > MAX_RECORD_BYTES:
                            # The total carrier budget also accounts for
                        ...
                        if family is None:
                            continue  # Opaque neighboring records remain uninterpreted.
                        identity, version = family
                        # Validate known identity envelopes and duplicates throughout
                        # the bounded carrier without retaining unselected payloads.
