# Exact local source intake — Vitae philosophorum

Inspected: 2026-09-08T23:48:48.081061+00:00

Version: `PerseusDL/canonical-greekLit@341e309c821d5eca8c976bebca77c28b10bad58f`.

The 1 original files (1660224 bytes) match the prepared Git blob identities and sizes. The Item manifest records computed SHA-256. The files were opened and parsed locally; source bytes and code-point order were preserved.
...
Supplied title and contributor statement: Βίοι καὶ γνῶμαι τῶν ἐν φιλοσοφίᾳ εὐδοκιμησάντων Diogenes Laertius R. D. Hicks Gregory Crane Prepared under the supervision of Bridget Almas Lisa Cerrato Rashmi Singhal National Endowment for the Humanities Division of Preservation and Access. Preserve the exact source header; its claims remain reported.
