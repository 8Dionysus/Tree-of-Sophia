# Exact local source intake — On Oratory

Inspected: 2026-09-09T06:45:12.613550+00:00

Version: `PerseusDL/canonical-latinLit@8668397510ca77fec6406f7d48f405e50d296764`.

The 1 original files (566202 bytes) match the prepared Git blob identities and sizes. The Item manifest records computed SHA-256. The files were opened and parsed locally; source bytes and code-point order were preserved.
...
Supplied title/contributor statement: De Oratore M. Tullius Cicero Augustus Samuel Wilkins Perseus Project, Tufts University Gregory Crane Prepared under the supervision of Bridget Almas Lisa Cerrato Anne Mahoney David Smith Clifford Wulfman National Endowment For The Humanities (NEH). Claims remain reported; preserve exact header.
