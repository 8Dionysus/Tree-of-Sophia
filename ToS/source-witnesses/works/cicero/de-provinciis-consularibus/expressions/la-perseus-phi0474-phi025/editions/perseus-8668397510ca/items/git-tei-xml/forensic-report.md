# Exact local source intake — De Provinciis Consularibus

Inspected: 2026-09-09T21:30:36.101238+00:00

Version: `PerseusDL/canonical-latinLit@8668397510ca77fec6406f7d48f405e50d296764`.

The 1 original files (62787 bytes) match the prepared Git blob identities and sizes. The Item manifest records computed SHA-256. The files were opened and parsed locally; source bytes and code-point order were preserved.
...
Supplied title/contributor statement: De Provinciis Consularibus In Senatu M. Tullius Cicero William Peterson Perseus Project, Tufts University Gregory Crane Prepared under the supervision of Bridget Almas Lisa Cerrato William Merrill David Mimno Rashmi Singhal David Smith Michael Konieczny Digital editor National Endowment For The Humanities (NEH). Claims remain reported; preserve exact header.
