# Exact local source intake — Greater Hippias

Inspected: 2026-09-09T06:16:05.315818+00:00

Version: `PerseusDL/canonical-greekLit@341e309c821d5eca8c976bebca77c28b10bad58f`.

The 1 original files (100198 bytes) match the prepared Git blob identities and sizes. The Item manifest records computed SHA-256. The files were opened and parsed locally; source bytes and code-point order were preserved.
...
Supplied title/contributor statement: Hippias Major Plato Harold North Fowler Perseus Project, Tufts University Gregory Crane Prepared under the supervision of Lisa Cerrato William Merrill Elli Mylonas David Smith The Annenberg CPB/Project. CTS translation description: Plato in Twelve Volumes, Vol. 4. Fowler, Harold North, translator. Lamb, W.R.M, editor. Cambridge, MA: Harvard University Press; London: William Heinemann Ltd. 1926 (printing).
