...
The packet follows exactly:

1. exact form;
2. frequency and concordance;
3. context;
4. morphology;
5. lemma;
6. recurrence within the section;
7. recurrence within the work;
8. recurrence within Nietzsche's corpus;
9. translation correspondences;
10. stable-sign candidate;
11. real-human confirmation or rejection;
12. relations between signs;
13. conceptual interpretations;
...
Before a human confirms a stable sign, the review must address:

- Does Nietzsche return to the form beyond raw frequency?
- Does its force change across contexts?
- Is there metaphorical development or a compositional role?
- Do translations expose a stable tension or only translator preference?
- Do negation, inversion, irony, or contrast destabilize the proposed unity?
- What other sign relations are evidenced, and which are merely attractive?
...
A later graph is a rebuildable read model over stronger occurrence, claim,
review, and decision records. It cannot be the only copy of a relation and
cannot become authority merely because its schema validates.
