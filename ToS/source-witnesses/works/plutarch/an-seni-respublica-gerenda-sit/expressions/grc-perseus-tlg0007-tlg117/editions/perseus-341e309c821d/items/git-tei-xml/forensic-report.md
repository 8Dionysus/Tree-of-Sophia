# Exact local source intake — An seni respublica gerenda sit

Inspected: 2026-09-09T16:45:12.316046+00:00

Version: `PerseusDL/canonical-greekLit@341e309c821d5eca8c976bebca77c28b10bad58f`.

The 1 original files (143259 bytes) match the prepared Git blob identities and sizes. The Item manifest records computed SHA-256. The files were opened and parsed locally; source bytes and code-point order were preserved.
...
Supplied title and contributor statement: Εἰ πρεσβυτέρῳ πολιτευτέον Plutarch Grēgorios N. Vernardakēs Perseus Project, Tufts University Gregory Crane Prepared under the supervision of Lisa Cerrato Rashmi Singhal Bridget Almas The National Endowment for the Humanities Angelia Hanhardt Center for Hellenic Studies CTS conversion Michael Konieczny Center for Hellenic Studies CTS conversion. Preserve the exact source header; its claims remain reported.
