# Exact local source intake — De Tranquillitate Animi

Inspected: 2026-09-09T16:37:37.698171+00:00

Version: `PerseusDL/canonical-greekLit@341e309c821d5eca8c976bebca77c28b10bad58f`.

The 1 original files (118858 bytes) match the prepared Git blob identities and sizes. The Item manifest records computed SHA-256. The files were opened and parsed locally; source bytes and code-point order were preserved.
...
Supplied title and contributor statement: Περὶ εὐθυμίας Plutarch Grēgorios N.Vernardakēs Perseus Project, Tufts University Gregory Crane Prepared under the supervision of Lisa Cerrato Rashmi Singhal Bridget Almas Angelia Hanhardt The National Endowment for the Humanities Karina Cooper Center for Hellenic Studies CTS conversion. Preserve the exact source header; its claims remain reported.
