# Exact local source intake — Sāmaññaphala Sutta (DN 2)

Inspected: 2026-09-08T21:20:18.257868+00:00

Version: `suttacentral/bilara-data@d6d54741b7f2ddfeca82f02c3f95eb3990b4e351`.

The 1 original files (88116 bytes) match the prepared Git blob identities and sizes. The Item manifest records computed SHA-256. The files were opened and parsed locally; source bytes and code-point order were preserved.
...
The Dhamma Society prepared the Mahāsaṅgīti edition; Ven. Yuttadhammo preserved and supplied its XML; SuttaCentral maintains the supplied structure, markup and punctuation. No modern actor is asserted to be the ancient author.
