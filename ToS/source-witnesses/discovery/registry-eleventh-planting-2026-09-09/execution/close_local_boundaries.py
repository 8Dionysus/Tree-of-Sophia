...
src=root/'ToS/source-witnesses'; base=src/'discovery/registry-eleventh-planting-2026-09-09'
...
for target in manifest['targets']:
 ...
 eventid='tos.event.server-import-plan.registry-20260909.'+target['slug']
