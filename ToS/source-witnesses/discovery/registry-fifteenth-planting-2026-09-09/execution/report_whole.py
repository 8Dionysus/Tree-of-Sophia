...
assert len(rows)==401 and new_bytes==1939204
whole={'completed_at':datetime.now(timezone.utc).isoformat(),'scope':'Two stages of the fifteenth planting: 401 new Pali versions and 401 English Sujato translations, sharing 401 newly created Work identities','stage_results':['batch-result.json','translations/batch-result.json'],'new_works':401,'new_versions':802,'new_files':802,'new_bytes':new_bytes,'paired_works':401,'reused_Pali_versions':0,'pairs':rows,'deferred_files_ref':'deferred-files.json','source_text_admitted':False,'translation_quality_assessed':False,'semantic_alignment_admitted':False,'public_payload_delivery':False,'AI_derivative_use_admitted':False}
(BASE/'whole-batch-result.json').write_text(json.dumps(whole,ensure_ascii=False,indent=2)+'\n')
lines=['# Пятнадцатая поставка: Самъютта-никая SN 12–22','','**802 новые версии, 802 файла, 1 939 204 байт.** Добавлено 401 новое произведение. Каждое произведение представлено на пали и в английском переводе Суджато.','','Это 401 отдельно обозначенная сутта из SN 12–22 выбранной цифровой редакции. Шесть групповых UID (12 файлов двух языков) отложены до отдельного описания состава; полнота SN 12–22 не заявлена. Оно не означает полноту древней устной традиции, всех редакций или Āgama-параллелей.','','| UID | Палийское название | Английское название | Обе версии |','| --- | --- | --- | --- |']
