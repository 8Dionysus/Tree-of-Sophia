...
def main():
    ...
    for target in manifest['targets']:
        for kind in ('work', 'expression', 'edition', 'item'):
            ...
            if created:
                ...
                command_id = 'registry-fifteenth-pali-source-forms:'+key
    ...
    result={'scope':'Only the exact four corpus records per fifteenth-pali-stage target; source-copy wording via owner describe/prepare/apply, no semantic admission',
