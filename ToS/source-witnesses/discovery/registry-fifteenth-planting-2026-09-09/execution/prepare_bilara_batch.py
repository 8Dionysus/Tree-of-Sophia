...
def prepare(translated):
    ...
    if translated:
        ...
        if len(existing)!=401:raise ValueError('Pali Work closure incomplete')
    ...
    for row in rows:
        ...
        limits=['Grouped UID carriers sn12.72-81, sn12.83-92, sn12.93-213, sn17.13-20, sn17.38-43 and sn18.12-20 are explicitly deferred; this batch does not complete SN12–22.',
    ...
    branch_ref='ToS/philosophy/source-planting-preparation/early-buddhist-sn12-22-'+('translations' if translated else 'pali')+'-20260909.json'
