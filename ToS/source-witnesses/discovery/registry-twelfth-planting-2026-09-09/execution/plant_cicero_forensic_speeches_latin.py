...
base=root/'ToS/source-witnesses/discovery/registry-twelfth-planting-2026-09-09'
manifest=json.loads((base/'manifest.json').read_text())
plans={x['target_slug']:x for x in json.loads((root/'ToS/philosophy/source-planting-preparation/cicero-forensic-speeches-latin-20260909.json').read_text())['targets']}
