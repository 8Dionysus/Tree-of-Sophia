...
def report(completed):
    ...
    lines.extend(['', '## Границы', '',
        'Циклы речей, собрания писем и альтернативные версии отложены до отдельного разбора идентичности. Для Cum Populo Gratias Egit сохранено расхождение дат: CTS 1911, TEI 1909.', '',
