...
def main():
    ...
    result={'scope':'Only the exact four corpus records per thirteenth-English-wave target; source-copy wording via owner describe/prepare/apply, no semantic admission',
