...
The current preparation routes follow the early Buddhist Nikaya branch and language roles; the reviewed navigation migration and exact historical receipt bytes are recorded in [the current migration record](path-migration.current.json).
