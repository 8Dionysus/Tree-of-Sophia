...
base=root/'ToS/source-witnesses/discovery/registry-fourth-planting-2026-09-09'
manifest=json.loads((base/'manifest.json').read_text())
plans={x['target_slug']:x for x in json.loads((root/'ToS/philosophy/source-planting-preparation/ancient-mediterranean-english-translations-20260909.json').read_text())['targets']}
for target in manifest['targets']:
 ...
 greek=root/parallel['reading_route']; prior=greek.read_text(); marker='## English translation added 2026-09-09'
