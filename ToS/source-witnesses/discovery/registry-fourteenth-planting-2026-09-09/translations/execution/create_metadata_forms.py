...
def main():
    ...
    for target in manifest['targets']:
        for kind in ('work', 'expression', 'edition', 'item'):
            ...
            if created or stale:
                ...
                command_id = 'registry-fourteenth-English-source-forms:'+key
    ...
    result={'scope':'Only the exact four corpus records per early-buddhist-sn1-11-translations target; source-copy wording via owner describe/prepare/apply, no semantic admission',
