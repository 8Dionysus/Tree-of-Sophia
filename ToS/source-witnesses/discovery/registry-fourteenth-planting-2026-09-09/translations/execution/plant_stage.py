...
for target in manifest['targets']:
 ...
 extra_limits=[]
 if target['coverage']['uid']=='sn10.6':extra_limits.append('Observed source discrepancy at sn10.6:1.1: Pali names Anuruddha, English names Sariputta; the next segment names Anuruddha in both. Both supplied versions remain unchanged; no verified translation alignment.')
