...
src=root/'ToS/source-witnesses'; base=src/'discovery/registry-second-planting-2026-09-08'
...
for target in manifest['targets']:
 ...
 eventid='tos.event.server-import-plan.registry-20260908.'+target['slug']
