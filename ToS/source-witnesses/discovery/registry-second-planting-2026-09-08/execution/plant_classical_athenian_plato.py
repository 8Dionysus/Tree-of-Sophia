...
base=root/'ToS/source-witnesses/discovery/registry-second-planting-2026-09-08'
manifest=json.loads((base/'manifest.json').read_text())
plans={x['target_slug']:x for x in json.loads((root/'ToS/philosophy/source-planting-preparation/classical-athenian-plato-works-20260908.json').read_text())['targets']}
