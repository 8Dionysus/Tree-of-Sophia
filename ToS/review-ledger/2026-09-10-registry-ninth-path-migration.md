# Registry ninth navigation path migration — 2026-09-10

## Scope and owner review

Reviewed the current preparation and execution navigation for **Plutarch Moralia English preparation and execution** against parent `d5c034871722b041f9966d5857f12703994ed23e`. Current route names identify the source branch or corpus together with the language or version role; ordinal sequence labels remain historical provenance.

The source owner records this as a navigation migration in [the current migration record](../source-witnesses/discovery/registry-ninth-planting-2026-09-09/path-migration.current.json). The archive record at `ToS/source-witnesses/discovery/registry-ninth-planting-2026-09-09/legacy/path-migration.json` retains the exact prior preparation inputs, execution bytes and checkpoint receipts, including their original manifest digests, preparation commits and review references. No source record ID, Work/Expression/Edition/Item relation, payload byte, rights assessment, translation, semantic claim, publication state or canon state was rewritten.
...
- `source-preparation`: `ToS/philosophy/source-planting-preparation/plutarch-moralia-english-20260909.json` (SHA-256 `ab13199220d190b6396360a72b0ecc49a7e6e9ebbc61a63c78b27e91c0c67ea5`).
- `planting-execution`: `ToS/source-witnesses/discovery/registry-ninth-planting-2026-09-09/execution/plant_plutarch_moralia_english.py` (SHA-256 `e791633091893a95a16eaa4cd5fb29ec46b9bfbc92086d8459a637504b8f058e`).
- `report-execution`: `ToS/source-witnesses/discovery/registry-ninth-planting-2026-09-09/execution/report_plutarch_moralia_english.py` (SHA-256 `f9fd3475a8c2e888b077d3e6a9f1557f471d2bf1085da076c0d4b1080cd94b65`).
...
- `ToS/source-witnesses/discovery/registry-ninth-planting-2026-09-09/manifest.json` binds SHA-256 `825636d96ea5dc51017d7e789e07879675912ea34d95b67cc3bde78bc86510df` and retains historical manifest SHA-256 `264ad6901ebed243b10d949b3f8d7c0c7b9e783df12e371d6ebca9344f4234e3`.
