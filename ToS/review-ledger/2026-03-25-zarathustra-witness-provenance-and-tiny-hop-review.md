...
- updated `ToS/doctrine/NODE_CONTRACT.md`, `ToS/doctrine/SOURCE_NODE_TEMPLATE.md`, and `ToS/doctrine/ZARATHUSTRA_TRILINGUAL_ENTRY.md` so source witness, published translation, and maintainer-curated witness can stay distinguishable
- updated `ToS/doctrine/REVIEW_CHECKLIST.md` to test witness-provenance legibility during manual review
