...
- added `ToS/doctrine/TINY_ENTRY_ROUTE.md` as the first public doctrine note for the tree-first tiny-entry seam
- added `ToS/contracts/tos-tiny-entry-route.schema.json` and `ToS/public-compatibility/tos_tiny_entry_route.example.json`
- reframed `ToS/doctrine/ZARATHUSTRA_TRILINGUAL_ENTRY.md` as the first worked capsule for the tiny-entry seam
- updated `README.md`, `ROADMAP.md`, and `ToS/doctrine/KNOWLEDGE_MODEL.md` so the tiny-entry route is visible in the public entry path
- updated `ToS/doctrine/REVIEW_CHECKLIST.md` with tiny-entry-specific manual review items
...
- `yes` `ToS/doctrine/ZARATHUSTRA_TRILINGUAL_ENTRY.md` now acts as a worked capsule without replacing `ToS/public-compatibility/source_node.example.json` as the authority surface
...
- 2026-03-24: the downstream `aoa-kag` and `aoa-routing` syncs for this public seam have since landed; see `ToS/review-ledger/2026-03-24-tiny-entry-downstream-consumption-review.md`
