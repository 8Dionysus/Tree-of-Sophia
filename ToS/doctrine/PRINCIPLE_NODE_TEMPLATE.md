...
- a raw row lifted unchanged from `ToS/candidate-intake/principles.csv`
...
- one bounded principle family under `ToS/canon/principle/`
- one worked example mirrored into `ToS/public-compatibility/principle_node.example.json`
