...
фильтрации и пагинации. Потребление этой карты владельцем UI, лишний шаг
между носителями и компактный проход Claim ещё требуют работы; это не
завершённый содержательный фокус.
