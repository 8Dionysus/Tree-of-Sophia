...
| A02 · G4 | валидация, содержательная оценка, полномочие и текущий допуск различны | Assessment/Growth → admit, limit, reject, dispute, defer | область допуска, оценщик, основания и ограничения | [три реальных scholarly_report Claim](../review-ledger/2026-09-08-real-source-assessment-review.md) получили ограниченный research admission через source-bound local-account adapter без отдельной human подписи; это не remote authentication, общий допуск или publication; **есть часть** |
| A03 · G4 | риск, язык, задача, метод, модель и независимость | Assessment → qualified reusable grant, audit | область компетенции и предел вывода | [пять guided source-observation случаев и узкий временный grant](../review-ledger/2026-09-08-real-source-assessment-review.md) привязаны к реальному reviewer/configuration; 20 формулировок не 20 независимых случаев, одна модельная группа и один documentary origin сохранены. Общая языковая компетенция и drift sampling не доказаны; **есть часть** |
| A04 · M19, G4/G7 | отзыв, supersession, конфликт и история знания | Assessment/Growth/Processing → revoke, reassess dependencies | история, спор и последствия отзыва | [реальный own-decision цикл](../review-ledger/2026-09-08-real-source-assessment-review.md): допуск → административный отзыв → новое чтение и новая оценка; три неизменяемых события, старый receipt/конфигурация не воскрешают допуск. Это не систематическая смысловая ошибка и не проверка всех dependent consumers; **есть часть** |
...
| A06 · G4/G11 | реальное качество и доля необходимого участия человека | Assessment → task/language evaluation, sampled audit | измеримые ошибки, возражения и эскалации | [реальная оценка и допуск трёх существующих Claim](../review-ledger/2026-09-08-real-source-assessment-review.md): полный source audit без найденного расхождения, 0 per-record human approvals, 7 запрещённых запросов отклонены, точный replay не дублирует историю; собственный допуск реально отозван и заменён новой source-оценкой. Это overlapping-source срез, не population accuracy/intervention rate; более широкое качество, рост и consumers ещё нужны; **есть часть** |
...
сохранены как предложения и возвращают `needs-assessment`, без поддельного
review. [Локальная сборка оценённых форм](../review-ledger/2026-09-07-assessed-graph-reader-review.md)
теперь соединяет тот же журнал с обеими существующими проекциями и общим
читателем; смешанные оценки между носителями отвергаются. Реальные формы
пока остаются непроверенными. Реальный допуск оценщика, содержательное
качество, публичная поставка и подключение runtime ещё не выполнены.
