...
| F07 · M19, G2/G7 | байты, OCR, коррекция, нормализация, сегментация, выравнивание, интерпретация и проекция | Corpus/Processing → derive, inspect lineage, invalidate | исходник и отдельные преобразования | [Созданы реальный TextLayer и первый TextUnit](../review-ledger/2026-09-09-native-text-layer-quality-review.md) с точным acquired File/member/selector, policy/configuration и неизменными исходными байтами; оба CLI-повтора сохранили receipts. Отдельное v5 сравнение с источником и текущий quality basis не подменяют raw layer или содержательную оценку; границы механики дополнительно проверены синтетически. Реальный допуск, OCR/коррекция и остальные профили преобразования ещё не закрыты; **есть часть** |
...
| A02 · G4 | валидация, содержательная оценка, полномочие и текущий допуск различны | Assessment/Growth → admit, limit, reject, dispute, defer | область допуска, оценщик, основания и ограничения | [Policy v3 и private v5](../review-ledger/2026-09-09-native-text-layer-quality-review.md) отделяют доступное сравнение TextLayer от положительного допуска для конкретной цели; отказ/withdrawal возможны при доступных точных основаниях, metadata-only не разрешает оценку. [Три реальных scholarly_report Claim](../review-ledger/2026-09-08-real-source-assessment-review.md) и [две точные RU/EN metadata human forms](../review-ledger/2026-09-09-real-human-form-assessment-review.md) получили отдельные ограниченные research admissions через source-bound local-account adapter без per-record human подписи. [Реальный native citation/observation-пакет](../review-ledger/2026-09-09-real-native-quality-assessment-review.md) добавил ограниченные agent admissions для TextLayer и source-markup TextUnit после source-visible проверки; это не semantic/linguistic, rights, public или canon admission. Слой, процедуры и полномочия не объединены; это не remote authentication, общий допуск или publication. Обязательная ручная подпись не добавлена; реальная компетенция и source-visible допуск требуют отдельного подтверждения; **есть часть; расширенный допуск в работе** |
| A03 · G4 | риск, язык, задача, метод, модель и независимость | Assessment → qualified reusable grant, audit | область компетенции и предел вывода | [guided source-observation](../review-ledger/2026-09-08-real-source-assessment-review.md) и отдельный [RU/EN metadata trial](../review-ledger/2026-09-09-real-human-form-assessment-review.md) привязаны к реальному reviewer/configuration и узким временным grants. Во втором — 16 формулировок в восьми семьях и два запроса к отсутствующему тексту; один correlated model group. [Native English calibration](../review-ledger/2026-09-09-real-native-quality-assessment-review.md) содержала 12 source-visible cases: 11 labels совпали буквально, один был принят только после проверки сохранённого различия; maker и assessor были раздельны, но источник и исполнение оставались одной correlated model family. Серии вызовов/копии источника не умножают оснований; калибровка и дрейф проверены; это не общая точность или ancient-language компетенция, более широкая квалификация ещё нужна; **есть часть; расширенная квалификация в работе** |
| A04 · M19, G4/G7 | отзыв, supersession, конфликт и история знания | Assessment/Growth/Processing → revoke, reassess dependencies | история, спор и последствия отзыва | [реальный Claim lifecycle](../review-ledger/2026-09-08-real-source-assessment-review.md) и [цикл RU human form](../review-ledger/2026-09-09-real-human-form-assessment-review.md) сохраняют допуск → административный отзыв → новое чтение/оценку. [Точная область исторического решения и текущие зависимости качества](../review-ledger/2026-09-09-native-text-layer-quality-review.md) проверены через restart/revocation/withdrawal/reassessment. [Native recovery review](../review-ledger/2026-09-09-real-native-quality-assessment-review.md) отдельно показывает withdrawal слоя, stale dependent unit, новые source-visible bases и раздельное восстановление; старые positive retries не вернули допуск. Старый receipt не воскрешает допуск; обе form-проекции снимают RU wording, EN не меняется, устаревшая сборка отвергается; поздняя конфигурация не меняет committed scope, новая оценка слоя не воскрешает старую оценку Claim/формы. Это не систематическая смысловая ошибка или проверка всех dependent consumers; реальная содержательная серия и остальные processing-зависимости ещё нужны; **есть часть; полное покрытие в работе** |
...
| A06 · G4/G11 | реальное качество и доля необходимого участия человека | Assessment → task/language evaluation, sampled audit | измеримые ошибки, возражения и эскалации | [три реальных Claim](../review-ledger/2026-09-08-real-source-assessment-review.md) и [RU/EN metadata forms](../review-ledger/2026-09-09-real-human-form-assessment-review.md) прошли source-visible оценку и полный issuer audit без найденного расхождения; [реальный native citation/observation-пакет](../review-ledger/2026-09-09-real-native-quality-assessment-review.md) добавляет пять substantive proposals, четыре committed decisions, одну исправленную до append ошибку и отдельный административный withdrawal; новых human approvals для этих решений не потребовалось. Per-record human approvals — 0 в этих пакетах, не population intervention rate; native counts не являются held-out accuracy или общей error-rate оценкой. Проверены ограниченный допуск, отказ, replay, реальный отзыв/новая оценка и две form-проекции. Более широкие языки/задачи, систематические ошибки и полноценное UI-потребление ещё нужны; **есть часть** |
