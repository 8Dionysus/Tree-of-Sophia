...
| M01 · G8 | прямое отображение, адаптер, уточнение, неизвестность, ограничение | Corpus/Processing → shadow migration, classify remainder | статус каждого объекта и следующий владелец | native artifact v1/v2 и [все десять существующих scholarly-composite v1](../review-ledger/2026-09-07-native-composites-and-reader-review.md) сохраняются целиком через адаптеры общего читателя; ID и исходные записи не переписаны. Формы/оценка native-композитов, универсальная карта остатка и миграции остальных семейств ещё нужны; **есть часть** |
