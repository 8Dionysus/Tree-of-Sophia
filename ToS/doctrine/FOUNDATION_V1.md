...
предела 200 до 9 носителей (7 предметов). Два дублирующих носителя одного ID
и лишний шаг между ними ещё мешают сцене и требуют следующего изменения
контракта представления; это не завершённый содержательный фокус.
