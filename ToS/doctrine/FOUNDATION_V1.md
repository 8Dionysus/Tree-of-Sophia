...
| B01 · M19/M22/M25 | интеллектуальный объект, произведение, замысел, черновик, редакция, языковое выражение | Corpus/Registry → work/version/expression profile | что за объект и какая реализация | [De constantia создано штатной командой](../review-ledger/2026-09-07-intellectual-formations-and-reader-review.md) как начальный Work с формами и отдельными Claim авторства/интеллектуального выражения, без выдуманных Expression/Edition/Item. Исправление записи не новая редакция; общие транзакции связанных библиографических слоёв ещё нужны; **есть часть** |
