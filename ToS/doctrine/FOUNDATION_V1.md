...
Исторические отметки K1/K2 ниже читаются вместе с этим продолжением, не как
требование повторить достаточные проверки. Итоговая сверка всех 57 строк и
K1–K4 ещё не объявлена завершённой.
