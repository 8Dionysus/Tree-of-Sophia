...
| L03 · M12/M15/M25 | знак, этимология, семантический диапазон, переводимость, мотив, изменение употребления | Registry/Assessment → linguistic comparison | альтернативные разборы и основания | **частично**: шесть отдельных предикатов лексической истории, когнатности и переводного соответствия исполняются общей грамматикой Claim/форм/исправления; реальные 3 Lexeme и 2 Sense по Duden связаны четырьмя предварительными Claims, точный повтор и ограниченное чтение проверены ([проверка](../review-ledger/2026-09-08-lexical-comparison-review.md)). Знак, ограниченный результат переводимости, мотив/изменение употребления и подтверждённая компетентная оценка ещё требуют работы. Текущий UI не потребляет готовые полные формы; кодовый пробел отделён от успешного backend-чтения |
