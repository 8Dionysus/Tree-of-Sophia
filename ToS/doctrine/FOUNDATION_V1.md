...
| B03 · M19 | фрагмент, утраченное произведение, сохранённая цитата, реконструкция | Corpus/Assessment → preserved-in, cites, reconstruct | что сохранилось и что реконструировано | **есть часть**: textual_survival исполняется как отдельное типизированное значение Claim через общий create/revise/read/form-контур с делегированием v3; реальная поэма Парменида сохраняет Work ID и отдельное сообщение о фрагментарной сохранности по Палмеру ([источник](../review-ledger/2026-09-07-parmenides-survival-source-reading.md)); самостоятельные профили фрагмента, цитаты, реконструкции и полный связанный маршрут ещё нужны |
