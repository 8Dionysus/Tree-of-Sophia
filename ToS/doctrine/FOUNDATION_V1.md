...
| P01 · M19/M22 | человек, коллектив, сообщество, учреждение, школа, традиция, движение | Registry → people/social profile, membership | разные виды объединений и область членства | Agent и новые SocialGroup/Community/InstitutionalBody имеют создание, формы и источник; лейпцигское общество, Венский кружок и университеты не сливаются с местом или atlas-категорией. [Проверены полный читатель и оба носителя форм](../review-ledger/2026-09-07-social-profiles-and-reader-review.md). Школа, традиция и движение ещё требуют собственных профилей; **есть часть, реальный корпус связан** |
...
| P03 · M22/M25 | обучение, учитель/ученик, сотрудничество, переписка, дружба, конфликт | Registry/Assessment → social/intellectual paths | конкретная связь, время и основания | восемь конкретных социальных предикатов требуют основания, область и временную оговорку; [реальный читатель проверен](../review-ledger/2026-09-07-social-profiles-and-reader-review.md) на обучении/преподавании Ницше, его отношениях и участниках Венского кружка. Социальная близость не становится влиянием; точная временная алгебра, независимая оценка и полнота контекста ещё нужны; **есть часть, реальный корпус связан** |
