...
| B04 · M19/M25 | рукопись, бумага, почерк, носитель, устная речь, аудио/видео, цифровой файл | Corpus/Registry → material/representation profile | точный материальный и цифровой объект | 18 существующих artifact v1/v2 подключены через точный адаптер catalog/graph/access без новых ID или придуманных связей; скан/OCR не становятся новыми произведениями; полные формы, growth и документ/носитель ещё нужны; **есть часть** |
