...
| M01 · G8 | прямое отображение, адаптер, уточнение, неизвестность, ограничение | Corpus/Processing → shadow migration, classify remainder | статус каждого объекта и следующий владелец | [Source-first карта](../review-ledger/2026-09-09-source-projection-coverage-review.md) перечисляет все 665 текущих публично каталогизированных идентичностей: 631 прямое отображение, 28 native-адаптеров, 5 legacy Link-Claims требуют полного контекста, 1 Collection обнаруживает устаревший второй носитель. Каждая запись имеет точный source/digest, различия полей и следующего владельца; фильтр потребителя не определяет полноту каталога. [28 native-свидетелей](../review-ledger/2026-09-07-native-witness-forms-and-assessment-input-review.md) имеют 56 source-copy форм и точный вход для оценки без выведенного языка или автоматического допуска. Это не карта всего некаталогизированного/закрытого корпуса, исторических версий или качества форм; остаток и интеграция сохраняют явные границы; **есть часть** |
