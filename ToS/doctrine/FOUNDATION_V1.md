...
| F07 · M19, G2/G7 | байты, OCR, коррекция, нормализация, сегментация, выравнивание, интерпретация и проекция | Corpus/Processing → derive, inspect lineage, invalidate | исходник и отдельные преобразования | [Созданы реальный TextLayer и первый TextUnit](../review-ledger/2026-09-09-native-text-layer-quality-review.md) с точным acquired File/member/selector, policy/configuration и неизменными исходными байтами; оба CLI-повтора сохранили receipts. Отдельное v5 сравнение с источником и текущий quality basis не подменяют raw layer или содержательную оценку; границы механики дополнительно проверены синтетически. [Реальные отдельные citation, semantic-quality, Claim и Form решения](../review-ledger/2026-09-09-real-native-semantic-form-assessment-review.md) сохраняют raw слои и текущие scope; обычное assessed чтение формы проверено. OCR/коррекция и остальные профили преобразования ещё не закрыты; **есть часть** |
...
| R04 · M15 | переопределение, отвержение, сужение, расширение, секуляризация, психологизация, политизация, инверсия | Registry/Assessment → compare transformations | направленное преобразование трактовок | **частично**: восемь отдельных нетранзитивных предикатов Conception → Conception, источник/statement/relation_basis, прямое и обратное чтение, общий claims.create и проверки; [реальная квалифицированная инверсия JGB 21](../review-ledger/2026-09-09-jgb21-inversion-growth-review.md) создана с точной английской формой, отказом устаревшего входа, повтором и двусторонним чтением. Это сравнение критикуемых трактовок, не endorsement или хронология; оценка и реальные остальные преобразования ещё нужны |
...
| A02 · G4 | валидация, содержательная оценка, полномочие и текущий допуск различны | Assessment/Growth → admit, limit, reject, dispute, defer | область допуска, оценщик, основания и ограничения | [Policy v3 и private v5](../review-ledger/2026-09-09-native-text-layer-quality-review.md) отделяют доступное сравнение TextLayer от положительного допуска для конкретной цели; отказ/withdrawal возможны при доступных точных основаниях, metadata-only не разрешает оценку. [Три реальных scholarly_report Claim](../review-ledger/2026-09-08-real-source-assessment-review.md), [две точные RU/EN metadata human forms](../review-ledger/2026-09-09-real-human-form-assessment-review.md) и [отдельные semantic-quality, interpretation и contextual Form решения](../review-ledger/2026-09-09-real-native-semantic-form-assessment-review.md) прошли разные ограниченные research scopes через source-bound local-account adapter; native citation/observation получил отдельные agent admissions после source-visible проверки. Допуск формы не endorsement Claim; слой, процедуры и полномочия не объединены, это не remote authentication, linguistic/rights/public/canon admission или publication; **есть часть, остальное в работе** |
| A03 · G4 | риск, язык, задача, метод, модель и независимость | Assessment → qualified reusable grant, audit | область компетенции и предел вывода | [guided source-observation](../review-ledger/2026-09-08-real-source-assessment-review.md), [RU/EN metadata trial](../review-ledger/2026-09-09-real-human-form-assessment-review.md) и [реальный английский citation/observation calibration](../review-ledger/2026-09-09-real-native-quality-assessment-review.md) привязаны к реальному reviewer/configuration и узким временным grants. Native calibration содержит 12 source-visible cases: 11 labels совпали буквально, одно различие принято после проверки сохранённого контекста; maker и assessor разделены, но источник и исполнение остаются одной correlated model family. Ошибочная языковая идентификация в первом production-предложении была исправлена до append; серии вызовов и копии источника не умножают основания, общей языковой/ancient-language точности и широкой drift-квалификации нет; **есть ограниченное подтверждение** |
| A04 · M19, G4/G7 | отзыв, supersession, конфликт и история знания | Assessment/Growth/Processing → revoke, reassess dependencies | история, спор и последствия отзыва | [реальный Claim lifecycle](../review-ledger/2026-09-08-real-source-assessment-review.md) и [цикл RU human form](../review-ledger/2026-09-09-real-human-form-assessment-review.md) сохраняют допуск → административный отзыв → новое чтение/оценку. [Точная область исторического решения и текущие зависимости качества](../review-ledger/2026-09-09-native-text-layer-quality-review.md) и [реальное восстановление слоя/фрагмента](../review-ledger/2026-09-09-real-native-quality-assessment-review.md) проверили stale dependent unit, новые source-visible bases и то, что старые positive retries не возвращают допуск. [Действительное истечение полномочий и новые отдельные Layer/Claim/Form решения](../review-ledger/2026-09-09-real-native-semantic-form-assessment-review.md) подтвердили, что stale basis не восстанавливается одним grant и новая оценка слоя не воскрешает старую оценку Claim/формы; история сохранена, но это не cross-subject write transaction и не все processing-зависимости; **есть часть** |
...
| A06 · G4/G11 | реальное качество и доля необходимого участия человека | Assessment → task/language evaluation, sampled audit | измеримые ошибки, возражения и эскалации | [три реальных Claim](../review-ledger/2026-09-08-real-source-assessment-review.md) и [RU/EN metadata forms](../review-ledger/2026-09-09-real-human-form-assessment-review.md) прошли source-visible оценку и issuer audit; [native citation/observation-пакет](../review-ledger/2026-09-09-real-native-quality-assessment-review.md) добавил пять substantive proposals, четыре committed решения, одну исправленную до append ошибку и отдельный withdrawal; [семантический/Form срез](../review-ledger/2026-09-09-real-native-semantic-form-assessment-review.md) добавил 12-case bilingual calibration и шесть отдельно проверенных committed решений после настоящего expiry. Новых human approvals для этих ограниченных решений не потребовалось; per-record human approvals = 0 не является population intervention rate, а native counts не являются held-out accuracy или общей error-rate оценкой. Проверены ограниченный допуск, отказ, replay, отзыв/новая оценка и две form-проекции; более широкие языки/задачи, систематические ошибки и полноценное UI-потребление ещё нужны; **есть часть** |
...
| V01 · M19/M25, G5 | имя, caption, hover, statement, основания и technical view | Forms/Research → select form, inspect exact | один смысл на разных уровнях подробности | [реальные RU/EN metadata hover](../review-ledger/2026-09-09-real-human-form-assessment-review.md) сохраняют отрицание/спорность/оговорки и целый source context; compact form возвращает exact ref при большом пакете, полный reader сохраняет текст. Явное открытие такой формы в UI и полнота ролей ещё нужны; **есть часть** |
| V02 · G5 | язык источника, перевод и язык UI, происхождение каждой формы | Forms → fallback, translate, inspect provenance | честный выбор доступного языка | original-only не становится утвердительным синтезом; исходные метки языка/письменности отдельных имён и описаний проходят growth/graph/access с оговорками, неизвестные структурно поддержанные метки не исчезают; [Реальная Collection correction](../review-ledger/2026-09-09-native-corpus-descriptive-revision-review.md) объявила языки существующих имени/заметки, сохранив строки, ID и исторические формы. Полная миграция и квалификация языковых преобразований ещё нужны; **есть часть** |
| V03 · G5 | содержательная готовность ≠ непустая строка | Forms/Processing → quality coverage, regenerate dependent form | наблюдаемый missing/restricted/unsupported | [Диагностика покрытия](../review-ledger/2026-09-09-knowledge-coverage-review.md) перечисляет каждый carrier текущего снимка, отдельно наблюдает заглушки, происхождение, неоднозначность, недоступность и роли форм; прежние transport-счётчики не названы качеством. Содержательная готовность и отображение отсутствующего в проекции остатка не доказаны; **есть часть** |
...
| M01 · G8 | прямое отображение, адаптер, уточнение, неизвестность, ограничение | Corpus/Processing → shadow migration, classify remainder | статус каждого объекта и следующий владелец | [Source-first карта](../review-ledger/2026-09-09-source-projection-coverage-review.md) перечислила все 665 на исходном публично каталогизированном снимке идентичностей: 631 прямое отображение, 28 native-адаптеров, 5 legacy Link-Claims требуют полного контекста, 1 Collection обнаруживает устаревший второй носитель. Каждая запись имеет точный source/digest, различия полей и следующего владельца; фильтр потребителя не определяет полноту каталога. [28 native-свидетелей](../review-ledger/2026-09-07-native-witness-forms-and-assessment-input-review.md) имеют 56 source-copy форм и точный вход для оценки без выведенного языка или автоматического допуска. [Полная сохранность 253 canon/intake CSV-связей и 92 карточек](../review-ledger/2026-09-09-corpus-csv-retention-review.md) проверена через обычного читателя; неизвестные поля и точные source bindings не теряются. Пересборка устранила старый Collection-носитель; пять legacy Claims остаются отдельным интеграционным переходом. Это не карта всего некаталогизированного/закрытого корпуса, исторических версий или качества форм; остаток и интеграция сохраняют явные границы; **есть часть** |
