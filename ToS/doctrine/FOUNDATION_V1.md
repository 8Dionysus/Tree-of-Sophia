...
характеристику начала работы у Зоммера. Это ещё не внесено в существующий
source-пакет как пересмотр: содержательного допуска и атомарного исправления
связанных предметов это исполнение не доказывает.
...
Это ещё не команда изменения Claim или нескольких предметов, и не решение
об исторической истинности. Реальное применение к письму пока отдельно.
