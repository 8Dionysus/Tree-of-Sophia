...
| H04 · M22/M25 | эпоха, поколение, современность, фаза, скорость передачи и запаздывание рецепции | Registry/Research → time scales, sequence comparison | разные временные масштабы | **частично**: исполняемые периодизация и поколение различены с датой и организацией; реальное поколение, современность и сравнение скорости передачи/запаздывания ещё не доказаны |
