...
| H01 · M19/M22 | историческое событие, процесс, состояние, участие | Registry → event/participation profile | что произошло, кто участвовал и откуда известно | отдельные исходные исторические предметы и Claim-связи проходят каталог, граф, формы и access focus/filter; время, полный профиль ролей и реальная историческая оценка ещё нужны; **в работе** |
