...
| --- | --- | --- | --- | --- |
| F01 · M19, G2 | предмет, имя, внешний ID, запись, версия, утверждение, проекция различны | Registry/Corpus → resolve, inspect, revise | узнаваемый предмет и история описаний | нет Claim/object ID collision; коррекция historical/declared-profile и native Agent/Place/Organization/Work сохраняет ID и архив; точные Claim и поддержанные metadata-версии доступны отдельно через граф; [реальные Expression v1/v2/v3 и Edition v1 читаются по точным refs и исходным байтам](../review-ledger/2026-09-09-native-expression-edition-review.md). Не все native-семейства и исторические формы закрыты; **есть часть** |
...
| B02 · M19/M25 | издание, публикация, экземпляр, документ, письмо, лекция, записная книжка | Corpus/Registry → bibliographic paths | произведение, выпуск и конкретный экземпляр | [Электронное издание Gutenberg № 4363 создано отдельно от Expression](../review-ledger/2026-09-09-native-expression-edition-review.md) штатной составной командой с отдельным Claim, формами и сохранением трёх версий Expression. Издание не установлено как исторический печатный оригинал, Item или File; несколько реализаций и коллекции не запрещены. Item/File adoption и остальные операции ещё нужны; **есть часть** |
...
| C01 · G6 | общий язык разрешённого роста для человека и агента | Growth → create, revise, assert, assess, merge/split proposal, extend | понятная команда, diff и конфликт | create/revise форм, historical/declared metadata и отдельных Claim; [составная Work → Expression команда и адресная ревизия native-метаданных](../review-ledger/2026-09-09-native-work-expression-growth-review.md) и [отдельная квалифицированная атрибуция перевода существующему Agent](../review-ledger/2026-09-09-native-translator-responsibility-review.md) сохраняют предшественников, проверяют полномочия, повтор и восстановление без обхода потомков. [Обнаружение подключённых обработчиков без grant](../review-ledger/2026-09-09-command-discovery-and-temporal-comparison-review.md) использует ту же грамматику dispatch и не объявляет текущие полномочия. [Отдельная Expression → Edition команда](../review-ledger/2026-09-09-native-expression-edition-review.md) доводит каталог до 25 обработчиков, сохраняя самостоятельные grant, Claim и историю. Старые flat-package grants не расширены; полноценная человеческая форма команд и остальные предметные операции ещё нужны; **в работе** |
