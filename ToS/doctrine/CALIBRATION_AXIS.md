...
ToS may name a guiding axis of meaning.

In the current public architecture, that axis is:
...
- sources remain stronger than interpretive preference
- extraction remains distinguishable from synthesis
- tension with the guiding axis may be preserved rather than hidden
- a source may resist the dominant current without becoming invalid

## Review question

The central review question is:

Does the guiding axis sharpen orientation while leaving source plurality and contestability intact?
