...
| *Jenseits* authorial and critical metadata route | ordered GSA ORES/Kalliope -> HAAB OPAC/IIIF -> DFGA/eKGWB -> e-rara -> established genetic scholarship/HAdW -> 2024-2025 textual-genetic work -> general-web-last discovery; mixed W I/Mp regions, D 18, C 4615/C 4619, 1886 print, 302 critical addresses, representation-count asymmetry, same-day Nietzsche Source timeout, and one exact deferred §22 route; zero acquired source bodies | promote remote identity, region-attribution law, correction-witness separation, representation-specific addressing, and freshness-conflict preservation with limits | exact upstream route for the first transfer work and future question-specific W I 7 / D 18 / publication A/B/C soil | whole-notebook work membership, local Item or custody, duplicate first print, author-final text, region collation, accepted German, manuscript/proof transcription, critical equivalence, rights clearance, human backlog, semantics, experiment result, or publication |
