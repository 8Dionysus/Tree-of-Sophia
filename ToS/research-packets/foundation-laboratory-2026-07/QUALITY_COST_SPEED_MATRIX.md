...
| historical-German morphology B/C | ZDL `de_zdl_lg 4.0.0` unchanged-context B and DTAEC-normalized exact-B C frozen before output | no packet, output, German gold, or quality result | not measured | B's 627,548,130-byte package and C's 31,741,808-byte weights identified but not acquired; runtime/peak evidence absent | not measured; no human task opened | blocked-not-materialized until reviewed A residue or a concrete contextual question plus rights and fresh host admission |
