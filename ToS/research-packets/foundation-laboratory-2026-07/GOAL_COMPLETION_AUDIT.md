...
- Tree of Sophia through `38dd32a` (`Admit open DTA 1883 structured
  witness`), plus the remaining DTA public-part sequence audited in this
  working slice;
...
| 16 | ID, anchor, provenance, sign, and claim contracts | `CORPUS_FOUNDATION.md`, `CORPUS_CONTRACTS.md`, and the corresponding schemas separate identity, address, occurrence, sign, and claim | proven as contract | real accepted signs and claims remain absent |
...
| 22 | structure recovery report | `STRUCTURE_RECOVERY_REPORT.md` records real A/B/C runs and preserved failures | partial | real-human structure, reading-order, and correction review |
