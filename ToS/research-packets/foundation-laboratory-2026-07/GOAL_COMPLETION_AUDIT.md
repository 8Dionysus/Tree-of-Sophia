...
| 18 | semantic annotation packet contracts | semantic ladder, sign annotation, claim packet, graph query, historical universal v1 evidence, task-specific semantic v2, and task-specific LLM v2 contracts exist; the semantic v2 plan separates observation, linguistic, and interpretive assurance and schedules zero work before task materialization | proven as contract and refreshed 2026-07-29 | exact accepted source for selected tasks, language-competence evidence where required, unassisted baselines for materialized interpretive tasks, and promotion-capable human sign decisions |
