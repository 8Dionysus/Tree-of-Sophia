...
| 15 | access-request workflow | schemas, private/public lanes, letter and redacted-receipt templates, an unsent Wörterbuch request, and an unsent exact eKGWB request derived from the first incomplete discovery run exist | prepared | direct institutional contact-route refresh, human approval, sending, response, and permission scope |
