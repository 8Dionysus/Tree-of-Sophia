...
- Tree of Sophia through `dcad681` (`Admit bounded Zarathustra translation
  calibration input`), plus the completed bounded A/B/C evidence reconciliation in this
  working tree;
