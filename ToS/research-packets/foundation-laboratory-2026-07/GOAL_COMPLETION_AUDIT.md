...
| 11 | manifests and page/resource inventories for the source files | Antonovsky PDF, *Mysl* PDF, and Naumann EPUB have Work/Expression/Edition/Item routes and tracked manifests; three separately acquired scan items and four structured DTA TEI items add their own manifests; all ten items now carry deterministic text-free resource inventories: 2,468 PDF pages, 541 EPUB members, and 762 TEI page-break/division resources resolve to exact file digests without copying source text into Git | proven mechanically | exact acquisition history and rights still carry their review posture; resource enumeration is not content acceptance |
| 12 | checksums and forensic reports | SHA-256 fixity and forensic reports exist for all three operator-supplied files, all three acquired scan PDFs, and all four acquired DTA TEIs; the open-source byte counts, local hashes, ignore rules, and absence from tracked files were checked independently in the canonical checkout on 2026-07-28; each resource inventory has its own digest-bound provenance event | proven | BLAKE3 was not adopted as a second required fixity algorithm |
...
| 16 | ID, anchor, provenance, sign, and claim contracts | `CORPUS_FOUNDATION.md`, `CORPUS_CONTRACTS.md`, and the corresponding schemas separate identity, address, occurrence, sign, and claim; the 82 Zarathustra witness-structure correspondences resolve to 246 stable proposed TEI, EPUB-member, and PDF-page anchor IDs; the *Mysl* aggregate adds 11 fixity-bound page anchors and one text-free seven-member boundary map; the new parallel-PDF contract adds 11 model-reviewed *Jenseits* division correspondences and 22 proposed whole-page anchors across the exact Naumann and Polilov/Mysl witnesses | proven as contract and proposed structural addressing | the structural IDs are not exact accepted passage boundaries; the *Jenseits* map materializes zero exact per-unit pages and asserts no translation equivalence; bibliographic claims remain unreviewed; real accepted signs and semantic claims remain absent |
...
| 22 | structure recovery report | `STRUCTURE_RECOVERY_REPORT.md` records real A/B/C runs and preserved failures; the source-owned DTA-parts ↔ Naumann 1893 map adds 82 monotonic named-boundary candidates and 246 stable proposed addresses; the *Jenseits* Naumann 1886 ↔ Polilov/Mysl 1996 map adds 11 visually reviewed division starts, 22 proposed page anchors, contiguous division-level coverage of units 1–296, and the supplemental units 65a/73a without changing any extraction verdict | partial | real-human structure, reading-order, exact-boundary, and correction review; exact per-unit pages remain unmaterialized because the German OCR has unresolved numeral gaps |
