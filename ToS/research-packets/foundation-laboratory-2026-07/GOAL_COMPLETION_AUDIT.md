...
- Tree of Sophia through `d8e2969` (`Map Mysl volume work boundaries`), plus
  the exact Naumann 1886 *Jenseits von Gut und Böse* source-witness slice
...
| 16 | ID, anchor, provenance, sign, and claim contracts | `CORPUS_FOUNDATION.md`, `CORPUS_CONTRACTS.md`, and the corresponding schemas separate identity, address, occurrence, sign, and claim; the 82 witness-structure correspondences resolve to 246 stable proposed TEI, EPUB-member, and PDF-page anchor IDs; the *Mysl* aggregate adds 11 fixity-bound page anchors and one text-free seven-member boundary map with membership and responsibility claim closure | proven as contract and proposed structural addressing | the structural IDs are not exact accepted passage boundaries; the new bibliographic claims remain unreviewed; real accepted signs and semantic claims remain absent |
