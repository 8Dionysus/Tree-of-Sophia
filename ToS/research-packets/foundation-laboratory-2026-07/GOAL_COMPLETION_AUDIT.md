...
3. Preserve the completed blind resident A/B/C translation-method calibration
...
4. Keep direct visual retrieval separate from the completed text A/B/C
...
5. Open the accepted translation lifecycle only after its exact German anchors
   reach a philologically admitted source posture.
6. Follow accepted translation with sign review, retrieval/graph adjudication,
