...
| `QUALITY_COST_SPEED_MATRIX.md` | Which mechanical speed/resource values exist, which are comparable, where direct energy observation is currently permission-blocked, and where quality and human correction cost remain unmeasured? |
