...
| `ANTONOVSKY_1913_LAYERED_RIGHTS_ASSESSMENT.md` | Why the exact fixity-matched Commons object supports positive RU/US public-domain assessments for the work, translation, preface, historical presentation, faithful scan, and mechanical ABBYY layer; why the US historical route is §104A's source-country condition rather than a domestic pre-1931 shortcut; and why text quality, other jurisdictions, human review, operator approval, local-payload transfer, and publication remain independently closed? |
...
| `ANTONOVSKY_1911_RSL_RUNEB_LAYERED_RIGHTS_ASSESSMENT.md` | Why Nietzsche's Work, Antonovsky's 1911 translation and preface, and the historical presentation are public-domain-reviewed for RU/US while the exact RSL/RuNEB scan and embedded text remain copyright-undetermined without an object-specific reuse statement; why the foreign-work US route requires the URAA source-country test; and why the aggregate file stays local-only and non-transferable? |
