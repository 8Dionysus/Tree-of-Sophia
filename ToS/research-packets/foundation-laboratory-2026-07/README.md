...
| `STRUCTURE_RECOVERY_REPORT.md` | What did the real Structure A/B/C runs produce; how do later text-free source/target numbered-label maps yield stable addresses; and why 140 hierarchical pairs plus 20 German routes still do not establish accepted text or alignment? |
...
| `GOLDEN_KERNEL_TRANSFER_REPORT.md` | Is cross-work A/B/C epistemically runnable, what do the three title-page scouts and twenty private pre-output page candidates prove, how do all twenty pages now obtain 35 possible text-free source routes, and what exact evidence gate still blocks a false transfer claim? |
