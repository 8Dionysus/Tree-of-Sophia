...
Admitted prepared-dossier shape is indexed in
`ToS/philosophy/atlas/dossiers/`.

This research-packet directory owns packet capture context. It does not
duplicate the atlas dossier index or pretend to be the philosophy tree itself.
...
semantic review, source-witness status, or canon acceptance.
