...
class SourceWitnessBibliographicGraphTest(unittest.TestCase):
    ...
    def test_projection_is_claim_reified_and_complete(self) -> None:
        ...
        self.assertEqual(counts["source_claims"], 140)
        self.assertEqual(counts["claim_traces"], 140)
        self.assertEqual(counts["nodes"], 492)
        self.assertEqual(counts["edges"], 989)
        ...
        self.assertEqual(payload["review_counts"], {"unreviewed": 140})
        self.assertEqual(payload["visibility_counts"], {"public_metadata_only": 140})
        self.assertEqual(
