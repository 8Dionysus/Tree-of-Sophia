...
class SourceWitnessBibliographicGraphTest(unittest.TestCase):
    ...
    def test_projection_is_claim_reified_and_complete(self) -> None:
        ...
        self.assertEqual(counts["source_claims"], 165)
        self.assertEqual(counts["claim_traces"], 165)
        self.assertEqual(counts["nodes"], 582)
        self.assertEqual(counts["edges"], 1139)
        ...
        self.assertEqual(payload["review_counts"], {"unreviewed": 165})
        self.assertEqual(payload["visibility_counts"], {"public_metadata_only": 165})
        self.assertEqual(
