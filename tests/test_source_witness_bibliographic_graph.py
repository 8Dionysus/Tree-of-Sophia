...
class SourceWitnessBibliographicGraphTest(unittest.TestCase):
    ...
    def test_projection_is_claim_reified_and_complete(self) -> None:
        ...
        self.assertEqual(counts["source_claims"], 156)
        self.assertEqual(counts["claim_traces"], 156)
        self.assertEqual(counts["nodes"], 552)
        self.assertEqual(counts["edges"], 1085)
        ...
        self.assertEqual(payload["review_counts"], {"unreviewed": 156})
        self.assertEqual(payload["visibility_counts"], {"public_metadata_only": 156})
        self.assertEqual(
