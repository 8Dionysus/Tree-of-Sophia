...
class SourceWitnessBibliographicGraphTest(unittest.TestCase):
    ...
    def test_projection_is_claim_reified_and_complete(self) -> None:
        ...
        self.assertEqual(counts["source_claims"], 181)
        self.assertEqual(counts["claim_traces"], 181)
        self.assertEqual(counts["nodes"], 641)
        self.assertEqual(counts["edges"], 1235)
        ...
        self.assertEqual(payload["review_counts"], {"unreviewed": 181})
        self.assertEqual(payload["visibility_counts"], {"public_metadata_only": 181})
        self.assertEqual(
