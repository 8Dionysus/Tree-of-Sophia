...
class SourceWitnessBibliographicGraphTest(unittest.TestCase):
    ...
    def test_projection_is_claim_reified_and_complete(self) -> None:
        ...
        self.assertEqual(counts["source_claims"], 157)
        self.assertEqual(counts["claim_traces"], 157)
        self.assertEqual(counts["nodes"], 558)
        self.assertEqual(counts["edges"], 1091)
        ...
        self.assertEqual(payload["review_counts"], {"unreviewed": 157})
        self.assertEqual(payload["visibility_counts"], {"public_metadata_only": 157})
        self.assertEqual(
