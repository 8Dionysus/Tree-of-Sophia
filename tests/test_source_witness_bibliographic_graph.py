...
class SourceWitnessBibliographicGraphTest(unittest.TestCase):
    ...
    def test_projection_is_claim_reified_and_complete(self) -> None:
        ...
        self.assertEqual(counts["source_claims"], 150)
        self.assertEqual(counts["claim_traces"], 150)
        self.assertEqual(counts["nodes"], 521)
        self.assertEqual(counts["edges"], 1049)
        ...
        self.assertEqual(payload["review_counts"], {"unreviewed": 150})
        self.assertEqual(payload["visibility_counts"], {"public_metadata_only": 150})
        self.assertEqual(
