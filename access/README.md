...
for nodes, edges and rights. Python and D1 verify exact emitted JSON (including
...
forward/reverse checksum-only SQL. It does not rewrite corpus rows or grant
