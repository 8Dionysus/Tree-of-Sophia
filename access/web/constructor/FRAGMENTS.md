...
fragment**. The reader offers Russian, English and a side-by-side view. Each
version retains its own paragraphs; the columns do not imply sentence alignment.
...
two versions. Every version has complete paragraphs, the SHA-256 of their UTF-8
...
prepared material set. In the browser check both languages, the last paragraph,
parallel reading, credits, unavailable works and return to the same graph step.
