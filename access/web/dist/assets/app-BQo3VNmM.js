...
`)}const $g={[jc]:"Linear",[ed]:"Reinhard",[td]:"Cineon",[nd]:"ACESFilmic",[rd]:"AgX",[sd]:"Neutral",[id]:"Custom"};function Zg(n,e){const t=$g[e];return t===void 0?(tt("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Vs=new re;function Jg(){xt.getLuminanceCoefficients(Vs);const n=Vs.x.toFixed(4),e=Vs.y.toFixed(4),t=Vs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+m);const P=C+g+a,M=C+m+o,I=_c(r,r.VERTEX_SHADER,P),T=_c(r,r.FRAGMENT_SHADER,M);r.attachShader(x,I),r.attachShader(x,T),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function D(L){if(n.debug.checkShaderErrors){const H=r.getProgramInfoLog(x)||"",Z=r.getShaderInfoLog(I)||"",k=r.getShaderInfoLog(T)||"",z=H.trim(),R=Z.trim(),A=k.trim();let G=!0,Y=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(G=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,x,I,T);else{const ne=xc(r,I,"vertex"),de=xc(r,T,"fragment");Et("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+ne+`
`+de)}else z!==""?tt("WebGLProgram: Program Info Log:",z):(R===""||A==="")&&(Y=!1);Y&&(L.diagnostics={runnable:G,programLog:z,vertexShader:{log:R,prefix:g},fragmentShader:{log:A,prefix:m}})}r.deleteShader(I),r.deleteShader(T),v=new ea(r,x),S=e_(r,x)}let v;this.getUniforms=function(){return v===void 0&&D(this),v};let S;this.getAttributes=function(){return S===void 0&&D(this),S};let w=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=r.getProgramParameter(x,Wg)),w},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Xg++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=I,this.fragmentShader=T,this}let g_=0;class __{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,i){const r=this._getShaderCacheForMaterial(e);return r.has(t)===!1&&(r.add(t),t.usedTimes++),r.has(i)===!1&&(r.add(i),i.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new v_(e),t.set(e,i)),i}}class v_{constructor(e){this.id=g_++,this.code=e,this.usedTimes=0}}function x_(n){return n===cr||n===ia||n===ra}function y_(n,e,t,i,r,s){const a=new gd,o=new __,c=new Set,l=[],p=new Map,u=i.logarithmicDepthBuffer;let d=i.precision;const h={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(v){return c.add(v),v===0?"uv":`uv${v}`}function x(v,S,w,L,H,Z){const k=L.fog,z=H.geometry,R=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?L.environment:null,A=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap,G=e.get(v.envMap||R,A),Y=G&&G.mapping===pa?G.image.height:null,ne=h[v.type];v.precision!==null&&(d=i.getMaxPrecision(v.precision),d!==v.precision&&tt("WebGLProgram.getParameters:",v.precision,"not supported, using",d,"instead."));const de=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,ce=de!==void 0?de.length:0;let J=0;z.morphAttributes.position!==void 0&&(J=1),z.morphAttributes.normal!==void 0&&(J=2),z.morphAttributes.color!==void 0&&(J=3);let ue,me,B,oe;if(ne){const Ee=Jn[ne];ue=Ee.vertexShader,me=Ee.fragmentShader}else{ue=v.vertexShader,me=v.fragmentShader;const Ee=o.getVertexShaderStage(v),Dt=o.getFragmentShaderStage(v);o.update(v,Ee,Dt),B=Ee.id,oe=Dt.id}const $=n.getRenderTarget(),se=n.state.buffers.depth.getReversed(),_e=H.isInstancedMesh===!0,Me=H.isBatchedMesh===!0,ve=!!v.map,F=!!v.matcap,K=!!G,ae=!!v.aoMap,xe=!!v.lightMap,Ae=!!v.bumpMap&&v.wireframe===!1,be=!!v.normalMap,ke=!!v.displacementMap,Xe=!!v.emissiveMap,Ze=!!v.metalnessMap,Ne=!!v.roughnessMap,N=v.anisotropy>0,at=v.clearcoat>0,$e=v.dispersion>0,E=v.iridescence>0,f=v.sheen>0,U=v.transmission>0,O=N&&!!v.anisotropyMap,V=at&&!!v.clearcoatMap,fe=at&&!!v.clearcoatNormalMap,he=at&&!!v.clearcoatRoughnessMap,ee=E&&!!v.iridescenceMap,te=E&&!!v.iridescenceThicknessMap,Se=f&&!!v.sheenColorMap,Ue=f&&!!v.sheenRoughnessMap,we=!!v.specularMap,Te=!!v.specularColorMap,Ve=!!v.specularIntensityMap,Ge=U&&!!v.transmissionMap,it=U&&!!v.thicknessMap,X=!!v.gradientMap,Ce=!!v.alphaMap,ge=v.alphaTest>0,Pe=!!v.alphaHash,Le=!!v.extensions;let ye=kn;v.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(ye=n.toneMapping);const He={shaderID:ne,shaderType:v.type,shaderName:v.name,vertexShader:ue,fragmentShader:me,defines:v.defines,customVertexShaderID:B,customFragmentShaderID:oe,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:d,batching:Me,batchingColor:Me&&H._colorsTexture!==null,instancing:_e,instancingColor:_e&&H.instanceColor!==null,instancingMorph:_e&&H.morphTexture!==null,outputColorSpace:$===null?n.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:xt.workingColorSpace,alphaToCoverage:!!v.alphaToCoverage,map:ve,matcap:F,envMap:K,envMapMode:K&&G.mapping,envMapCubeUVHeight:Y,aoMap:ae,lightMap:xe,bumpMap:Ae,normalMap:be,displacementMap:ke,emissiveMap:Xe,normalMapObjectSpace:be&&v.normalMapType===rf,normalMapTangentSpace:be&&v.normalMapType===Ol,packedNormalMap:be&&v.normalMapType===Ol&&x_(v.normalMap.format),metalnessMap:Ze,roughnessMap:Ne,anisotropy:N,anisotropyMap:O,clearcoat:at,clearcoatMap:V,clearcoatNormalMap:fe,clearcoatRoughnessMap:he,dispersion:$e,iridescence:E,iridescenceMap:ee,iridescenceThicknessMap:te,sheen:f,sheenColorMap:Se,sheenRoughnessMap:Ue,specularMap:we,specularColorMap:Te,specularIntensityMap:Ve,transmission:U,transmissionMap:Ge,thicknessMap:it,gradientMap:X,opaque:v.transparent===!1&&v.blending===Nr&&v.alphaToCoverage===!1,alphaMap:Ce,alphaTest:ge,alphaHash:Pe,combine:v.combine,mapUv:ve&&_(v.map.channel),aoMapUv:ae&&_(v.aoMap.channel),lightMapUv:xe&&_(v.lightMap.channel),bumpMapUv:Ae&&_(v.bumpMap.channel),normalMapUv:be&&_(v.normalMap.channel),displacementMapUv:ke&&_(v.displacementMap.channel),emissiveMapUv:Xe&&_(v.emissiveMap.channel),metalnessMapUv:Ze&&_(v.metalnessMap.channel),roughnessMapUv:Ne&&_(v.roughnessMap.channel),anisotropyMapUv:O&&_(v.anisotropyMap.channel),clearcoatMapUv:V&&_(v.clearcoatMap.channel),clearcoatNormalMapUv:fe&&_(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:he&&_(v.clearcoatRoughnessMap.channel),iridescenceMapUv:ee&&_(v.iridescenceMap.channel),iridescenceThicknessMapUv:te&&_(v.iridescenceThicknessMap.channel),sheenColorMapUv:Se&&_(v.sheenColorMap.channel),sheenRoughnessMapUv:Ue&&_(v.sheenRoughnessMap.channel),specularMapUv:we&&_(v.specularMap.channel),specularColorMapUv:Te&&_(v.specularColorMap.channel),specularIntensityMapUv:Ve&&_(v.specularIntensityMap.channel),transmissionMapUv:Ge&&_(v.transmissionMap.channel),thicknessMapUv:it&&_(v.thicknessMap.channel),alphaMapUv:Ce&&_(v.alphaMap.channel),vertexTangents:!!z.attributes.tangent&&(be||N),vertexNormals:!!z.attributes.normal,vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,pointsUvs:H.isPoints===!0&&!!z.attributes.uv&&(ve||Ce),fog:!!k,useFog:v.fog===!0,fogExp2:!!k&&k.isFogExp2,flatShading:v.wireframe===!1&&(v.flatShading===!0||z.attributes.normal===void 0&&be===!1&&(v.isMeshLambertMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isMeshPhysicalMaterial)),sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:se,skinning:H.isSkinnedMesh===!0,hasPositionAttribute:z.attributes.position!==void 0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:ce,morphTextureStride:J,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numLightProbeGrids:Z.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:v.dithering,shadowMapEnabled:n.shadowMap.enabled&&w.length>0,shadowMapType:n.shadowMap.type,toneMapping:ye,decodeVideoTexture:ve&&v.map.isVideoTexture===!0&&xt.getTransfer(v.map.colorSpace)===It,decodeVideoTextureEmissive:Xe&&v.emissiveMap.isVideoTexture===!0&&xt.getTransfer(v.emissiveMap.colorSpace)===It,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===vi,flipSided:v.side===_n,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:Le&&v.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Le&&v.extensions.multiDraw===!0||Me)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return He.vertexUv1s=c.has(1),He.vertexUv2s=c.has(2),He.vertexUv3s=c.has(3),c.clear(),He}function g(v){const S=[];if(v.shaderID?S.push(v.shaderID):(S.push(v.customVertexShaderID),S.push(v.customFragmentShaderID)),v.defines!==void 0)for(const w in v.defines)S.push(w),S.push(v.defines[w]);return v.isRawShaderMaterial===!1&&(m(S,v),C(S,v),S.push(n.outputColorSpace)),S.push(v.customProgramCacheKey),S.join()}function m(v,S){v.push(S.precision),v.push(S.outputColorSpace),v.push(S.envMapMode),v.push(S.envMapCubeUVHeight),v.push(S.mapUv),v.push(S.alphaMapUv),v.push(S.lightMapUv),v.push(S.aoMapUv),v.push(S.bumpMapUv),v.push(S.normalMapUv),v.push(S.displacementMapUv),v.push(S.emissiveMapUv),v.push(S.metalnessMapUv),v.push(S.roughnessMapUv),v.push(S.anisotropyMapUv),v.push(S.clearcoatMapUv),v.push(S.clearcoatNormalMapUv),v.push(S.clearcoatRoughnessMapUv),v.push(S.iridescenceMapUv),v.push(S.iridescenceThicknessMapUv),v.push(S.sheenColorMapUv),v.push(S.sheenRoughnessMapUv),v.push(S.specularMapUv),v.push(S.specularColorMapUv),v.push(S.specularIntensityMapUv),v.push(S.transmissionMapUv),v.push(S.thicknessMapUv),v.push(S.combine),v.push(S.fogExp2),v.push(S.sizeAttenuation),v.push(S.morphTargetsCount),v.push(S.morphAttributeCount),v.push(S.numDirLights),v.push(S.numPointLights),v.push(S.numSpotLights),v.push(S.numSpotLightMaps),v.push(S.numHemiLights),v.push(S.numRectAreaLights),v.push(S.numDirLightShadows),v.push(S.numPointLightShadows),v.push(S.numSpotLightShadows),v.push(S.numSpotLightShadowsWithMaps),v.push(S.numLightProbes),v.push(S.shadowMapType),v.push(S.toneMapping),v.push(S.numClippingPlanes),v.push(S.numClipIntersection),v.push(S.depthPacking)}function C(v,S){a.disableAll(),S.instancing&&a.enable(0),S.instancingColor&&a.enable(1),S.instancingMorph&&a.enable(2),S.matcap&&a.enable(3),S.envMap&&a.enable(4),S.normalMapObjectSpace&&a.enable(5),S.normalMapTangentSpace&&a.enable(6),S.clearcoat&&a.enable(7),S.iridescence&&a.enable(8),S.alphaTest&&a.enable(9),S.vertexColors&&a.enable(10),S.vertexAlphas&&a.enable(11),S.vertexUv1s&&a.enable(12),S.vertexUv2s&&a.enable(13),S.vertexUv3s&&a.enable(14),S.vertexTangents&&a.enable(15),S.anisotropy&&a.enable(16),S.alphaHash&&a.enable(17),S.batching&&a.enable(18),S.dispersion&&a.enable(19),S.batchingColor&&a.enable(20),S.gradientMap&&a.enable(21),S.packedNormalMap&&a.enable(22),S.vertexNormals&&a.enable(23),v.push(a.mask),a.disableAll(),S.fog&&a.enable(0),S.useFog&&a.enable(1),S.flatShading&&a.enable(2),S.logarithmicDepthBuffer&&a.enable(3),S.reversedDepthBuffer&&a.enable(4),S.skinning&&a.enable(5),S.morphTargets&&a.enable(6),S.morphNormals&&a.enable(7),S.morphColors&&a.enable(8),S.premultipliedAlpha&&a.enable(9),S.shadowMapEnabled&&a.enable(10),S.doubleSided&&a.enable(11),S.flipSided&&a.enable(12),S.useDepthPacking&&a.enable(13),S.dithering&&a.enable(14),S.transmission&&a.enable(15),S.sheen&&a.enable(16),S.opaque&&a.enable(17),S.pointsUvs&&a.enable(18),S.decodeVideoTexture&&a.enable(19),S.decodeVideoTextureEmissive&&a.enable(20),S.alphaToCoverage&&a.enable(21),S.numLightProbeGrids>0&&a.enable(22),S.hasPositionAttribute&&a.enable(23),v.push(a.mask)}function P(v){const S=h[v.type];let w;if(S){const L=Jn[S];w=Xf.clone(L.uniforms)}else w=v.uniforms;return w}function M(v,S){let w=p.get(S);return w!==void 0?++w.usedTimes:(w=new m_(n,S,v,r),l.push(w),p.set(S,w)),w}function I(v){if(--v.usedTimes===0){const S=l.indexOf(v);l[S]=l[l.length-1],l.pop(),p.delete(v.cacheKey),v.destroy()}}function T(v){o.remove(v)}function D(){o.dispose()}return{getParameters:x,getProgramCacheKey:g,getUniforms:P,acquireProgram:M,releaseProgram:I,releaseShaderCache:T,programs:l,dispose:D}}function S_(){let n=new WeakMap;function e(a){return n.has(a)}function t(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function r(a,o,c){n.get(a)[o]=c}function s(){n=new WeakMap}return{has:e,get:t,remove:i,update:r,dispose:s}}function M_(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.materialVariant!==e.materialVariant?n.materialVariant-e.materialVariant:n.z!==e.z?n.z-e.z:n.id-e.id}function Ec(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Tc(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(d){let h=0;return d.isInstancedMesh&&(h+=2),d.isSkinnedMesh&&(h+=1),h}function o(d,h,_,x,g,m){let C=n[e];return C===void 0?(C={id:d.id,object:d,geometry:h,material:_,materialVariant:a(d),groupOrder:x,renderOrder:d.renderOrder,z:g,group:m},n[e]=C):(C.id=d.id,C.object=d,C.geometry=h,C.material=_,C.materialVariant=a(d),C.groupOrder=x,C.renderOrder=d.renderOrder,C.z=g,C.group=m),e++,C}function c(d,h,_,x,g,m){const C=o(d,h,_,x,g,m);_.transmission>0?i.push(C):_.transparent===!0?r.push(C):t.push(C)}function l(d,h,_,x,g,m){const C=o(d,h,_,x,g,m);_.transmission>0?i.unshift(C):_.transparent===!0?r.unshift(C):t.unshift(C)}function p(d,h,_){t.length>1&&t.sort(d||M_),i.length>1&&i.sort(h||Ec),r.length>1&&r.sort(h||Ec),_&&(t.reverse(),i.reverse(),r.reverse())}function u(){for(let d=e,h=n.length;d<h;d++){const _=n[d];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:c,unshift:l,finish:u,sort:p}}function b_(){let n=new WeakMap;function e(i,r){const s=n.get(i);let a;return s===void 0?(a=new Tc,n.set(i,[a])):r>=s.length?(a=new Tc,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function E_(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new re,color:new Lt};break;case"SpotLight":t={position:new re,direction:new re,color:new Lt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new re,color:new Lt,distance:0,decay:0};break;case"HemisphereLight":t={direction:new re,skyColor:new Lt,groundColor:new Lt};break;case"RectAreaLight":t={color:new Lt,position:new re,halfWidth:new re,halfHeight:new re};break}return n[e.id]=t,t}}}function T_(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Tt};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Tt};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Tt,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let w_=0;function A_(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function R_(n){const e=new E_,t=T_(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)i.probe.push(new re);const r=new re,s=new Kt,a=new Kt;function o(l){let p=0,u=0,d=0;for(let S=0;S<9;S++)i.probe[S].set(0,0,0);let h=0,_=0,x=0,g=0,m=0,C=0,P=0,M=0,I=0,T=0,D=0;l.sort(A_);for(let S=0,w=l.length;S<w;S++){const L=l[S],H=L.color,Z=L.intensity,k=L.distance;let z=null;if(L.shadow&&L.shadow.map&&(L.shadow.map.texture.format===cr?z=L.shadow.map.texture:z=L.shadow.map.depthTexture||L.shadow.map.texture),L.isAmbientLight)p+=H.r*Z,u+=H.g*Z,d+=H.b*Z;else if(L.isLightProbe){for(let R=0;R<9;R++)i.probe[R].addScaledVector(L.sh.coefficients[R],Z);D++}else if(L.isDirectionalLight){const R=e.get(L);if(R.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){const A=L.shadow,G=t.get(L);G.shadowIntensity=A.intensity,G.shadowBias=A.bias,G.shadowNormalBias=A.normalBias,G.shadowRadius=A.radius,G.shadowMapSize=A.mapSize,i.directionalShadow[h]=G,i.directionalShadowMap[h]=z,i.directionalShadowMatrix[h]=L.shadow.matrix,C++}i.directional[h]=R,h++}else if(L.isSpotLight){const R=e.get(L);R.position.setFromMatrixPosition(L.matrixWorld),R.color.copy(H).multiplyScalar(Z),R.distance=k,R.coneCos=Math.cos(L.angle),R.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),R.decay=L.decay,i.spot[x]=R;const A=L.shadow;if(L.map&&(i.spotLightMap[I]=L.map,I++,A.updateMatrices(L),L.castShadow&&T++),i.spotLightMatrix[x]=A.matrix,L.castShadow){const G=t.get(L);G.shadowIntensity=A.intensity,G.shadowBias=A.bias,G.shadowNormalBias=A.normalBias,G.shadowRadius=A.radius,G.shadowMapSize=A.mapSize,i.spotShadow[x]=G,i.spotShadowMap[x]=z,M++}x++}else if(L.isRectAreaLight){const R=e.get(L);R.color.copy(H).multiplyScalar(Z),R.halfWidth.set(L.width*.5,0,0),R.halfHeight.set(0,L.height*.5,0),i.rectArea[g]=R,g++}else if(L.isPointLight){const R=e.get(L);if(R.color.copy(L.color).multiplyScalar(L.intensity),R.distance=L.distance,R.decay=L.decay,L.castShadow){const A=L.shadow,G=t.get(L);G.shadowIntensity=A.intensity,G.shadowBias=A.bias,G.shadowNormalBias=A.normalBias,G.shadowRadius=A.radius,G.shadowMapSize=A.mapSize,G.shadowCameraNear=A.camera.near,G.shadowCameraFar=A.camera.far,i.pointShadow[_]=G,i.pointShadowMap[_]=z,i.pointShadowMatrix[_]=L.shadow.matrix,P++}i.point[_]=R,_++}else if(L.isHemisphereLight){const R=e.get(L);R.skyColor.copy(L.color).multiplyScalar(Z),R.groundColor.copy(L.groundColor).multiplyScalar(Z),i.hemi[m]=R,m++}}g>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=De.LTC_FLOAT_1,i.rectAreaLTC2=De.LTC_FLOAT_2):(i.rectAreaLTC1=De.LTC_HALF_1,i.rectAreaLTC2=De.LTC_HALF_2)),i.ambient[0]=p,i.ambient[1]=u,i.ambient[2]=d;const v=i.hash;(v.directionalLength!==h||v.pointLength!==_||v.spotLength!==x||v.rectAreaLength!==g||v.hemiLength!==m||v.numDirectionalShadows!==C||v.numPointShadows!==P||v.numSpotShadows!==M||v.numSpotMaps!==I||v.numLightProbes!==D)&&(i.directional.length=h,i.spot.length=x,i.rectArea.length=g,i.point.length=_,i.hemi.length=m,i.directionalShadow.length=C,i.directionalShadowMap.length=C,i.pointShadow.length=P,i.pointShadowMap.length=P,i.spotShadow.length=M,i.spotShadowMap.length=M,i.directionalShadowMatrix.length=C,i.pointShadowMatrix.length=P,i.spotLightMatrix.length=M+I-T,i.spotLightMap.length=I,i.numSpotLightShadowsWithMaps=T,i.numLightProbes=D,v.directionalLength=h,v.pointLength=_,v.spotLength=x,v.rectAreaLength=g,v.hemiLength=m,v.numDirectionalShadows=C,v.numPointShadows=P,v.numSpotShadows=M,v.numSpotMaps=I,v.numLightProbes=D,i.version=w_++)}function c(l,p){let u=0,d=0,h=0,_=0,x=0;const g=p.matrixWorldInverse;for(let m=0,C=l.length;m<C;m++){const P=l[m];if(P.isDirectionalLight){const M=i.directional[u];M.direction.setFromMatrixPosition(P.matrixWorld),r.setFromMatrixPosition(P.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(g),u++}else if(P.isSpotLight){const M=i.spot[h];M.position.setFromMatrixPosition(P.matrixWorld),M.position.applyMatrix4(g),M.direction.setFromMatrixPosition(P.matrixWorld),r.setFromMatrixPosition(P.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(g),h++}else if(P.isRectAreaLight){const M=i.rectArea[_];M.position.setFromMatrixPosition(P.matrixWorld),M.position.applyMatrix4(g),a.identity(),s.copy(P.matrixWorld),s.premultiply(g),a.extractRotation(s),M.halfWidth.set(P.width*.5,0,0),M.halfHeight.set(0,P.height*.5,0),M.halfWidth.applyMatrix4(a),M.halfHeight.applyMatrix4(a),_++}else if(P.isPointLight){const M=i.point[d];M.position.setFromMatrixPosition(P.matrixWorld),M.position.applyMatrix4(g),d++}else if(P.isHemisphereLight){const M=i.hemi[x];M.direction.setFromMatrixPosition(P.matrixWorld),M.direction.transformDirection(g),x++}}}return{setup:o,setupView:c,state:i}}function wc(n){const e=new R_(n),t=[],i=[],r=[];function s(d){u.camera=d,t.length=0,i.length=0,r.length=0}function a(d){t.push(d)}function o(d){i.push(d)}function c(d){r.push(d)}function l(){e.setup(t)}function p(d){e.setupView(t,d)}const u={lightsArray:t,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:u,setupLights:l,setupLightsView:p,pushLight:a,pushShadow:o,pushLightProbeGrid:c}}function C_(n){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new wc(n),e.set(r,[o])):s>=a.length?(o=new wc(n),a.push(o)):o=a[s],o}function i(){e=new WeakMap}return{get:t,dispose:i}}const P_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,I_=[new re(1,0,0),new re(-1,0,0),new re(0,1,0),new re(0,-1,0),new re(0,0,1),new re(0,0,-1)],D_=[new re(0,-1,0),new re(0,-1,0),new re(0,0,1),new re(0,0,-1),new re(0,-1,0),new re(0,-1,0)],Ac=new Kt,ns=new re,no=new re;function U_(n,e,t){let i=new Sd;const r=new Tt,s=new Tt,a=new Ht,o=new Kf,c=new $f,l={},p=t.maxTextureSize,u={[Gi]:_n,[_n]:Gi,[vi]:vi},d=new si({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Tt},radius:{value:4}},vertexShader:P_,fragmentShader:L_}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const _=new ai;_.setAttribute("position",new zn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new ri(_,d),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$s;let m=this.type;this.render=function(T,D,v){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||T.length===0)return;this.type===Ou&&(tt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=$s);const S=n.getRenderTarget(),w=n.getActiveCubeFace(),L=n.getActiveMipmapLevel(),H=n.state;H.setBlending(Mi),H.buffers.depth.getReversed()===!0?H.buffers.color.setClear(0,0,0,0):H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const Z=m!==this.type;Z&&D.traverse(function(k){k.material&&(Array.isArray(k.material)?k.material.forEach(z=>z.needsUpdate=!0):k.material.needsUpdate=!0)});for(let k=0,z=T.length;k<z;k++){const R=T[k],A=R.shadow;if(A===void 0){tt("WebGLShadowMap:",R,"has no shadow.");continue}if(A.autoUpdate===!1&&A.needsUpdate===!1)continue;r.copy(A.mapSize);const G=A.getFrameExtents();r.multiply(G),s.copy(A.mapSize),(r.x>p||r.y>p)&&(r.x>p&&(s.x=Math.floor(p/G.x),r.x=s.x*G.x,A.mapSize.x=s.x),r.y>p&&(s.y=Math.floor(p/G.y),r.y=s.y*G.y,A.mapSize.y=s.y));const Y=n.state.buffers.depth.getReversed();if(A.camera._reversedDepth=Y,A.map===null||Z===!0){if(A.map!==null&&(A.map.depthTexture!==null&&(A.map.depthTexture.dispose(),A.map.depthTexture=null),A.map.dispose()),this.type===rs){if(R.isPointLight){tt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}A.map=new ni(r.x,r.y,{format:cr,type:wi,minFilter:sn,magFilter:sn,generateMipmaps:!1}),A.map.texture.name=R.name+".shadowMap",A.map.depthTexture=new zr(r.x,r.y,ei),A.map.depthTexture.name=R.name+".shadowMapDepth",A.map.depthTexture.format=Ai,A.map.depthTexture.compareFunction=null,A.map.depthTexture.minFilter=rn,A.map.depthTexture.magFilter=rn}else R.isPointLight?(A.map=new Cd(r.x),A.map.depthTexture=new Hf(r.x,ii)):(A.map=new ni(r.x,r.y),A.map.depthTexture=new zr(r.x,r.y,ii)),A.map.depthTexture.name=R.name+".shadowMap",A.map.depthTexture.format=Ai,this.type===$s?(A.map.depthTexture.compareFunction=Y?ml:pl,A.map.depthTexture.minFilter=sn,A.map.depthTexture.magFilter=sn):(A.map.depthTexture.compareFunction=null,A.map.depthTexture.minFilter=rn,A.map.depthTexture.magFilter=rn);A.camera.updateProjectionMatrix()}const ne=A.map.isWebGLCubeRenderTarget?6:1;for(let de=0;de<ne;de++){if(A.map.isWebGLCubeRenderTarget)n.setRenderTarget(A.map,de),n.clear();else{de===0&&(n.setRenderTarget(A.map),n.clear());const ce=A.getViewport(de);a.set(s.x*ce.x,s.y*ce.y,s.x*ce.z,s.y*ce.w),H.viewport(a)}if(R.isPointLight){const ce=A.camera,J=A.matrix,ue=R.distance||ce.far;ue!==ce.far&&(ce.far=ue,ce.updateProjectionMatrix()),ns.setFromMatrixPosition(R.matrixWorld),ce.position.copy(ns),no.copy(ce.position),no.add(I_[de]),ce.up.copy(D_[de]),ce.lookAt(no),ce.updateMatrixWorld(),J.makeTranslation(-ns.x,-ns.y,-ns.z),Ac.multiplyMatrices(ce.projectionMatrix,ce.matrixWorldInverse),A._frustum.setFromProjectionMatrix(Ac,ce.coordinateSystem,ce.reversedDepth)}else A.updateMatrices(R);i=A.getFrustum(),M(D,v,A.camera,R,this.type)}A.isPointLightShadow!==!0&&this.type===rs&&C(A,v),A.needsUpdate=!1}m=this.type,g.needsUpdate=!1,n.setRenderTarget(S,w,L)};function C(T,D){const v=e.update(x);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,h.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new ni(r.x,r.y,{format:cr,type:wi})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(D,null,v,d,x,null),h.uniforms.shadow_pass.value=T.mapPass.texture,h.uniforms.resolution.value=T.mapSize,h.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(D,null,v,h,x,null)}function P(T,D,v,S){let w=null;const L=v.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(L!==void 0)w=L;else if(w=v.isPointLight===!0?c:o,n.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0||D.alphaToCoverage===!0){const H=w.uuid,Z=D.uuid;let k=l[H];k===void 0&&(k={},l[H]=k);let z=k[Z];z===void 0&&(z=w.clone(),k[Z]=z,D.addEventListener("dispose",I)),w=z}if(w.visible=D.visible,w.wireframe=D.wireframe,S===rs?w.side=D.shadowSide!==null?D.shadowSide:D.side:w.side=D.shadowSide!==null?D.shadowSide:u[D.side],w.alphaMap=D.alphaMap,w.alphaTest=D.alphaToCoverage===!0?.5:D.alphaTest,w.map=D.map,w.clipShadows=D.clipShadows,w.clippingPlanes=D.clippingPlanes,w.clipIntersection=D.clipIntersection,w.displacementMap=D.displacementMap,w.displacementScale=D.displacementScale,w.displacementBias=D.displacementBias,w.wireframeLinewidth=D.wireframeLinewidth,w.linewidth=D.linewidth,v.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const H=n.properties.get(w);H.light=v}return w}function M(T,D,v,S,w){if(T.visible===!1)return;if(T.layers.test(D.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&w===rs)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,T.matrixWorld);const Z=e.update(T),k=T.material;if(Array.isArray(k)){const z=Z.groups;for(let R=0,A=z.length;R<A;R++){const G=z[R],Y=k[G.materialIndex];if(Y&&Y.visible){const ne=P(T,Y,S,w);T.onBeforeShadow(n,T,D,v,Z,ne,G),n.renderBufferDirect(v,null,Z,ne,T,G),T.onAfterShadow(n,T,D,v,Z,ne,G)}}}else if(k.visible){const z=P(T,k,S,w);T.onBeforeShadow(n,T,D,v,Z,z,null),n.renderBufferDirect(v,null,Z,z,T,null),T.onAfterShadow(n,T,D,v,Z,z,null)}}const H=T.children;for(let Z=0,k=H.length;Z<k;Z++)M(H[Z],D,v,S,w)}function I(T){T.target.removeEventListener("dispose",I);for(const v in l){const S=l[v],w=T.target.uuid;w in S&&(S[w].dispose(),delete S[w])}}}function N_(n,e){function t(){let X=!1;const Ce=new Ht;let ge=null;const Pe=new Ht(0,0,0,0);return{setMask:function(Le){ge!==Le&&!X&&(n.colorMask(Le,Le,Le,Le),ge=Le)},setLocked:function(Le){X=Le},setClear:function(Le,ye,He,Ee,Dt){Dt===!0&&(Le*=Ee,ye*=Ee,He*=Ee),Ce.set(Le,ye,He,Ee),Pe.equals(Ce)===!1&&(n.clearColor(Le,ye,He,Ee),Pe.copy(Ce))},reset:function(){X=!1,ge=null,Pe.set(-1,0,0,0)}}}function i(){let X=!1,Ce=!1,ge=null,Pe=null,Le=null;return{setReversed:function(ye){if(Ce!==ye){const He=e.get("EXT_clip_control");ye?He.clipControlEXT(He.LOWER_LEFT_EXT,He.ZERO_TO_ONE_EXT):He.clipControlEXT(He.LOWER_LEFT_EXT,He.NEGATIVE_ONE_TO_ONE_EXT),Ce=ye;const Ee=Le;Le=null,this.setClear(Ee)}},getReversed:function(){return Ce},setTest:function(ye){ye?$(n.DEPTH_TEST):se(n.DEPTH_TEST)},setMask:function(ye){ge!==ye&&!X&&(n.depthMask(ye),ge=ye)},setFunc:function(ye){if(Ce&&(ye=mf[ye]),Pe!==ye){switch(ye){case lo:n.depthFunc(n.NEVER);break;case co:n.depthFunc(n.ALWAYS);break;case uo:n.depthFunc(n.LESS);break;case Br:n.depthFunc(n.LEQUAL);break;case fo:n.depthFunc(n.EQUAL);break;case ho:n.depthFunc(n.GEQUAL);break;case po:n.depthFunc(n.GREATER);break;case mo:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Pe=ye}},setLocked:function(ye){X=ye},setClear:function(ye){Le!==ye&&(Le=ye,Ce&&(ye=1-ye),n.clearDepth(ye))},reset:function(){X=!1,ge=null,Pe=null,Le=null,Ce=!1}}}function r(){let X=!1,Ce=null,ge=null,Pe=null,Le=null,ye=null,He=null,Ee=null,Dt=null;return{setTest:function(gt){X||(gt?$(n.STENCIL_TEST):se(n.STENCIL_TEST))},setMask:function(gt){Ce!==gt&&!X&&(n.stencilMask(gt),Ce=gt)},setFunc:function(gt,St,tn){(ge!==gt||Pe!==St||Le!==tn)&&(n.stencilFunc(gt,St,tn),ge=gt,Pe=St,Le=tn)},setOp:function(gt,St,tn){(ye!==gt||He!==St||Ee!==tn)&&(n.stencilOp(gt,St,tn),ye=gt,He=St,Ee=tn)},setLocked:function(gt){X=gt},setClear:function(gt){Dt!==gt&&(n.clearStencil(gt),Dt=gt)},reset:function(){X=!1,Ce=null,ge=null,Pe=null,Le=null,ye=null,He=null,Ee=null,Dt=null}}}const s=new t,a=new i,o=new r,c=new WeakMap,l=new WeakMap;let p={},u={},d={},h=new WeakMap,_=[],x=null,g=!1,m=null,C=null,P=null,M=null,I=null,T=null,D=null,v=new Lt(0,0,0),S=0,w=!1,L=null,H=null,Z=null,k=null,z=null;const R=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let A=!1,G=0;const Y=n.getParameter(n.VERSION);Y.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(Y)[1]),A=G>=1):Y.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),A=G>=2);let ne=null,de={};const ce=n.getParameter(n.SCISSOR_BOX),J=n.getParameter(n.VIEWPORT),ue=new Ht().fromArray(ce),me=new Ht().fromArray(J);function B(X,Ce,ge,Pe){const Le=new Uint8Array(4),ye=n.createTexture();n.bindTexture(X,ye),n.texParameteri(X,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(X,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let He=0;He<ge;He++)X===n.TEXTURE_3D||X===n.TEXTURE_2D_ARRAY?n.texImage3D(Ce,0,n.RGBA,1,1,Pe,0,n.RGBA,n.UNSIGNED_BYTE,Le):n.texImage2D(Ce+He,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Le);return ye}const oe={};oe[n.TEXTURE_2D]=B(n.TEXTURE_2D,n.TEXTURE_2D,1),oe[n.TEXTURE_CUBE_MAP]=B(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),oe[n.TEXTURE_2D_ARRAY]=B(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),oe[n.TEXTURE_3D]=B(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),$(n.DEPTH_TEST),a.setFunc(Br),Ae(!1),be(Dl),$(n.CULL_FACE),ae(Mi);function $(X){p[X]!==!0&&(n.enable(X),p[X]=!0)}function se(X){p[X]!==!1&&(n.disable(X),p[X]=!1)}function _e(X,Ce){return d[X]!==Ce?(n.bindFramebuffer(X,Ce),d[X]=Ce,X===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=Ce),X===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=Ce),!0):!1}function Me(X,Ce){let ge=_,Pe=!1;if(X){ge=h.get(Ce),ge===void 0&&(ge=[],h.set(Ce,ge));const Le=X.textures;if(ge.length!==Le.length||ge[0]!==n.COLOR_ATTACHMENT0){for(let ye=0,He=Le.length;ye<He;ye++)ge[ye]=n.COLOR_ATTACHMENT0+ye;ge.length=Le.length,Pe=!0}}else ge[0]!==n.BACK&&(ge[0]=n.BACK,Pe=!0);Pe&&n.drawBuffers(ge)}function ve(X){return x!==X?(n.useProgram(X),x=X,!0):!1}const F={[Oi]:n.FUNC_ADD,[Bu]:n.FUNC_SUBTRACT,[ku]:n.FUNC_REVERSE_SUBTRACT};F[zu]=n.MIN,F[Gu]=n.MAX;const K={[Vu]:n.ZERO,[ao]:n.ONE,[Hu]:n.SRC_COLOR,[oo]:n.SRC_ALPHA,[Ku]:n.SRC_ALPHA_SATURATE,[qu]:n.DST_COLOR,[Wu]:n.DST_ALPHA,[Jc]:n.ONE_MINUS_SRC_COLOR,[os]:n.ONE_MINUS_SRC_ALPHA,[Yu]:n.ONE_MINUS_DST_COLOR,[Xu]:n.ONE_MINUS_DST_ALPHA,[$u]:n.CONSTANT_COLOR,[Zu]:n.ONE_MINUS_CONSTANT_COLOR,[Ju]:n.CONSTANT_ALPHA,[Qu]:n.ONE_MINUS_CONSTANT_ALPHA};function ae(X,Ce,ge,Pe,Le,ye,He,Ee,Dt,gt){if(X===Mi){g===!0&&(se(n.BLEND),g=!1);return}if(g===!1&&($(n.BLEND),g=!0),X!==Zc){if(X!==m||gt!==w){if((C!==Oi||I!==Oi)&&(n.blendEquation(n.FUNC_ADD),C=Oi,I=Oi),gt)switch(X){case Nr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ul:n.blendFunc(n.ONE,n.ONE);break;case Nl:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Fl:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Et("WebGLState: Invalid blending: ",X);break}else switch(X){case Nr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ul:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Nl:Et("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Fl:Et("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Et("WebGLState: Invalid blending: ",X);break}P=null,M=null,T=null,D=null,v.set(0,0,0),S=0,m=X,w=gt}return}Le=Le||Ce,ye=ye||ge,He=He||Pe,(Ce!==C||Le!==I)&&(n.blendEquationSeparate(F[Ce],F[Le]),C=Ce,I=Le),(ge!==P||Pe!==M||ye!==T||He!==D)&&(n.blendFuncSeparate(K[ge],K[Pe],K[ye],K[He]),P=ge,M=Pe,T=ye,D=He),(Ee.equals(v)===!1||Dt!==S)&&(n.blendColor(Ee.r,Ee.g,Ee.b,Dt),v.copy(Ee),S=Dt),m=X,w=!1}function xe(X,Ce){X.side===vi?se(n.CULL_FACE):$(n.CULL_FACE);let ge=X.side===_n;Ce&&(ge=!ge),Ae(ge),X.blending===Nr&&X.transparent===!1?ae(Mi):ae(X.blending,X.blendEquation,X.blendSrc,X.blendDst,X.blendEquationAlpha,X.blendSrcAlpha,X.blendDstAlpha,X.blendColor,X.blendAlpha,X.premultipliedAlpha),a.setFunc(X.depthFunc),a.setTest(X.depthTest),a.setMask(X.depthWrite),s.setMask(X.colorWrite);const Pe=X.stencilWrite;o.setTest(Pe),Pe&&(o.setMask(X.stencilWriteMask),o.setFunc(X.stencilFunc,X.stencilRef,X.stencilFuncMask),o.setOp(X.stencilFail,X.stencilZFail,X.stencilZPass)),Xe(X.polygonOffset,X.polygonOffsetFactor,X.polygonOffsetUnits),X.alphaToCoverage===!0?$(n.SAMPLE_ALPHA_TO_COVERAGE):se(n.SAMPLE_ALPHA_TO_COVERAGE)}function Ae(X){L!==X&&(X?n.frontFace(n.CW):n.frontFace(n.CCW),L=X)}function be(X){X!==Nu?($(n.CULL_FACE),X!==H&&(X===Dl?n.cullFace(n.BACK):X===Fu?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):se(n.CULL_FACE),H=X}function ke(X){X!==Z&&(A&&n.lineWidth(X),Z=X)}function Xe(X,Ce,ge){X?($(n.POLYGON_OFFSET_FILL),(k!==Ce||z!==ge)&&(k=Ce,z=ge,a.getReversed()&&(Ce=-Ce),n.polygonOffset(Ce,ge))):se(n.POLYGON_OFFSET_FILL)}function Ze(X){X?$(n.SCISSOR_TEST):se(n.SCISSOR_TEST)}function Ne(X){X===void 0&&(X=n.TEXTURE0+R-1),ne!==X&&(n.activeTexture(X),ne=X)}function N(X,Ce,ge){ge===void 0&&(ne===null?ge=n.TEXTURE0+R-1:ge=ne);let Pe=de[ge];Pe===void 0&&(Pe={type:void 0,texture:void 0},de[ge]=Pe),(Pe.type!==X||Pe.texture!==Ce)&&(ne!==ge&&(n.activeTexture(ge),ne=ge),n.bindTexture(X,Ce||oe[X]),Pe.type=X,Pe.texture=Ce)}function at(){const X=de[ne];X!==void 0&&X.type!==void 0&&(n.bindTexture(X.type,null),X.type=void 0,X.texture=void 0)}function $e(){try{n.compressedTexImage2D(...arguments)}catch(X){Et("WebGLState:",X)}}function E(){try{n.compressedTexImage3D(...arguments)}catch(X){Et("WebGLState:",X)}}function f(){try{n.texSubImage2D(...arguments)}catch(X){Et("WebGLState:",X)}}function U(){try{n.texSubImage3D(...arguments)}catch(X){Et("WebGLState:",X)}}function O(){try{n.compressedTexSubImage2D(...arguments)}catch(X){Et("WebGLState:",X)}}function V(){try{n.compressedTexSubImage3D(...arguments)}catch(X){Et("WebGLState:",X)}}function fe(){try{n.texStorage2D(...arguments)}catch(X){Et("WebGLState:",X)}}function he(){try{n.texStorage3D(...arguments)}catch(X){Et("WebGLState:",X)}}function ee(){try{n.texImage2D(...arguments)}catch(X){Et("WebGLState:",X)}}function te(){try{n.texImage3D(...arguments)}catch(X){Et("WebGLState:",X)}}function Se(X){return u[X]!==void 0?u[X]:n.getParameter(X)}function Ue(X,Ce){u[X]!==Ce&&(n.pixelStorei(X,Ce),u[X]=Ce)}function we(X){ue.equals(X)===!1&&(n.scissor(X.x,X.y,X.z,X.w),ue.copy(X))}function Te(X){me.equals(X)===!1&&(n.viewport(X.x,X.y,X.z,X.w),me.copy(X))}function Ve(X,Ce){let ge=l.get(Ce);ge===void 0&&(ge=new WeakMap,l.set(Ce,ge));let Pe=ge.get(X);Pe===void 0&&(Pe=n.getUniformBlockIndex(Ce,X.name),ge.set(X,Pe))}function Ge(X,Ce){const Pe=l.get(Ce).get(X);c.get(Ce)!==Pe&&(n.uniformBlockBinding(Ce,Pe,X.__bindingPointIndex),c.set(Ce,Pe))}function it(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),p={},u={},ne=null,de={},d={},h=new WeakMap,_=[],x=null,g=!1,m=null,C=null,P=null,M=null,I=null,T=null,D=null,v=new Lt(0,0,0),S=0,w=!1,L=null,H=null,Z=null,k=null,z=null,ue.set(0,0,n.canvas.width,n.canvas.height),me.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:$,disable:se,bindFramebuffer:_e,drawBuffers:Me,useProgram:ve,setBlending:ae,setMaterial:xe,setFlipSided:Ae,setCullFace:be,setLineWidth:ke,setPolygonOffset:Xe,setScissorTest:Ze,activeTexture:Ne,bindTexture:N,unbindTexture:at,compressedTexImage2D:$e,compressedTexImage3D:E,texImage2D:ee,texImage3D:te,pixelStorei:Ue,getParameter:Se,updateUBOMapping:Ve,uniformBlockBinding:Ge,texStorage2D:fe,texStorage3D:he,texSubImage2D:f,texSubImage3D:U,compressedTexSubImage2D:O,compressedTexSubImage3D:V,scissor:we,viewport:Te,reset:it}}function F_(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Tt,p=new WeakMap,u=new Set;let d;const h=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(E,f){return _?new OffscreenCanvas(E,f):oa("canvas")}function g(E,f,U){let O=1;const V=$e(E);if((V.width>U||V.height>U)&&(O=U/Math.max(V.width,V.height)),O<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const fe=Math.floor(O*V.width),he=Math.floor(O*V.height);d===void 0&&(d=x(fe,he));const ee=f?x(fe,he):d;return ee.width=fe,ee.height=he,ee.getContext("2d").drawImage(E,0,0,fe,he),tt("WebGLRenderer: Texture has been resized from ("+V.width+"x"+V.height+") to ("+fe+"x"+he+")."),ee}else return"data"in E&&tt("WebGLRenderer: Image in DataTexture is too big ("+V.width+"x"+V.height+")."),E;return E}function m(E){return E.generateMipmaps}function C(E){n.generateMipmap(E)}function P(E){return E.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?n.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function M(E,f,U,O,V,fe=!1){if(E!==null){if(n[E]!==void 0)return n[E];tt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let he;O&&(he=e.get("EXT_texture_norm16"),he||tt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let ee=f;if(f===n.RED&&(U===n.FLOAT&&(ee=n.R32F),U===n.HALF_FLOAT&&(ee=n.R16F),U===n.UNSIGNED_BYTE&&(ee=n.R8),U===n.UNSIGNED_SHORT&&he&&(ee=he.R16_EXT),U===n.SHORT&&he&&(ee=he.R16_SNORM_EXT)),f===n.RED_INTEGER&&(U===n.UNSIGNED_BYTE&&(ee=n.R8UI),U===n.UNSIGNED_SHORT&&(ee=n.R16UI),U===n.UNSIGNED_INT&&(ee=n.R32UI),U===n.BYTE&&(ee=n.R8I),U===n.SHORT&&(ee=n.R16I),U===n.INT&&(ee=n.R32I)),f===n.RG&&(U===n.FLOAT&&(ee=n.RG32F),U===n.HALF_FLOAT&&(ee=n.RG16F),U===n.UNSIGNED_BYTE&&(ee=n.RG8),U===n.UNSIGNED_SHORT&&he&&(ee=he.RG16_EXT),U===n.SHORT&&he&&(ee=he.RG16_SNORM_EXT)),f===n.RG_INTEGER&&(U===n.UNSIGNED_BYTE&&(ee=n.RG8UI),U===n.UNSIGNED_SHORT&&(ee=n.RG16UI),U===n.UNSIGNED_INT&&(ee=n.RG32UI),U===n.BYTE&&(ee=n.RG8I),U===n.SHORT&&(ee=n.RG16I),U===n.INT&&(ee=n.RG32I)),f===n.RGB_INTEGER&&(U===n.UNSIGNED_BYTE&&(ee=n.RGB8UI),U===n.UNSIGNED_SHORT&&(ee=n.RGB16UI),U===n.UNSIGNED_INT&&(ee=n.RGB32UI),U===n.BYTE&&(ee=n.RGB8I),U===n.SHORT&&(ee=n.RGB16I),U===n.INT&&(ee=n.RGB32I)),f===n.RGBA_INTEGER&&(U===n.UNSIGNED_BYTE&&(ee=n.RGBA8UI),U===n.UNSIGNED_SHORT&&(ee=n.RGBA16UI),U===n.UNSIGNED_INT&&(ee=n.RGBA32UI),U===n.BYTE&&(ee=n.RGBA8I),U===n.SHORT&&(ee=n.RGBA16I),U===n.INT&&(ee=n.RGBA32I)),f===n.RGB&&(U===n.UNSIGNED_SHORT&&he&&(ee=he.RGB16_EXT),U===n.SHORT&&he&&(ee=he.RGB16_SNORM_EXT),U===n.UNSIGNED_INT_5_9_9_9_REV&&(ee=n.RGB9_E5),U===n.UNSIGNED_INT_10F_11F_11F_REV&&(ee=n.R11F_G11F_B10F)),f===n.RGBA){const te=fe?sa:xt.getTransfer(V);U===n.FLOAT&&(ee=n.RGBA32F),U===n.HALF_FLOAT&&(ee=n.RGBA16F),U===n.UNSIGNED_BYTE&&(ee=te===It?n.SRGB8_ALPHA8:n.RGBA8),U===n.UNSIGNED_SHORT&&he&&(ee=he.RGBA16_EXT),U===n.SHORT&&he&&(ee=he.RGBA16_SNORM_EXT),U===n.UNSIGNED_SHORT_4_4_4_4&&(ee=n.RGBA4),U===n.UNSIGNED_SHORT_5_5_5_1&&(ee=n.RGB5_A1)}return(ee===n.R16F||ee===n.R32F||ee===n.RG16F||ee===n.RG32F||ee===n.RGBA16F||ee===n.RGBA32F)&&e.get("EXT_color_buffer_float"),ee}function I(E,f){let U;return E?f===null||f===ii||f===cs?U=n.DEPTH24_STENCIL8:f===ei?U=n.DEPTH32F_STENCIL8:f===ls&&(U=n.DEPTH24_STENCIL8,tt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):f===null||f===ii||f===cs?U=n.DEPTH_COMPONENT24:f===ei?U=n.DEPTH_COMPONENT32F:f===ls&&(U=n.DEPTH_COMPONENT16),U}function T(E,f){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==rn&&E.minFilter!==sn?Math.log2(Math.max(f.width,f.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?f.mipmaps.length:1}function D(E){const f=E.target;f.removeEventListener("dispose",D),S(f),f.isVideoTexture&&p.delete(f),f.isHTMLTexture&&u.delete(f)}function v(E){const f=E.target;f.removeEventListener("dispose",v),L(f)}function S(E){const f=i.get(E);if(f.__webglInit===void 0)return;const U=E.source,O=h.get(U);if(O){const V=O[f.__cacheKey];V.usedTimes--,V.usedTimes===0&&w(E),Object.keys(O).length===0&&h.delete(U)}i.remove(E)}function w(E){const f=i.get(E);n.deleteTexture(f.__webglTexture);const U=E.source,O=h.get(U);delete O[f.__cacheKey],a.memory.textures--}function L(E){const f=i.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),i.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let O=0;O<6;O++){if(Array.isArray(f.__webglFramebuffer[O]))for(let V=0;V<f.__webglFramebuffer[O].length;V++)n.deleteFramebuffer(f.__webglFramebuffer[O][V]);else n.deleteFramebuffer(f.__webglFramebuffer[O]);f.__webglDepthbuffer&&n.deleteRenderbuffer(f.__webglDepthbuffer[O])}else{if(Array.isArray(f.__webglFramebuffer))for(let O=0;O<f.__webglFramebuffer.length;O++)n.deleteFramebuffer(f.__webglFramebuffer[O]);else n.deleteFramebuffer(f.__webglFramebuffer);if(f.__webglDepthbuffer&&n.deleteRenderbuffer(f.__webglDepthbuffer),f.__webglMultisampledFramebuffer&&n.deleteFramebuffer(f.__webglMultisampledFramebuffer),f.__webglColorRenderbuffer)for(let O=0;O<f.__webglColorRenderbuffer.length;O++)f.__webglColorRenderbuffer[O]&&n.deleteRenderbuffer(f.__webglColorRenderbuffer[O]);f.__webglDepthRenderbuffer&&n.deleteRenderbuffer(f.__webglDepthRenderbuffer)}const U=E.textures;for(let O=0,V=U.length;O<V;O++){const fe=i.get(U[O]);fe.__webglTexture&&(n.deleteTexture(fe.__webglTexture),a.memory.textures--),i.remove(U[O])}i.remove(E)}let H=0;function Z(){H=0}function k(){return H}function z(E){H=E}function R(){const E=H;return E>=r.maxTextures&&tt("WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),H+=1,E}function A(E){const f=[];return f.push(E.wrapS),f.push(E.wrapT),f.push(E.wrapR||0),f.push(E.magFilter),f.push(E.minFilter),f.push(E.anisotropy),f.push(E.internalFormat),f.push(E.format),f.push(E.type),f.push(E.generateMipmaps),f.push(E.premultiplyAlpha),f.push(E.flipY),f.push(E.unpackAlignment),f.push(E.colorSpace),f.join()}function G(E,f){const U=i.get(E);if(E.isVideoTexture&&N(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&U.__version!==E.version){const O=E.image;if(O===null)tt("WebGLRenderer: Texture marked for update but no image data found.");else if(O.complete===!1)tt("WebGLRenderer: Texture marked for update but image is incomplete");else{se(U,E,f);return}}else E.isExternalTexture&&(U.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,U.__webglTexture,n.TEXTURE0+f)}function Y(E,f){const U=i.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&U.__version!==E.version){se(U,E,f);return}else E.isExternalTexture&&(U.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,U.__webglTexture,n.TEXTURE0+f)}function ne(E,f){const U=i.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&U.__version!==E.version){se(U,E,f);return}t.bindTexture(n.TEXTURE_3D,U.__webglTexture,n.TEXTURE0+f)}function de(E,f){const U=i.get(E);if(E.isCubeDepthTexture!==!0&&E.version>0&&U.__version!==E.version){_e(U,E,f);return}t.bindTexture(n.TEXTURE_CUBE_MAP,U.__webglTexture,n.TEXTURE0+f)}const ce={[go]:n.REPEAT,[Si]:n.CLAMP_TO_EDGE,[_o]:n.MIRRORED_REPEAT},J={[rn]:n.NEAREST,[tf]:n.NEAREST_MIPMAP_NEAREST,[ys]:n.NEAREST_MIPMAP_LINEAR,[sn]:n.LINEAR,[wa]:n.LINEAR_MIPMAP_NEAREST,[rr]:n.LINEAR_MIPMAP_LINEAR},ue={[sf]:n.NEVER,[df]:n.ALWAYS,[af]:n.LESS,[pl]:n.LEQUAL,[of]:n.EQUAL,[ml]:n.GEQUAL,[lf]:n.GREATER,[cf]:n.NOTEQUAL};function me(E,f){if(f.type===ei&&e.has("OES_texture_float_linear")===!1&&(f.magFilter===sn||f.magFilter===wa||f.magFilter===ys||f.magFilter===rr||f.minFilter===sn||f.minFilter===wa||f.minFilter===ys||f.minFilter===rr)&&tt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(E,n.TEXTURE_WRAP_S,ce[f.wrapS]),n.texParameteri(E,n.TEXTURE_WRAP_T,ce[f.wrapT]),(E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY)&&n.texParameteri(E,n.TEXTURE_WRAP_R,ce[f.wrapR]),n.texParameteri(E,n.TEXTURE_MAG_FILTER,J[f.magFilter]),n.texParameteri(E,n.TEXTURE_MIN_FILTER,J[f.minFilter]),f.compareFunction&&(n.texParameteri(E,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(E,n.TEXTURE_COMPARE_FUNC,ue[f.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(f.magFilter===rn||f.minFilter!==ys&&f.minFilter!==rr||f.type===ei&&e.has("OES_texture_float_linear")===!1)return;if(f.anisotropy>1||i.get(f).__currentAnisotropy){const U=e.get("EXT_texture_filter_anisotropic");n.texParameterf(E,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(f.anisotropy,r.getMaxAnisotropy())),i.get(f).__currentAnisotropy=f.anisotropy}}}function B(E,f){let U=!1;E.__webglInit===void 0&&(E.__webglInit=!0,f.addEventListener("dispose",D));const O=f.source;let V=h.get(O);V===void 0&&(V={},h.set(O,V));const fe=A(f);if(fe!==E.__cacheKey){V[fe]===void 0&&(V[fe]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,U=!0),V[fe].usedTimes++;const he=V[E.__cacheKey];he!==void 0&&(V[E.__cacheKey].usedTimes--,he.usedTimes===0&&w(f)),E.__cacheKey=fe,E.__webglTexture=V[fe].texture}return U}function oe(E,f,U){return Math.floor(Math.floor(E/U)/f)}function $(E,f,U,O){const fe=E.updateRanges;if(fe.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,f.width,f.height,U,O,f.data);else{fe.sort((Ue,we)=>Ue.start-we.start);let he=0;for(let Ue=1;Ue<fe.length;Ue++){const we=fe[he],Te=fe[Ue],Ve=we.start+we.count,Ge=oe(Te.start,f.width,4),it=oe(we.start,f.width,4);Te.start<=Ve+1&&Ge===it&&oe(Te.start+Te.count-1,f.width,4)===Ge?we.count=Math.max(we.count,Te.start+Te.count-we.start):(++he,fe[he]=Te)}fe.length=he+1;const ee=t.getParameter(n.UNPACK_ROW_LENGTH),te=t.getParameter(n.UNPACK_SKIP_PIXELS),Se=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,f.width);for(let Ue=0,we=fe.length;Ue<we;Ue++){const Te=fe[Ue],Ve=Math.floor(Te.start/4),Ge=Math.ceil(Te.count/4),it=Ve%f.width,X=Math.floor(Ve/f.width),Ce=Ge,ge=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,it),t.pixelStorei(n.UNPACK_SKIP_ROWS,X),t.texSubImage2D(n.TEXTURE_2D,0,it,X,Ce,ge,U,O,f.data)}E.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,ee),t.pixelStorei(n.UNPACK_SKIP_PIXELS,te),t.pixelStorei(n.UNPACK_SKIP_ROWS,Se)}}function se(E,f,U){let O=n.TEXTURE_2D;(f.isDataArrayTexture||f.isCompressedArrayTexture)&&(O=n.TEXTURE_2D_ARRAY),f.isData3DTexture&&(O=n.TEXTURE_3D);const V=B(E,f),fe=f.source;t.bindTexture(O,E.__webglTexture,n.TEXTURE0+U);const he=i.get(fe);if(fe.version!==he.__version||V===!0){if(t.activeTexture(n.TEXTURE0+U),(typeof ImageBitmap<"u"&&f.image instanceof ImageBitmap)===!1){const ge=xt.getPrimaries(xt.workingColorSpace),Pe=f.colorSpace===xi?null:xt.getPrimaries(f.colorSpace),Le=f.colorSpace===xi||ge===Pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,f.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,f.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Le)}t.pixelStorei(n.UNPACK_ALIGNMENT,f.unpackAlignment);let te=g(f.image,!1,r.maxTextureSize);te=at(f,te);const Se=s.convert(f.format,f.colorSpace),Ue=s.convert(f.type);let we=M(f.internalFormat,Se,Ue,f.normalized,f.colorSpace,f.isVideoTexture);me(O,f);let Te;const Ve=f.mipmaps,Ge=f.isVideoTexture!==!0,it=he.__version===void 0||V===!0,X=fe.dataReady,Ce=T(f,te);if(f.isDepthTexture)we=I(f.format===sr,f.type),it&&(Ge?t.texStorage2D(n.TEXTURE_2D,1,we,te.width,te.height):t.texImage2D(n.TEXTURE_2D,0,we,te.width,te.height,0,Se,Ue,null));else if(f.isDataTexture)if(Ve.length>0){Ge&&it&&t.texStorage2D(n.TEXTURE_2D,Ce,we,Ve[0].width,Ve[0].height);for(let ge=0,Pe=Ve.length;ge<Pe;ge++)Te=Ve[ge],Ge?X&&t.texSubImage2D(n.TEXTURE_2D,ge,0,0,Te.width,Te.height,Se,Ue,Te.data):t.texImage2D(n.TEXTURE_2D,ge,we,Te.width,Te.height,0,Se,Ue,Te.data);f.generateMipmaps=!1}else Ge?(it&&t.texStorage2D(n.TEXTURE_2D,Ce,we,te.width,te.height),X&&$(f,te,Se,Ue)):t.texImage2D(n.TEXTURE_2D,0,we,te.width,te.height,0,Se,Ue,te.data);else if(f.isCompressedTexture)if(f.isCompressedArrayTexture){Ge&&it&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ce,we,Ve[0].width,Ve[0].height,te.depth);for(let ge=0,Pe=Ve.length;ge<Pe;ge++)if(Te=Ve[ge],f.format!==Bn)if(Se!==null)if(Ge){if(X)if(f.layerUpdates.size>0){const Le=rc(Te.width,Te.height,f.format,f.type);for(const ye of f.layerUpdates){const He=Te.data.subarray(ye*Le/Te.data.BYTES_PER_ELEMENT,(ye+1)*Le/Te.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ge,0,0,ye,Te.width,Te.height,1,Se,He)}f.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ge,0,0,0,Te.width,Te.height,te.depth,Se,Te.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ge,we,Te.width,Te.height,te.depth,0,Te.data,0,0);else tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?X&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ge,0,0,0,Te.width,Te.height,te.depth,Se,Ue,Te.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ge,we,Te.width,Te.height,te.depth,0,Se,Ue,Te.data)}else{Ge&&it&&t.texStorage2D(n.TEXTURE_2D,Ce,we,Ve[0].width,Ve[0].height);for(let ge=0,Pe=Ve.length;ge<Pe;ge++)Te=Ve[ge],f.format!==Bn?Se!==null?Ge?X&&t.compressedTexSubImage2D(n.TEXTURE_2D,ge,0,0,Te.width,Te.height,Se,Te.data):t.compressedTexImage2D(n.TEXTURE_2D,ge,we,Te.width,Te.height,0,Te.data):tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?X&&t.texSubImage2D(n.TEXTURE_2D,ge,0,0,Te.width,Te.height,Se,Ue,Te.data):t.texImage2D(n.TEXTURE_2D,ge,we,Te.width,Te.height,0,Se,Ue,Te.data)}else if(f.isDataArrayTexture)if(Ge){if(it&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ce,we,te.width,te.height,te.depth),X)if(f.layerUpdates.size>0){const ge=rc(te.width,te.height,f.format,f.type);for(const Pe of f.layerUpdates){const Le=te.data.subarray(Pe*ge/te.data.BYTES_PER_ELEMENT,(Pe+1)*ge/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,Pe,te.width,te.height,1,Se,Ue,Le)}f.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,Se,Ue,te.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,we,te.width,te.height,te.depth,0,Se,Ue,te.data);else if(f.isData3DTexture)Ge?(it&&t.texStorage3D(n.TEXTURE_3D,Ce,we,te.width,te.height,te.depth),X&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,Se,Ue,te.data)):t.texImage3D(n.TEXTURE_3D,0,we,te.width,te.height,te.depth,0,Se,Ue,te.data);else if(f.isFramebufferTexture){if(it)if(Ge)t.texStorage2D(n.TEXTURE_2D,Ce,we,te.width,te.height);else{let ge=te.width,Pe=te.height;for(let Le=0;Le<Ce;Le++)t.texImage2D(n.TEXTURE_2D,Le,we,ge,Pe,0,Se,Ue,null),ge>>=1,Pe>>=1}}else if(f.isHTMLTexture){if("texElementImage2D"in n){const ge=n.canvas;if(ge.hasAttribute("layoutsubtree")||ge.setAttribute("layoutsubtree","true"),te.parentNode!==ge){ge.appendChild(te),u.add(f),ge.onpaint=Pe=>{const Le=Pe.changedElements;for(const ye of u)Le.includes(ye.image)&&(ye.needsUpdate=!0)},ge.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,te);else{const Le=n.RGBA,ye=n.RGBA,He=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,Le,ye,He,te)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Ve.length>0){if(Ge&&it){const ge=$e(Ve[0]);t.texStorage2D(n.TEXTURE_2D,Ce,we,ge.width,ge.height)}for(let ge=0,Pe=Ve.length;ge<Pe;ge++)Te=Ve[ge],Ge?X&&t.texSubImage2D(n.TEXTURE_2D,ge,0,0,Se,Ue,Te):t.texImage2D(n.TEXTURE_2D,ge,we,Se,Ue,Te);f.generateMipmaps=!1}else if(Ge){if(it){const ge=$e(te);t.texStorage2D(n.TEXTURE_2D,Ce,we,ge.width,ge.height)}X&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Se,Ue,te)}else t.texImage2D(n.TEXTURE_2D,0,we,Se,Ue,te);m(f)&&C(O),he.__version=fe.version,f.onUpdate&&f.onUpdate(f)}E.__version=f.version}function _e(E,f,U){if(f.image.length!==6)return;const O=B(E,f),V=f.source;t.bindTexture(n.TEXTURE_CUBE_MAP,E.__webglTexture,n.TEXTURE0+U);const fe=i.get(V);if(V.version!==fe.__version||O===!0){t.activeTexture(n.TEXTURE0+U);const he=xt.getPrimaries(xt.workingColorSpace),ee=f.colorSpace===xi?null:xt.getPrimaries(f.colorSpace),te=f.colorSpace===xi||he===ee?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,f.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,f.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,f.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,te);const Se=f.isCompressedTexture||f.image[0].isCompressedTexture,Ue=f.image[0]&&f.image[0].isDataTexture,we=[];for(let ye=0;ye<6;ye++)!Se&&!Ue?we[ye]=g(f.image[ye],!0,r.maxCubemapSize):we[ye]=Ue?f.image[ye].image:f.image[ye],we[ye]=at(f,we[ye]);const Te=we[0],Ve=s.convert(f.format,f.colorSpace),Ge=s.convert(f.type),it=M(f.internalFormat,Ve,Ge,f.normalized,f.colorSpace),X=f.isVideoTexture!==!0,Ce=fe.__version===void 0||O===!0,ge=V.dataReady;let Pe=T(f,Te);me(n.TEXTURE_CUBE_MAP,f);let Le;if(Se){X&&Ce&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Pe,it,Te.width,Te.height);for(let ye=0;ye<6;ye++){Le=we[ye].mipmaps;for(let He=0;He<Le.length;He++){const Ee=Le[He];f.format!==Bn?Ve!==null?X?ge&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,He,0,0,Ee.width,Ee.height,Ve,Ee.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,He,it,Ee.width,Ee.height,0,Ee.data):tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):X?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,He,0,0,Ee.width,Ee.height,Ve,Ge,Ee.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,He,it,Ee.width,Ee.height,0,Ve,Ge,Ee.data)}}}else{if(Le=f.mipmaps,X&&Ce){Le.length>0&&Pe++;const ye=$e(we[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Pe,it,ye.width,ye.height)}for(let ye=0;ye<6;ye++)if(Ue){X?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,0,0,we[ye].width,we[ye].height,Ve,Ge,we[ye].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,it,we[ye].width,we[ye].height,0,Ve,Ge,we[ye].data);for(let He=0;He<Le.length;He++){const Dt=Le[He].image[ye].image;X?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,He+1,0,0,Dt.width,Dt.height,Ve,Ge,Dt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,He+1,it,Dt.width,Dt.height,0,Ve,Ge,Dt.data)}}else{X?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,0,0,Ve,Ge,we[ye]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,it,Ve,Ge,we[ye]);for(let He=0;He<Le.length;He++){const Ee=Le[He];X?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,He+1,0,0,Ve,Ge,Ee.image[ye]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,He+1,it,Ve,Ge,Ee.image[ye])}}}m(f)&&C(n.TEXTURE_CUBE_MAP),fe.__version=V.version,f.onUpdate&&f.onUpdate(f)}E.__version=f.version}function Me(E,f,U,O,V,fe){const he=s.convert(U.format,U.colorSpace),ee=s.convert(U.type),te=M(U.internalFormat,he,ee,U.normalized,U.colorSpace),Se=i.get(f),Ue=i.get(U);if(Ue.__renderTarget=f,!Se.__hasExternalTextures){const we=Math.max(1,f.width>>fe),Te=Math.max(1,f.height>>fe);V===n.TEXTURE_3D||V===n.TEXTURE_2D_ARRAY?t.texImage3D(V,fe,te,we,Te,f.depth,0,he,ee,null):t.texImage2D(V,fe,te,we,Te,0,he,ee,null)}t.bindFramebuffer(n.FRAMEBUFFER,E),Ne(f)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,O,V,Ue.__webglTexture,0,Ze(f)):(V===n.TEXTURE_2D||V>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&V<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,O,V,Ue.__webglTexture,fe),t.bindFramebuffer(n.FRAMEBUFFER,null)}function ve(E,f,U){if(n.bindRenderbuffer(n.RENDERBUFFER,E),f.depthBuffer){const O=f.depthTexture,V=O&&O.isDepthTexture?O.type:null,fe=I(f.stencilBuffer,V),he=f.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Ne(f)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ze(f),fe,f.width,f.height):U?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ze(f),fe,f.width,f.height):n.renderbufferStorage(n.RENDERBUFFER,fe,f.width,f.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,E)}else{const O=f.textures;for(let V=0;V<O.length;V++){const fe=O[V],he=s.convert(fe.format,fe.colorSpace),ee=s.convert(fe.type),te=M(fe.internalFormat,he,ee,fe.normalized,fe.colorSpace);Ne(f)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ze(f),te,f.width,f.height):U?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ze(f),te,f.width,f.height):n.renderbufferStorage(n.RENDERBUFFER,te,f.width,f.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function F(E,f,U){const O=f.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,E),!(f.depthTexture&&f.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const V=i.get(f.depthTexture);if(V.__renderTarget=f,(!V.__webglTexture||f.depthTexture.image.width!==f.width||f.depthTexture.image.height!==f.height)&&(f.depthTexture.image.width=f.width,f.depthTexture.image.height=f.height,f.depthTexture.needsUpdate=!0),O){if(V.__webglInit===void 0&&(V.__webglInit=!0,f.depthTexture.addEventListener("dispose",D)),V.__webglTexture===void 0){V.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,V.__webglTexture),me(n.TEXTURE_CUBE_MAP,f.depthTexture);const Se=s.convert(f.depthTexture.format),Ue=s.convert(f.depthTexture.type);let we;f.depthTexture.format===Ai?we=n.DEPTH_COMPONENT24:f.depthTexture.format===sr&&(we=n.DEPTH24_STENCIL8);for(let Te=0;Te<6;Te++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Te,0,we,f.width,f.height,0,Se,Ue,null)}}else G(f.depthTexture,0);const fe=V.__webglTexture,he=Ze(f),ee=O?n.TEXTURE_CUBE_MAP_POSITIVE_X+U:n.TEXTURE_2D,te=f.depthTexture.format===sr?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(f.depthTexture.format===Ai)Ne(f)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,te,ee,fe,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,te,ee,fe,0);else if(f.depthTexture.format===sr)Ne(f)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,te,ee,fe,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,te,ee,fe,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function K(E){const f=i.get(E),U=E.isWebGLCubeRenderTarget===!0;if(f.__boundDepthTexture!==E.depthTexture){const O=E.depthTexture;if(f.__depthDisposeCallback&&f.__depthDisposeCallback(),O){const V=()=>{delete f.__boundDepthTexture,delete f.__depthDisposeCallback,O.removeEventListener("dispose",V)};O.addEventListener("dispose",V),f.__depthDisposeCallback=V}f.__boundDepthTexture=O}if(E.depthTexture&&!f.__autoAllocateDepthBuffer)if(U)for(let O=0;O<6;O++)F(f.__webglFramebuffer[O],E,O);else{const O=E.texture.mipmaps;O&&O.length>0?F(f.__webglFramebuffer[0],E,0):F(f.__webglFramebuffer,E,0)}else if(U){f.__webglDepthbuffer=[];for(let O=0;O<6;O++)if(t.bindFramebuffer(n.FRAMEBUFFER,f.__webglFramebuffer[O]),f.__webglDepthbuffer[O]===void 0)f.__webglDepthbuffer[O]=n.createRenderbuffer(),ve(f.__webglDepthbuffer[O],E,!1);else{const V=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,fe=f.__webglDepthbuffer[O];n.bindRenderbuffer(n.RENDERBUFFER,fe),n.framebufferRenderbuffer(n.FRAMEBUFFER,V,n.RENDERBUFFER,fe)}}else{const O=E.texture.mipmaps;if(O&&O.length>0?t.bindFramebuffer(n.FRAMEBUFFER,f.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,f.__webglFramebuffer),f.__webglDepthbuffer===void 0)f.__webglDepthbuffer=n.createRenderbuffer(),ve(f.__webglDepthbuffer,E,!1);else{const V=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,fe=f.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,fe),n.framebufferRenderbuffer(n.FRAMEBUFFER,V,n.RENDERBUFFER,fe)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function ae(E,f,U){const O=i.get(E);f!==void 0&&Me(O.__webglFramebuffer,E,E.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),U!==void 0&&K(E)}function xe(E){const f=E.texture,U=i.get(E),O=i.get(f);E.addEventListener("dispose",v);const V=E.textures,fe=E.isWebGLCubeRenderTarget===!0,he=V.length>1;if(he||(O.__webglTexture===void 0&&(O.__webglTexture=n.createTexture()),O.__version=f.version,a.memory.textures++),fe){U.__webglFramebuffer=[];for(let ee=0;ee<6;ee++)if(f.mipmaps&&f.mipmaps.length>0){U.__webglFramebuffer[ee]=[];for(let te=0;te<f.mipmaps.length;te++)U.__webglFramebuffer[ee][te]=n.createFramebuffer()}else U.__webglFramebuffer[ee]=n.createFramebuffer()}else{if(f.mipmaps&&f.mipmaps.length>0){U.__webglFramebuffer=[];for(let ee=0;ee<f.mipmaps.length;ee++)U.__webglFramebuffer[ee]=n.createFramebuffer()}else U.__webglFramebuffer=n.createFramebuffer();if(he)for(let ee=0,te=V.length;ee<te;ee++){const Se=i.get(V[ee]);Se.__webglTexture===void 0&&(Se.__webglTexture=n.createTexture(),a.memory.textures++)}if(E.samples>0&&Ne(E)===!1){U.__webglMultisampledFramebuffer=n.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let ee=0;ee<V.length;ee++){const te=V[ee];U.__webglColorRenderbuffer[ee]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,U.__webglColorRenderbuffer[ee]);const Se=s.convert(te.format,te.colorSpace),Ue=s.convert(te.type),we=M(te.internalFormat,Se,Ue,te.normalized,te.colorSpace,E.isXRRenderTarget===!0),Te=Ze(E);n.renderbufferStorageMultisample(n.RENDERBUFFER,Te,we,E.width,E.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ee,n.RENDERBUFFER,U.__webglColorRenderbuffer[ee])}n.bindRenderbuffer(n.RENDERBUFFER,null),E.depthBuffer&&(U.__webglDepthRenderbuffer=n.createRenderbuffer(),ve(U.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(fe){t.bindTexture(n.TEXTURE_CUBE_MAP,O.__webglTexture),me(n.TEXTURE_CUBE_MAP,f);for(let ee=0;ee<6;ee++)if(f.mipmaps&&f.mipmaps.length>0)for(let te=0;te<f.mipmaps.length;te++)Me(U.__webglFramebuffer[ee][te],E,f,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,te);else Me(U.__webglFramebuffer[ee],E,f,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0);m(f)&&C(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(he){for(let ee=0,te=V.length;ee<te;ee++){const Se=V[ee],Ue=i.get(Se);let we=n.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(we=E.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(we,Ue.__webglTexture),me(we,Se),Me(U.__webglFramebuffer,E,Se,n.COLOR_ATTACHMENT0+ee,we,0),m(Se)&&C(we)}t.unbindTexture()}else{let ee=n.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ee=E.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ee,O.__webglTexture),me(ee,f),f.mipmaps&&f.mipmaps.length>0)for(let te=0;te<f.mipmaps.length;te++)Me(U.__webglFramebuffer[te],E,f,n.COLOR_ATTACHMENT0,ee,te);else Me(U.__webglFramebuffer,E,f,n.COLOR_ATTACHMENT0,ee,0);m(f)&&C(ee),t.unbindTexture()}E.depthBuffer&&K(E)}function Ae(E){const f=E.textures;for(let U=0,O=f.length;U<O;U++){const V=f[U];if(m(V)){const fe=P(E),he=i.get(V).__webglTexture;t.bindTexture(fe,he),C(fe),t.unbindTexture()}}}const be=[],ke=[];function Xe(E){if(E.samples>0){if(Ne(E)===!1){const f=E.textures,U=E.width,O=E.height;let V=n.COLOR_BUFFER_BIT;const fe=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,he=i.get(E),ee=f.length>1;if(ee)for(let Se=0;Se<f.length;Se++)t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer);const te=E.texture.mipmaps;te&&te.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let Se=0;Se<f.length;Se++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(V|=n.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(V|=n.STENCIL_BUFFER_BIT)),ee){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,he.__webglColorRenderbuffer[Se]);const Ue=i.get(f[Se]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ue,0)}n.blitFramebuffer(0,0,U,O,0,0,U,O,V,n.NEAREST),c===!0&&(be.length=0,ke.length=0,be.push(n.COLOR_ATTACHMENT0+Se),E.depthBuffer&&E.resolveDepthBuffer===!1&&(be.push(fe),ke.push(fe),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,ke)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,be))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ee)for(let Se=0;Se<f.length;Se++){t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.RENDERBUFFER,he.__webglColorRenderbuffer[Se]);const Ue=i.get(f[Se]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.TEXTURE_2D,Ue,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const f=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[f])}}}function Ze(E){return Math.min(r.maxSamples,E.samples)}function Ne(E){const f=i.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&f.__useRenderToTexture!==!1}function N(E){const f=a.render.frame;p.get(E)!==f&&(p.set(E,f),E.update())}function at(E,f){const U=E.colorSpace,O=E.format,V=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||U!==ds&&U!==xi&&(xt.getTransfer(U)===It?(O!==Bn||V!==Cn)&&tt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Et("WebGLTextures: Unsupported texture color space:",U)),f}function $e(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=R,this.resetTextureUnits=Z,this.getTextureUnits=k,this.setTextureUnits=z,this.setTexture2D=G,this.setTexture2DArray=Y,this.setTexture3D=ne,this.setTextureCube=de,this.rebindTextures=ae,this.setupRenderTarget=xe,this.updateRenderTargetMipmap=Ae,this.updateMultisampleRenderTarget=Xe,this.setupDepthRenderbuffer=K,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=Ne,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function O_(n,e){function t(i,r=xi){let s;const a=xt.getTransfer(r);if(i===Cn)return n.UNSIGNED_BYTE;if(i===cl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===dl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===cd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===dd)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===od)return n.BYTE;if(i===ld)return n.SHORT;if(i===ls)return n.UNSIGNED_SHORT;if(i===ll)return n.INT;if(i===ii)return n.UNSIGNED_INT;if(i===ei)return n.FLOAT;if(i===wi)return n.HALF_FLOAT;if(i===ud)return n.ALPHA;if(i===fd)return n.RGB;if(i===Bn)return n.RGBA;if(i===Ai)return n.DEPTH_COMPONENT;if(i===sr)return n.DEPTH_STENCIL;if(i===hd)return n.RED;if(i===ul)return n.RED_INTEGER;if(i===cr)return n.RG;if(i===fl)return n.RG_INTEGER;if(i===hl)return n.RGBA_INTEGER;if(i===Zs||i===Js||i===Qs||i===js)if(a===It)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Zs)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Qs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Zs)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Js)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Qs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===js)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===vo||i===xo||i===yo||i===So)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===vo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===xo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===yo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===So)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Mo||i===bo||i===Eo||i===To||i===wo||i===ia||i===Ao)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Mo||i===bo)return a===It?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Eo)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===To)return s.COMPRESSED_R11_EAC;if(i===wo)return s.COMPRESSED_SIGNED_R11_EAC;if(i===ia)return s.COMPRESSED_RG11_EAC;if(i===Ao)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ro||i===Co||i===Po||i===Lo||i===Io||i===Do||i===Uo||i===No||i===Fo||i===Oo||i===Bo||i===ko||i===zo||i===Go)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Ro)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Co)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Po)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Lo)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Io)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Do)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Uo)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===No)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Fo)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Oo)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Bo)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===ko)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===zo)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Go)return a===It?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Vo||i===Ho||i===Wo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Vo)return a===It?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ho)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Wo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Xo||i===qo||i===ra||i===Yo)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Xo)return s.COMPRESSED_RED_RGTC1_EXT;if(i===qo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ra)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Yo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===cs?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const B_=`
void main() {
...
}`,io=new Map;function Nd(n){if(io.has(n))return io.get(n);const e=n.replace("#","");if(![3,4,6,8].includes(e.length)||!/^[a-f0-9]+$/i.test(e))throw new Error("Unsupported scene color: "+n);const t=e.length<5?[...e].map(r=>r+r).join(""):e,i=[0,2,4].map(r=>parseInt(t.slice(r,r+2),16)/255);return i.push(t.length===8?parseInt(t.slice(6,8),16)/255:1),io.set(n,i),i}class Rc{constructor(e,t){this.a=e,this.b=t,this.stops=[]}addColorStop(e,t){this.stops.push([e,Nd(t)]),this.stops.sort((i,r)=>i[0]-r[0])}at(e,t){const i=this.b[0]-this.a[0],r=this.b[1]-this.a[1],s=Math.max(0,Math.min(1,((e-this.a[0])*i+(t-this.a[1])*r)/(i*i+r*r||1))),a=this.stops[0],o=this.stops.at(-1);return a[1].map((c,l)=>c+(o[1][l]-c)*s)}}class J_{constructor(e){this.canvas=e,this.renderer=new Y_({canvas:e,alpha:!1,antialias:!1,depth:!1,stencil:!1,premultipliedAlpha:!0}),this.renderer.setClearColor(0,1),this.renderer.outputColorSpace=ds,this.renderer.toneMapping=kn,this.renderer.sortObjects=!1,this.measure=document.createElement("canvas").getContext("2d"),this.atlas=document.createElement("canvas"),this.atlas.width=this.atlas.height=2048,this.atlasContext=this.atlas.getContext("2d"),this.atlasTexture=new Vf(this.atlas),this.atlasTexture.colorSpace=xi,this.atlasTexture.premultiplyAlpha=!0,this.atlasTexture.generateMipmaps=!1,this.atlasTexture.minFilter=this.atlasTexture.magFilter=sn,this.images=new Map,this.shelfX=2,this.shelfY=2,this.shelfHeight=0,this.resolution=new Tt(1,1),this.materials=["source-over","screen"].map(t=>new Td({name:"Sophia "+t,vertexShader:$_,fragmentShader:Z_,glslVersion:$o,uniforms:{uResolution:{value:this.resolution},uAtlas:{value:this.atlasTexture}},transparent:!0,depthTest:!1,depthWrite:!1,toneMapped:!1,blending:Zc,blendEquation:Oi,blendSrc:ao,blendDst:t==="screen"?Jc:os,blendSrcAlpha:ao,blendDstAlpha:os})),this.scene=new Pf,this.camera=new xl,this.capacity=0,this.mesh=null,this.allocate(16384),this.matrix=[1,0,0,1,0,0],this.stack=[],this.path=[],this.quadPoints=Array.from({length:4},()=>[0,0]),this.quadLocals=Array.from({length:4},()=>[0,0]),this.quadShape=[0,0,0],this.globalAlpha=1,this.globalCompositeOperation="source-over",this.fillStyle="#000000",this.strokeStyle="#000000",this.lineWidth=1,this.lost=!1,this.disposed=!1,e.addEventListener("webglcontextlost",t=>{t.preventDefault(),this.lost=!0,e.dataset.context="lost"}),e.addEventListener("webglcontextrestored",()=>{this.lost=!1,this.atlasTexture.needsUpdate=!0,e.dataset.context="restored",e.dispatchEvent(new CustomEvent("sophia-renderer-restored"))}),addEventListener("pagehide",t=>{t.persisted||this.dispose()})}get font(){return this.measure.font}set font(e){this.measure.font=e}measureText(e){return this.measure.measureText(e)}point(e,t){const i=this.matrix;return[i[0]*e+i[2]*t+i[4],i[1]*e+i[3]*t+i[5]]}setTransform(...e){this.matrix=e}translate(e,t){const i=this.point(e,t);this.matrix[4]=i[0],this.matrix[5]=i[1]}rotate(e){const[t,i,r,s,a,o]=this.matrix,c=Math.cos(e),l=Math.sin(e);this.matrix=[t*c+r*l,i*c+s*l,r*c-t*l,s*c-i*l,a,o]}save(){this.stack.push({matrix:this.matrix.slice(),globalAlpha:this.globalAlpha,globalCompositeOperation:this.globalCompositeOperation,fillStyle:this.fillStyle,strokeStyle:this.strokeStyle,lineWidth:this.lineWidth})}restore(){const e=this.stack.pop();e&&Object.assign(this,e)}createLinearGradient(e,t,i,r){return new Rc(this.point(e,t),this.point(i,r))}allocate(e){const t=this.data;this.geometry?.dispose(),this.capacity=e,this.data=new Float32Array(e*Hs),t&&this.data.set(t),this.buffer=new Uf(this.data,Hs).setUsage(uf),this.geometry=new ai;for(const[i,r,s]of[["aPosition",2,0],["aLocal",2,2],["aColor",4,4],["aShape",3,8]])this.geometry.setAttribute(i,new vl(this.buffer,r,s));this.mesh?this.mesh.geometry=this.geometry:(this.mesh=new ri(this.geometry,this.materials),this.mesh.frustumCulled=!1,this.scene.add(this.mesh))}beginFrame(){this.used=0,this.groups=[],(this.resolution.x!==this.canvas.width||this.resolution.y!==this.canvas.height)&&(this.resolution.set(this.canvas.width,this.canvas.height),this.renderer.setSize(this.canvas.width,this.canvas.height,!1))}endFrame(){this.lost||this.disposed||(this.geometry.clearGroups(),this.groups.forEach(e=>this.geometry.addGroup(e.start,e.count,e.material)),this.geometry.setDrawRange(0,this.used),this.buffer.clearUpdateRanges(),this.buffer.addUpdateRange(0,this.used*Hs),this.buffer.needsUpdate=!0,this.renderer.render(this.scene,this.camera),this.canvas.dataset.drawCalls=String(this.renderer.info.render.calls),this.canvas.dataset.gpuVertices=String(this.used),this.canvas.dataset.gpuTextures=String(this.renderer.info.memory.textures))}quad(e,t,i,r,s=this.globalAlpha){this.used+6>this.capacity&&this.allocate(this.capacity*2);const a=this.globalCompositeOperation==="screen"?1:0;let o=this.groups.at(-1);(!o||o.material!==a)&&(o={start:this.used,count:0,material:a},this.groups.push(o)),o.count+=6;const c=r instanceof Rc?null:Nd(r);for(const l of K_){const p=e[l],u=t[l],d=c||r.at(...p),h=d[3]*s,_=this.used++*Hs;this.data[_]=p[0],this.data[_+1]=p[1],this.data[_+2]=u[0],this.data[_+3]=u[1],this.data[_+4]=d[0]*h,this.data[_+5]=d[1]*h,this.data[_+6]=d[2]*h,this.data[_+7]=h,this.data[_+8]=i[0],this.data[_+9]=i[1],this.data[_+10]=i[2]}}atlasEntry(e){if(this.images.has(e))return this.images.get(e);const t=e.width,i=e.height;if(this.shelfX+t+2>2048&&(this.shelfX=2,this.shelfY+=this.shelfHeight+4,this.shelfHeight=0),this.shelfY+i+2>2048)throw new Error("Scene texture atlas budget exceeded");const r={x:this.shelfX,y:this.shelfY,width:t,height:i};return this.shelfX+=t+4,this.shelfHeight=Math.max(this.shelfHeight,i),this.images.set(e,r),this.invalidateImage(e),r}invalidateImage(e){const t=this.images.get(e);if(!t)return;const i=this.atlasContext,{x:r,y:s,width:a,height:o}=t;i.clearRect(r-1,s-1,a+2,o+2),i.drawImage(e,r,s),i.drawImage(e,0,0,a,1,r,s-1,a,1),i.drawImage(e,0,o-1,a,1,r,s+o,a,1),i.drawImage(e,0,0,1,o,r-1,s,1,o),i.drawImage(e,a-1,0,1,o,r+a,s,1,o);for(const[c,l,p,u]of[[0,0,r-1,s-1],[a-1,0,r+a,s-1],[0,o-1,r-1,s+o],[a-1,o-1,r+a,s+o]])i.drawImage(e,c,l,1,1,p,u,1,1);this.atlasTexture.needsUpdate=!0}drawImage(e,t,i,r,s){const a=this.atlasEntry(e),o=a.x/2048,c=1-a.y/2048,l=a.width/2048,p=a.height/2048,u=this.matrix,d=this.quadPoints,h=this.quadLocals,_=this.quadShape;for(let x=0;x<4;x++){const g=x===1||x===2,m=x>=2,C=g?t+r:t,P=m?i+s:i;d[x][0]=u[0]*C+u[2]*P+u[4],d[x][1]=u[1]*C+u[3]*P+u[5],h[x][0]=g?o+l:o,h[x][1]=m?c-p:c}_[0]=_[1]=_[2]=0,this.quad(d,h,_,"#ffffff")}rectAt(e,t,i,r,s,a,o){const c=s+1,l=a+1,p=this.quadPoints,u=this.quadLocals,d=this.quadShape;for(let h=0;h<4;h++){const _=h===1||h===2?c:-c,x=h>=2?l:-l;u[h][0]=_,u[h][1]=x,p[h][0]=e+i*_-r*x,p[h][1]=t+r*_+i*x}d[0]=1,d[1]=s,d[2]=a,this.quad(p,u,d,o)}fillRect(e,t,i,r){const s=this.matrix,a=Math.hypot(s[0],s[1]),o=Math.hypot(s[2],s[3]),c=e+i/2,l=t+r/2;this.rectAt(s[0]*c+s[2]*l+s[4],s[1]*c+s[3]*l+s[5],s[0]/a,s[1]/a,Math.abs(i*a/2),Math.abs(r*o/2),this.fillStyle)}beginPath(){this.path=[],this.current=null}moveTo(e,t){this.current=this.point(e,t)}lineTo(e,t){const i=this.point(e,t);this.current&&this.path.push({type:"line",a:this.current,b:i}),this.current=i}arc(e,t,i,r,s){if(Math.abs(s-r-Math.PI*2)>1e-4)throw new Error("Only full scene discs are supported");this.path.push({type:"disc",center:this.point(e,t),radius:i*Math.hypot(this.matrix[0],this.matrix[1])})}fill(){for(const e of this.path){if(e.type!=="disc")throw new Error("Only scene discs may be filled");const t=e.radius+1,i=[[-t,-t],[t,-t],[t,t],[-t,t]];this.quad(i.map(([r,s])=>[r+e.center[0],s+e.center[1]]),i,[2,e.radius,e.radius],this.fillStyle)}}stroke(){const e=this.lineWidth*Math.hypot(this.matrix[0],this.matrix[1])/2;if(this.path.length===2){const[t,i]=this.path;if(t.type==="line"&&i.type==="line"){const r=t.b[0]-t.a[0],s=t.b[1]-t.a[1],a=i.b[0]-i.a[0],o=i.b[1]-i.a[1],c=Math.hypot(r,s);if(c>0&&Math.abs(c-Math.hypot(a,o))<1e-5&&Math.abs(r*a+s*o)<1e-5&&Math.abs(t.a[0]+t.b[0]-i.a[0]-i.b[0])<1e-5&&Math.abs(t.a[1]+t.b[1]-i.a[1]-i.b[1])<1e-5){const l=(t.a[0]+t.b[0])/2,p=(t.a[1]+t.b[1])/2,u=r/c,d=s/c,h=c/2+1,_=[[-h,-h],[h,-h],[h,h],[-h,h]];this.quad(_.map(([x,g])=>[l+u*x-d*g,p+d*x+u*g]),_,[4,c/2,e],this.strokeStyle);return}}}for(let t=0;t<this.path.length;t++){const i=this.path[t],r=this.path[t+1];if(i.type!=="line")throw new Error("Only scene line segments may be stroked");const s=i.b[0]-i.a[0],a=i.b[1]-i.a[1],o=Math.hypot(s,a);if(r?.type==="line"&&i.b[0]===r.a[0]&&i.b[1]===r.a[1]){const c=r.b[0]-r.a[0],l=r.b[1]-r.a[1],p=Math.hypot(c,l);if(o>0&&Math.abs(o-p)<1e-5&&Math.abs(s*c+a*l)<1e-5){const u=[-s/o,-a/o],d=[c/o,l/o],h=-e-1,_=o+1;let x=[[h,h],[_,h],[_,_],[h,_]];u[0]*d[1]-u[1]*d[0]<0&&(x=[x[0],x[3],x[2],x[1]]),this.quad(x.map(([g,m])=>[i.b[0]+u[0]*g+d[0]*m,i.b[1]+u[1]*g+d[1]*m]),x,[3,o,e],this.strokeStyle),t++;continue}}o>0&&this.rectAt((i.a[0]+i.b[0])/2,(i.a[1]+i.b[1])/2,s/o,a/o,o/2,e,this.strokeStyle)}}dispose(){this.disposed||(this.disposed=!0,this.geometry.dispose(),this.materials.forEach(e=>e.dispose()),this.atlasTexture.dispose(),this.images.clear(),this.renderer.dispose())}}function Q_(n,{onChange:e=()=>{},initialFocus:t,initialLens:i,autoStart:r=!0}={}){const s=b=>n.querySelector(b);n.dataset.rendererBuild="c8d4575cf448b8707cdf55ae779d2743482a02f7348ae5e66f4972983bfe18cb";let a=s(".sc-sky"),o;try{o=new J_(a),n.dataset.renderer="three-webgl2"}catch(b){const W=a.cloneNode(!0);a.replaceWith(W),a=W,o=a.getContext("2d",{alpha:!1}),n.dataset.renderer="canvas-fallback",console.warn("GPU renderer unavailable; accepted Canvas painter retained.",b)}if(!o)return;const c=matchMedia("(prefers-reduced-motion: reduce)"),l={density:.85,pixel:.5,depth:1.25,liveliness:1,playing:!c.matches},p=1250;let u=[],d=[];const h=["#89accc","#dfc28f","#a49fdb"],_=new Map,x=s(".sc-nodes");let g=7239;const m=()=>(g=g*1664525+1013904223>>>0,g/4294967296),C=(b,W,le)=>{const pe=Math.max(0,Math.min(1,(le-b)/(W-b)));return pe*pe*(3-2*pe)},P=Array.from({length:2200},(b,W)=>{const le=W%25===0?2:W%5<2?1:0,pe=(m()-.5)*2.75,We=m()<.58&&le===0?pe*.34+(m()+m()+m()-1.5)*.54:(m()-.5)*2.7,je=[-2400,-920,220][le],ze=[1530,1150,570][le],ht=m()*Math.PI*2;return{layer:le,sx:pe,sy:We,minZ:je,range:ze,offset:m(),cycle:[230,135,92][le]*(.8+m()*.5),size:le===2?1.25+m()*1.5:le===1?.65+m()*.85:.38+m()*.65,phase:ht,freq:.55+m()*1.5,tone:Math.floor(m()*6),alpha:[.3,.58,.36][le]*(.55+m()*.65),flare:m()>.95,drift:(m()-.5)*26,x:0,y:0}}),M=["#bdd5ed","#95bde0","#e3eaf5","#dfcfb5","#aeb8e7","#f0e3c9"],I=new Map;function T(b){if(I.has(b))return I.get(b);const W=document.createElement("canvas");W.width=W.height=128;const le=W.getContext("2d"),pe=le.createRadialGradient(64,64,0,64,64,64);return pe.addColorStop(0,b+"c0"),pe.addColorStop(.05,b+"80"),pe.addColorStop(.16,b+"30"),pe.addColorStop(.45,b+"0c"),pe.addColorStop(1,b+"00"),le.fillStyle=pe,le.fillRect(0,0,128,128),I.set(b,W),W}const D=document.createElement("canvas");D.width=1100,D.height=780;const v=D.getContext("2d");function S(){v.fillStyle="#04070e",v.fillRect(0,0,1100,780);const b=[[210,260,390,"#111c33"],[620,410,375,"#142c31"],[930,555,330,"#231d38"],[585,405,170,"#242523"]];for(const[W,le,pe,We]of b){const je=v.createRadialGradient(W,le,0,W,le,pe);je.addColorStop(0,We+"b0"),je.addColorStop(.5,We+"65"),je.addColorStop(1,We+"00"),v.fillStyle=je,v.fillRect(0,0,1100,780)}o.invalidateImage?.(D)}function w(b,W,le){const pe=(Gt,Xt)=>{let kt=Math.imul(Gt,374761393)+Math.imul(Xt,668265263)+Math.imul(le,1442695041);return kt=Math.imul(kt^kt>>>13,1274126177),((kt^kt>>>16)>>>0)/4294967295},We=Math.floor(b),je=Math.floor(W),ze=b-We,ht=W-je,Je=ze*ze*(3-2*ze),ut=ht*ht*(3-2*ht),ot=pe(We,je),lt=pe(We+1,je),wt=pe(We,je+1),Ot=pe(We+1,je+1);return(ot+(lt-ot)*Je)*(1-ut)+(wt+(Ot-wt)*Je)*ut}function L(b,W){const le=document.createElement("canvas");le.width=320,le.height=240;const pe=le.getContext("2d"),We=pe.createImageData(le.width,le.height),je=We.data;for(let ze=0;ze<le.height;ze++)for(let ht=0;ht<le.width;ht++){const Je=ht/le.width,ut=ze/le.height,ot=w(Je*3,ut*3,W);let lt=0,wt=.55,Ot=3;for(let Pt=0;Pt<4;Pt++)lt+=w(Je*Ot+ot*.8,ut*Ot,W+Pt)*wt,wt*=.5,Ot*=2;const Gt=Math.exp(-Math.pow((ut-(.43+Math.sin(Je*4.4+W)*.14))/.23,2)),Xt=Math.sin(Math.PI*Je)*Math.sin(Math.PI*ut),kt=Math.max(0,lt-.34)*Gt*Xt,Ke=(ze*le.width+ht)*4;je[Ke]=b[0],je[Ke+1]=b[1],je[Ke+2]=b[2],je[Ke+3]=Math.min(130,Math.round(kt*220))}return pe.putImageData(We,0,0),le}const H=L([76,102,151],17),Z=L([111,91,136],53);let k=1,z=740,R=1,A=1,G=-1,Y=-1,ne="constellations",de=0,ce=-.055,J=0,ue=-.055,me=1,B=1,oe={x:0,y:0},$={x:0,y:0},se=0,_e=0,Me=0,ve=!0,F=null,K=0,ae=0,xe=0,Ae=0,be=0,ke="about",Xe=!0,Ze=!1,Ne=null,N=null,at=-1/0,$e=0,E="",f=0,U=0,O="trackpad",V=null,fe=-1/0;const he=.55,ee=22;let te={x:0,y:0,manual:!1},Se=[];const Ue=new Map,we=[],Te=new Map,Ve=(b,W,le)=>Math.max(W,Math.min(le,b)),Ge={x:0,y:0,tx:0,ty:0};let it=1,X=0,Ce=1,ge=0,Pe=1,Le=0,ye=1,He=0;const Ee=s(".sc-inspector");let Dt=null,gt=[],St=null,tn=!1,nn=null;function ms(){return{packet:Dt,vertices:u.map(b=>({id:b.id,slot:b.slot,p:b.p.slice(),sourcePosition:b.sourcePosition.slice(),volumeZ:b.volumeZ,pos:b.target.slice(),target:b.target.slice()})),selectedRelation:St}}function hr(b,W=u,{restore:le=!1}={}){const pe=u[G]?.id,We=new Map(u.map(ze=>[ze.id,ze]));if(u=eu(b,W).map(ze=>{const ht=We.get(ze.id);let Je=ht?.el,ut=ht?.label;if(!Je){Je=document.createElement("button"),Je.type="button",Je.className="sc-node",Je.dataset.id=ze.id,ut=document.createElement("span"),ut.className="sc-node-label",Je.append(ut);const ot=()=>_.get(ze.id);Je.addEventListener("click",lt=>{lt.detail<2&&ot()!==void 0&&Ie(ot())}),Je.addEventListener("dblclick",()=>{ot()!==void 0&&(xn(),ie(ot()))}),Je.addEventListener("pointerenter",()=>{Y=ot()??-1,bt()}),Je.addEventListener("pointerleave",()=>{Y=-1,bt()}),Je.addEventListener("focus",()=>{Y=ot()??-1,bt()}),Je.addEventListener("blur",()=>{Y=-1,bt()}),Je.addEventListener("keydown",lt=>{ot()!==void 0&&dn(lt,ot())})}return Je.dataset.main=String(ze.main),Je.setAttribute("aria-label",ze.fullName+" — "+ze.kind),ut.textContent=ze.name,{...ze,el:Je,label:ut,screen:pr(...ze.pos)}}),_.clear(),u.forEach((ze,ht)=>_.set(ze.id,ht)),x.replaceChildren(...u.map(ze=>ze.el)),Dt=b,gt=b.relations,d=gt.map(ze=>[_.get(ze.from_id),_.get(ze.to_id)]),ne!=="constellations"){const ze=le?new Set(W.map(ot=>ot.id)):null,ht=_.get(b.focus?.node_id)??0,Je=Wi(ht),ut=u.map((ot,lt)=>lt).filter(ot=>ot!==ht&&!Je.includes(ot));u.forEach((ot,lt)=>{if(!ze?.has(ot.id))if(ne==="plane")ot.target=[ot.sourcePosition[0],ot.sourcePosition[1],0];else if(lt===ht)ot.target=[0,0,0];else{const wt=Je.includes(lt)?Je:ut,Ot=wt.indexOf(lt)/wt.length*Math.PI*2-.8,Gt=wt===Je?175:380;ot.target=[Math.cos(Ot)*Gt,Math.sin(Ot)*Gt*.68,Math.sin(Ot*2)*140*l.depth]}})}G=_.get(pe)??-1,Y=-1,gt.some(ze=>ze.id===St)||(St=null),n.dataset.graphRevision=b.source_revision,n.dataset.graphFocus=b.focus?.node_id||"",n.dataset.nodeCount=String(u.length),n.dataset.relationCount=String(d.length),n.dataset.dataState="ready",Xi(),Q(),Pn(),Xe=!0,K=1,bt()}function qr(b){b?.packet&&(nn?.cancelPending(),hr(b.packet,b.vertices,{restore:!0}),St=b.selectedRelation)}function ya(b){if(!d.length)return!1;const W=n.getBoundingClientRect(),le=(b.clientX-W.left)*k/W.width,pe=(b.clientY-W.top)*z/W.height;let We=-1,je=7;for(let ze=0;ze<d.length;ze++){const[ht,Je]=d[ze],ut=u[ht].screen,ot=u[Je].screen;if(!ut.s||!ot.s)continue;const lt=ot.x-ut.x,wt=ot.y-ut.y,Ot=lt*lt+wt*wt,Gt=Ot?Ve(((le-ut.x)*lt+(pe-ut.y)*wt)/Ot,0,1):0;if(Gt<.04||Gt>.96)continue;const Xt=Math.hypot(le-ut.x-Gt*lt,pe-ut.y-Gt*wt);Xt<je&&(je=Xt,We=ze)}return We<0?!1:(Yr(gt[We].id),!0)}function Yr(b){const W=gt.find(le=>le.id===b);W&&(nn?.willSelect(),(St!==b||Ee.hidden)&&xn(),Re(!1,!1),Oe(!1,!1),St=b,G=_.get(W.from_id)??-1,Ee.hidden=!1,j(),nt(Ue.get(b)||"about"),Q(),Pn(),vn(!0),Xe=!0,bt(),Wn("Отношение: "+s(".sc-node-title").textContent),s("#so-about-tab").focus())}const Hi={get packet(){return Dt},get selection(){return{nodeId:u[G]?.id||null,relationId:St}},node:b=>u.find(W=>W.id===b)?.raw,relation:b=>gt.find(W=>W.id===b),neighbors:b=>gt.filter(W=>W.from_id===b||W.to_id===b),captureView:()=>_s(),capturePlace:()=>so({lens:ne,yaw:J,pitch:ue,zoom:B,pan:$,selectedId:u[G]?.id||null,relationId:St,panelOpen:!Ee.hidden,cardTab:ke,vertices:ms().vertices}),restorePlace(b){const W=so(b);Mt(),ne=W.lens,hr(Dt,W.vertices,{restore:!0}),G=_.get(W.selectedId)??-1,St=gt.some(le=>le.id===W.relationId)?W.relationId:null,J=W.yaw,ue=W.pitch,B=W.zoom,$={...W.pan},Ye(),G>=0||St?(j(),nt(W.cardTab,{preserveCamera:!0}),Ee.hidden=!W.panelOpen,vn(!1)):Ee.hidden=!0,Q(),Pn(),K=1,bt()},refreshTypography(){Xi(),Xe=!0,bt()},restoreView(b){b?.graph?.packet&&(xn(),q(b))},setGraph(b,{selectFocus:W=!1,initial:le=!1}={}){if(le||xn(),nn?.cancelInspector(),hr(b),W&&b.focus){tn=!0;try{Ie(_.get(b.focus.node_id))}finally{tn=!1}}else G>=0||St?j():(Ee.hidden=!0,Pn())},selectNode(b){const W=_.get(b);return W===void 0?!1:(Ie(W),!0)},selectRelation(b,{rememberView:W=!0}={}){const le=tn;tn=!W||le;try{Yr(b)}finally{tn=le}},cardChanged(){vn(!1),Xe=!0,bt()},announce:Wn};function Hn(){const b=k;k=n.clientWidth,z=n.clientHeight,R=Math.min(devicePixelRatio||1,1.5),a.width=Math.round(k*R),a.height=Math.round(z*R),A=k<=540?k/720:Math.min(k/1190,1.06),P.forEach(W=>{const le=W.minZ+W.range*.5,pe=(p-le)/p;W.x=W.sx*k*.5/A*pe,W.y=W.sy*z*.5/A*pe}),Xi(),vn(b!==k),G>=0&&!Ee.hidden&&ie(G,!1),Xe=!0,bt()}function pr(b,W,le,pe=!1){const We=pe?Pe:it,je=pe?Le:X,ze=pe?ye:Ce,ht=pe?He:ge,Je=b*We-le*je,ut=b*je+le*We,ot=W*ze-ut*ht,lt=W*ht+ut*ze;if(lt>p-110)return{x:-9999,y:-9999,s:0,depth:0,z:lt};const wt=p/(p-lt),Ot=A*(pe?1:me)*wt;return{x:k*.5+Je*Ot+(pe?oe.x*.18+Ge.x*wt*23:oe.x),y:z*.54+ot*Ot+(pe?oe.y*.18+Ge.y*wt*17:oe.y),s:Ot,depth:wt,z:lt}}function Wn(b){s(".sc-announcement").textContent=b}function li(b,W,le){b.style[W]!==String(le)&&(b.style[W]=le)}function Wi(b){return d.filter(W=>W.includes(b)).map(W=>W[0]===b?W[1]:W[0])}function Xi(){u.forEach(b=>{const W=getComputedStyle(b.label);o.font=W.font;const le=parseFloat(W.letterSpacing)||0;b.labelWidth=Math.ceil(o.measureText(b.name).width+le*b.name.length)+2,b.labelHeight=Math.ceil(parseFloat(W.fontSize)*1.5)})}function ci(b){const W=b.getBoundingClientRect(),le=n.getBoundingClientRect();return{x:W.left-le.left,y:W.top-le.top,w:W.width,h:W.height}}function Ri(b,W,le=0){return b.x<W.x+W.w+le&&b.x+b.w+le>W.x&&b.y<W.y+W.h+le&&b.y+b.h+le>W.y}function gs(){Se=[];for(const b of n.querySelectorAll(".sc-header,.sc-context,.sc-footer,.sc-label-west,.sc-label-east,.sc-panel"))if(!b.hidden){const W=ci(b);W.w&&W.h&&Se.push(W)}Ee.hidden||ci(Ee),Xe=!1}function vn(b=!1){if(!Ee.hidden){if(s(".sc-window-handle").disabled=k<=540,k<=540)for(const W of["left","right","top","bottom","transform"])Ee.style[W]="";else{const W=Ee.offsetWidth,le=Ee.offsetHeight;if(b&&!te.manual&&G>=0){const pe=u[G].screen;te.x=pe.x+W+60<k?pe.x+46:pe.x-W-46,te.y=pe.y-100}te.x=Ve(te.x,16,k-W-16),te.y=Ve(te.y,190,Math.max(190,z-le-98)),Ee.style.left="0",Ee.style.top="0",Ee.style.right="auto",Ee.style.bottom="auto",Ee.style.transform="translate3d("+Math.round(te.x)+"px,"+Math.round(te.y)+"px,0)"}Xe=!0,bt()}}function Pn(){s(".sc-back").hidden=we.length===0,s(".sc-context-sub").textContent=St?"Выбрана связь":G>=0?"Фокус: "+u[G].name:Dt?u.length+" звёзд · "+d.length+" связей":"Загружаем область…",n.dataset.history=String(we.length),Xe=!0,e(Hi)}function _s(){return{graph:ms(),selected:G,panelOpen:!Ee.hidden||Ze,lens:ne,targets:u.map(b=>b.target.slice()),yaw:J,pitch:ue,zoom:B,pan:{...$},windowPosition:{...te},cardTab:ke}}function xn(){if(tn)return;const b=_s();JSON.stringify(b)!==JSON.stringify(we.at(-1))&&(we.push(b),we.length>24&&we.shift()),Pn()}function y(){const b=we.pop();b&&q(b)}function q(b){Mt(),Re(!1,!1),Oe(!1,!1),qr(b.graph),G=b.selected,Y=-1,ne=b.lens,u.forEach((W,le)=>W.target=b.targets[le].slice()),J=b.yaw,ue=b.pitch,B=b.zoom,$={...b.pan},te={...b.windowPosition},Ye(),G>=0||St?(j(),nt(b.cardTab),Ee.hidden=!b.panelOpen,vn(!1)):Ee.hidden=!0,Q(),Pn(),Wn(G>=0?"Возврат: "+u[G].name:"Возврат к предыдущему виду"),we.length||s(".sc-overview").focus(),K=1,bt()}function ie(b,W=!0,{gentle:le=!1}={}){Mt();const pe=u[b].target,We=Math.cos(J),je=Math.sin(J),ze=Math.cos(ue),ht=Math.sin(ue),Je=pe[0]*We-pe[2]*je,ut=pe[0]*je+pe[2]*We,ot=pe[1]*ze-ut*ht,lt=pe[1]*ht+ut*ze;let wt=k*.5,Ot=z*.5;if(!Ee.hidden){const Xt=ci(Ee);if(k<=540){const kt=ci(s(".sc-context"));Ot=(kt.y+kt.h+35+Xt.y-38)*.5}else wt=Xt.x>k*.44?Math.max(k*.3,Xt.x*.55):Math.min(k*.76,(Xt.x+Xt.w+k)*.5),Ot=Ve(Xt.y+Xt.h*.44,250,z-150)}B=le?Ve(B*1.08,.65,2.2):W?Math.max(k<=540?1.25:1.45,B):k<=540?1.12:Math.max(1.1,B),B=Math.min(2.2,B);const Gt=A*B*p/(p-lt);$.x=wt-k*.5-Je*Gt,$.y=Ot-z*.54-ot*Gt,K=1,bt()}function Q(){n.dataset.selected=G>=0?u[G].id:"",u.forEach((b,W)=>b.el.setAttribute("aria-pressed",String(W===G)))}function j(){const b=St?Hi.relation(St):u[G]?.raw;b&&nn?.showCard(St?"relation":"node",b)}function Ie(b,{fly:W=!1,keepWindow:le=!1}={}){nn?.willSelect();const pe=G!==b||!!St;(pe||Ee.hidden)&&xn(),St=null;const We=!Ee.hidden;Re(!1,!1),Oe(!1,!1),G=b,j(),nt(Ue.get(u[b].id)||"about"),Ee.hidden=!1,nn?.restoreReading(),Q(),Pn(),vn(!le&&(pe||!We)),W?ie(b,!0):pe||!We?ie(b,!1,{gentle:!0}):k<=540&&ie(b,!1),Wn(u[b].kind+": "+u[b].name),Xe=!0,bt()}function Fe(b=!0,W=!1){nn?.captureReading(),nn?.cancelInspector(),Ee.hidden=!0,Ze=!1,b&&G>=0&&!u[G].el.hidden&&u[G].el.focus(),W&&(St=null,G=-1,Y=-1,Q(),Pn()),Xe=!0,bt()}function Re(b=!0,W=!0){nn?.cancelSearch();const le=!s(".sc-search").hidden;s(".sc-search").hidden=!0,s(".sc-search-open").setAttribute("aria-expanded","false"),le&&(W&&Ze&&G>=0&&(Ee.hidden=!1,vn(!1)),Ze=!1),b&&s(".sc-search-open").focus(),Xe=!0,bt()}function Oe(b=!0,W=!0){const le=!s(".sc-lenses").hidden;s(".sc-lenses").hidden=!0,s(".sc-lenses-open").setAttribute("aria-expanded","false"),le&&(W&&Ze&&G>=0&&(Ee.hidden=!1,vn(!1)),Ze=!1),b&&s(".sc-lenses-open").focus(),Xe=!0,bt()}function qe(b){const W=s(".sc-"+b);if(!W.hidden){b==="search"?Re():Oe();return}const le=!Ee.hidden||Ze;Re(!1,!1),Oe(!1,!1),Ze=le,Ee.hidden=!0,W.hidden=!1,s(".sc-"+b+"-open").setAttribute("aria-expanded","true"),b==="search"?(rt(),s("#sc-query").focus()):s('.sc-lens[aria-pressed="true"]').focus(),Xe=!0,bt()}function rt(){nn?.search(s("#sc-query").value)}function nt(b,{preserveCamera:W=!1}={}){nn?.captureReading(),ke=b;const le=St||u[G]?.id;le&&(Ue.delete(le),Ue.set(le,b),Ue.size>64&&Ue.delete(Ue.keys().next().value)),n.querySelectorAll(".sc-card-tab").forEach(pe=>{const We=pe.id==="so-"+b+"-tab";pe.setAttribute("aria-selected",String(We)),pe.tabIndex=We?0:-1}),s("#so-about").hidden=b!=="about",s("#so-relations").hidden=b!=="relations",nn?.restoreReading(),vn(!1),!W&&k<=540&&G>=0&&!Ee.hidden&&ie(G,!1),Xe=!0,bt()}function Ye(){n.dataset.lens=ne,s(".sc-context h2").textContent=ne==="orbits"?"Орбиты мысли":ne==="plane"?"Карта связей":"Созвездия мысли",s(".sc-label-west").hidden=!0,s(".sc-label-east").hidden=!0,n.querySelectorAll(".sc-lens").forEach(b=>b.setAttribute("aria-pressed",String(b.dataset.lens===ne))),Xe=!0}function At(b){if(b===ne){Oe();return}Mt(),xn(),ne=b;const W=G>=0?G:0,le=Wi(W),pe=u.map((We,je)=>je).filter(We=>We!==W&&!le.includes(We));u.forEach((We,je)=>{if(b==="constellations")We.target=We.p.slice();else if(b==="plane")We.target=[We.sourcePosition[0],We.sourcePosition[1],0];else if(je===W)We.target=[0,0,0];else{const ze=le.includes(je)?le:pe,ht=ze.indexOf(je)/ze.length*Math.PI*2-.8,Je=ze===le?175:380;We.target=[Math.cos(ht)*Je,Math.sin(ht)*Je*.68,Math.sin(ht*2)*140*l.depth]}}),Ye(),J=0,ue=b==="plane"?0:-.055,$={x:0,y:0},B=1,Oe(),G>=0&&!Ee.hidden&&ie(G,!1),Wn("Линза: "+s(".sc-context h2").textContent),K=1,bt()}function Bt(){Mt(),xn(),Re(!1,!1),Oe(!1,!1),J=0,ue=ne==="plane"?0:-.055,$={x:0,y:0},B=1,K=1,Fe(!1,!0),te.manual=!1,Wn("Общий вид"),bt()}function Mt(){f=0,at=-1/0,$e=0,E="",V=null,fe=-1/0}function Rt(){const b=O==="trackpad",W=s(".sc-input-mode");n.dataset.inputMode=O,W.setAttribute("aria-label",b?"Управление: тачпад. Переключить на мышь":"Управление: мышь. Переключить на тачпад"),W.setAttribute("data-tooltip",b?"Тачпад · два пальца — сдвиг, щипок — полёт":"Мышь · колесо — масштаб, перетаскивание — вращение"),W.innerHTML=b?'<i data-lucide="touchpad" aria-hidden="true"></i>':'<i data-lucide="mouse" aria-hidden="true"></i>',s(".sc-gesture").textContent=b?"Два пальца — сдвиг · щипок — полёт":"Колесо — масштаб · Shift + перетаскивание — сдвиг",ki(),Xe=!0}function zt(b,W=k*.5,le=z*.54){b=Ve(b,.65,2.2);const pe=b/B;$.x=W-k*.5-(W-k*.5-$.x)*pe,$.y=le-z*.54-(le-z*.54-$.y)*pe,B=b,K=1,bt()}function Be(){n.dataset.motion=l.playing?"running":"paused",s(".sc-motion").setAttribute("aria-pressed",String(!l.playing)),s(".sc-motion").setAttribute("aria-label",l.playing?"Приостановить движение":"Включить движение"),s(".sc-motion").innerHTML=l.playing?'<i data-lucide="pause" aria-hidden="true"></i>':'<i data-lucide="play" aria-hidden="true"></i>',ki(),bt()}function dn(b,W){const le={ArrowLeft:[-1,0],ArrowRight:[1,0],ArrowUp:[0,-1],ArrowDown:[0,1]}[b.key];if(!le)return;b.preventDefault();const pe=u[W].screen;let We=-1,je=1/0;u.forEach((ze,ht)=>{if(ht===W||ze.el.hidden)return;const Je=ze.screen.x-pe.x,ut=ze.screen.y-pe.y,ot=Je*le[0]+ut*le[1];if(ot<=0)return;const lt=Je*Je+ut*ut,wt=lt/Math.max(1,ot)+Math.abs(Je*le[1]-ut*le[0])*1.5;wt<je&&(je=wt,We=ht)}),We>=0&&u[We].el.focus()}s(".sc-back").addEventListener("click",y),s(".sc-close").addEventListener("click",()=>Fe()),s(".sc-focus").addEventListener("click",()=>{G>=0&&(xn(),ie(G))}),s(".sc-search-open").addEventListener("click",()=>qe("search")),s(".sc-search-close").addEventListener("click",()=>Re()),s("#sc-query").addEventListener("input",rt),s(".sc-lenses-open").addEventListener("click",()=>qe("lenses")),s(".sc-lenses-close").addEventListener("click",()=>Oe()),n.querySelectorAll(".sc-lens").forEach(b=>b.addEventListener("click",()=>At(b.dataset.lens))),s(".sc-overview").addEventListener("click",Bt),s(".sc-plus").addEventListener("click",()=>{Mt(),xn(),zt(B*1.18)}),s(".sc-minus").addEventListener("click",()=>{Mt(),xn(),zt(B/1.18)}),s(".sc-motion").addEventListener("click",()=>{l.playing=!l.playing,Be()}),s(".sc-input-mode").addEventListener("click",()=>{Mt(),O=O==="trackpad"?"mouse":"trackpad",Rt(),Wn(O==="trackpad"?"Тачпад: два пальца — перемещение, щипок — приближение":"Мышь: колесо — масштаб, перетаскивание — вращение"),bt()}),n.querySelectorAll(".sc-card-tab").forEach((b,W)=>{b.addEventListener("click",()=>nt(W?"relations":"about")),b.addEventListener("keydown",le=>{if(["ArrowLeft","ArrowRight","Home","End"].includes(le.key)){le.preventDefault();const pe=le.key==="Home"?"about":le.key==="End"||ke==="about"?"relations":"about";nt(pe),s("#so-"+pe+"-tab").focus()}})}),s(".sc-search").addEventListener("keydown",b=>{const W=[...n.querySelectorAll(".sc-result")],le=W.indexOf(b.target);if(b.target===s("#sc-query")&&b.key==="Enter"&&W[0])b.preventDefault(),W[0].click();else if(b.key==="ArrowDown"||b.key==="ArrowUp"){b.preventDefault();const pe=le+(b.key==="ArrowDown"?1:-1);pe<0?s("#sc-query").focus():W[Math.min(pe,W.length-1)]?.focus()}}),n.addEventListener("keydown",b=>{b.key==="Escape"&&(s(".sc-search").hidden?s(".sc-lenses").hidden?Ee.hidden||Fe():Oe():Re(),b.stopPropagation()),b.key==="/"&&!b.target.closest("input,textarea,select,[contenteditable]")&&(b.preventDefault(),qe("search"))});const dt=s(".sc-window-handle");dt.addEventListener("pointerdown",b=>{k<=540||b.button!==0||(Ne={id:b.pointerId,x:b.clientX,y:b.clientY,origin:{...te}},dt.setPointerCapture(b.pointerId),b.preventDefault())}),dt.addEventListener("pointermove",b=>{!Ne||b.pointerId!==Ne.id||(te={x:Ne.origin.x+b.clientX-Ne.x,y:Ne.origin.y+b.clientY-Ne.y,manual:!0},vn(!1))});const un=b=>{Ne?.id===b.pointerId&&(Ne=null,dt.hasPointerCapture(b.pointerId)&&dt.releasePointerCapture(b.pointerId))};dt.addEventListener("pointerup",un),dt.addEventListener("pointercancel",un),dt.addEventListener("lostpointercapture",()=>Ne=null),dt.addEventListener("keydown",b=>{if(k<=540)return;const W={ArrowLeft:[-1,0],ArrowRight:[1,0],ArrowUp:[0,-1],ArrowDown:[0,1]}[b.key];if(!W)return;b.preventDefault();const le=b.shiftKey?40:16;te.x+=W[0]*le,te.y+=W[1]*le,te.manual=!0,vn(!1)}),a.addEventListener("pointerdown",b=>{if(b.button===0){if(Te.set(b.pointerId,{x:b.clientX,y:b.clientY}),a.setPointerCapture(b.pointerId),Te.size===1)Mt(),F={id:b.pointerId,x:b.clientX,y:b.clientY,yaw:J,pitch:ue,pan:{...$},shift:b.shiftKey,moved:!1};else if(Te.size===2){const[W,le]=[...Te.values()],pe=n.getBoundingClientRect();B=me,$={...oe},N={distance:Math.hypot(le.x-W.x,le.y-W.y),x:((W.x+le.x)*.5-pe.left)*k/pe.width,y:((W.y+le.y)*.5-pe.top)*z/pe.height},F&&(F.moved=!0)}}}),a.addEventListener("pointermove",b=>{if(Te.has(b.pointerId)){if(Te.set(b.pointerId,{x:b.clientX,y:b.clientY}),N&&Te.size>=2){const[W,le]=[...Te.values()],pe=n.getBoundingClientRect(),We=Math.hypot(le.x-W.x,le.y-W.y),je=((W.x+le.x)*.5-pe.left)*k/pe.width,ze=((W.y+le.y)*.5-pe.top)*z/pe.height;$.x+=je-N.x,$.y+=ze-N.y,zt(B*We/Math.max(1,N.distance),je,ze),N={distance:We,x:je,y:ze},E="pinch",f=performance.now()+180,Ft()}else if(F&&b.pointerId===F.id){const W=b.clientX-F.x,le=b.clientY-F.y;if(F.moved=F.moved||Math.abs(W)+Math.abs(le)>4,F.shift){const pe=n.getBoundingClientRect();$.x=F.pan.x+W*k/pe.width*he,$.y=F.pan.y+le*z/pe.height*he,E="pan",f=performance.now()+180,Ft()}else J=F.yaw+W*.0022,ue=Ve(F.pitch+le*.0018,-.7,.7)}K=1,bt()}});function pn(b){if(!Te.has(b.pointerId))return;const W=F?.moved||N||b.type!=="pointerup";if(Te.delete(b.pointerId),N=null,Te.size){const[le,pe]=[...Te.entries()][0];F={id:le,x:pe.x,y:pe.y,yaw:J,pitch:ue,pan:{...$},shift:!1,moved:!0}}else F=null,!W&&!ya(b)&&(G>=0&&xn(),Re(!1,!1),Oe(!1,!1),Fe(!1,!0));a.hasPointerCapture(b.pointerId)&&a.releasePointerCapture(b.pointerId)}a.addEventListener("pointerup",pn),a.addEventListener("pointercancel",pn),a.addEventListener("lostpointercapture",pn);function Ln(b){const W=b.target instanceof Element?b.target:b.target.parentElement;return!!(W&&!W.closest('.sc-panel, .sc-navigation, button:not(.sc-node), input, textarea, select, a, [contenteditable="true"]'))}function Xn(b,W={x:k*.5,y:z*.54}){const le=n.getBoundingClientRect();return{x:Number.isFinite(b.clientX)?(b.clientX-le.left)*k/le.width:W.x,y:Number.isFinite(b.clientY)?(b.clientY-le.top)*z/le.height:W.y}}function Ct(b,W){(W-at>220||b!==E)&&(B=me,$={...oe}),at=W,E=b,f=W+180}function Ft(){n.dataset.wheelKind=E,n.dataset.zoomTarget=B.toFixed(6),n.dataset.panTarget=[$.x.toFixed(3),$.y.toFixed(3)].join(",")}function qn(b){if(!Ln(b))return;b.cancelable&&b.preventDefault(),b.stopPropagation(),n.dataset.wheelEvents=String(++U);const W=b.deltaMode,le=b.deltaX,pe=b.deltaY,We=performance.now();if(!Number.isFinite(le)||!Number.isFinite(pe)||V||b.ctrlKey&&We<fe||le===0&&pe===0)return;const je=b.ctrlKey?"pinch":O==="trackpad"?"pan":"wheel",ze=W===1?32:W===2?z:1,ht=Math.sign(-pe);if(je==="wheel"&&E===je&&ht!==$e&&(B=me,$={...oe}),Ct(je,We),$e=ht,je==="pan"){const Je=n.getBoundingClientRect();$.x-=le*ze*k/Je.width*he,$.y-=pe*ze*z/Je.height*he,K=1,bt()}else{const Je=je==="pinch"?Ve(-pe*ze*.006,-Math.log(4),Math.log(4)):Ve(-pe*ze*.0016,-.18,.18),ut=Xn(b);zt(B*Math.exp(Je),ut.x,ut.y)}Ft()}n.addEventListener("wheel",qn,{passive:!1,capture:!0});function Ut(b){if(!Ln(b)||!Number.isFinite(b.scale)||b.scale<=0)return;b.cancelable&&b.preventDefault(),b.stopPropagation(),B=me,$={...oe};const W=Xn(b);V={scale:b.scale,...W},Ct("pinch",performance.now())}function Yn(b){if(!V||!Number.isFinite(b.scale)||b.scale<=0)return;b.cancelable&&b.preventDefault(),b.stopPropagation();const W=Xn(b,V);$.x+=W.x-V.x,$.y+=W.y-V.y,zt(B*Math.pow(b.scale/V.scale,.6),W.x,W.y),V={scale:b.scale,...W},at=performance.now(),E="pinch",f=at+180,Ft()}function Ci(b){V&&(b.cancelable&&b.preventDefault(),b.stopPropagation(),V=null,fe=performance.now()+80)}n.addEventListener("gesturestart",Ut,{passive:!1,capture:!0}),n.addEventListener("gesturechange",Yn,{passive:!1,capture:!0}),n.addEventListener("gestureend",Ci,{passive:!1,capture:!0}),window.addEventListener("blur",()=>{V=null,fe=-1/0,Te.clear(),F=null,N=null,Mt()}),n.addEventListener("pointermove",b=>{if(b.pointerType!=="mouse"||!l.playing)return;const W=n.getBoundingClientRect();Ge.tx=Ve(((b.clientX-W.left)/k-.5)*2,-1,1),Ge.ty=Ve(((b.clientY-W.top)/z-.5)*2,-1,1),bt()}),n.addEventListener("pointerleave",()=>{Ge.tx=0,Ge.ty=0,bt()});function Kr(b,W,le){o.save(),o.globalCompositeOperation="screen",o.globalAlpha=le,o.translate(k*.5+Math.sin(se*.025+W)*k*.026+Ge.x*16-de*27,z*.51+Math.cos(se*.019+W)*z*.024+Ge.y*12),o.rotate(Math.sin(se*.013+W)*.055-de*.035),o.drawImage(b,-k*.72,-z*.68,k*1.44,z*1.36),o.restore()}function Sa(b,W){for(let le=0;le<W;le++){const pe=P[le];if(pe.layer!==b)continue;const We=(pe.offset+se/pe.cycle)%1,je=pe.minZ+We*pe.range,ze=C(0,.065,We)*(1-C(.9,1,We));if(ze<.002)continue;const ht=Math.sin(se*.035+pe.phase)*pe.drift,Je=pe.x+ht,ut=pe.y+Math.cos(se*.029+pe.phase)*pe.drift*.65,ot=Je*Pe-je*Le,lt=Je*Le+je*Pe,wt=ut*ye-lt*He,Ot=ut*He+lt*ye;if(Ot>p-130)continue;const Gt=p/(p-Ot),Xt=A*Gt,kt=k*.5+ot*Xt+oe.x*.18+Ge.x*Gt*23,Ke=z*.54+wt*Xt+oe.y*.18+Ge.y*Gt*17;if(kt<-30||Ke<-30||kt>k+30||Ke>z+30)continue;const Pt=Math.sin(se*pe.freq+pe.phase)*.26+Math.sin(se*pe.freq*.43+pe.phase*2.13)*.16,ft=pe.flare?Math.pow(Math.max(0,Math.sin(se*.23+pe.phase*1.7)),28):0,Vt=Math.min(.92,pe.alpha*ze*(.66+Pt+ft*.8))*(1-be*.16),qt=Math.min(b===2?3.3:2.2,Math.max(.38,pe.size*Gt*(.64+A*.32))),mn=M[pe.tone];if(o.fillStyle=mn,o.globalAlpha=Vt,b===2){const $t=17+qt*8;o.drawImage(T(mn),kt-$t/2,Ke-$t/2,$t,$t),o.globalAlpha=Vt*.7,o.beginPath(),o.arc(kt,Ke,qt*.62,0,Math.PI*2),o.fill()}else if(o.fillRect(kt-qt/2,Ke-qt/2,qt,qt),pe.flare||qt>1.5){const $t=12+qt*5+ft*17;o.globalAlpha=Vt*.6,o.drawImage(T(mn),kt-$t/2,Ke-$t/2,$t,$t)}if(pe.flare&&ft>.25&&b!==0){o.globalAlpha=Vt*ft*.52;const $t=3+ft*7;o.lineWidth=.6,o.strokeStyle=mn,o.beginPath(),o.moveTo(kt-$t,Ke),o.lineTo(kt+$t,Ke),o.moveTo(kt,Ke-$t),o.lineTo(kt,Ke+$t),o.stroke()}le===25&&(n.dataset.starProbe=[kt.toFixed(2),Ke.toFixed(2),Vt.toFixed(3)].join(","))}o.globalAlpha=1}function Rl(b){if(Me=0,!n.isConnected||!ve||document.hidden){_e=0;return}const W=performance.now();o.beginFrame?.();const le=_e?(b-_e)/1e3:1/60,pe=Math.min(le,.05);_e=b;const We=c.matches?1:1-Math.exp(-pe*14),je=c.matches?1:b<f?1-Math.exp(-pe*(E==="pan"?ee:30)):We,ze=Ee.hidden?0:1;if(be+=(ze-be)*(c.matches?1:1-Math.exp(-pe*3)),l.playing){se+=pe*l.liveliness*(1-be*.65);const Ke=1-Math.exp(-pe*4);Ge.x+=(Ge.tx-Ge.x)*Ke,Ge.y+=(Ge.ty-Ge.y)*Ke}de+=(J-de)*We,ce+=(ue-ce)*We,me+=(B-me)*je,oe.x+=($.x-oe.x)*je,oe.y+=($.y-oe.y)*je;let ht=Math.abs(J-de)+Math.abs(ue-ce)+Math.abs(B-me)+Math.abs(oe.x-$.x)*.01+Math.abs(oe.y-$.y)*.01+Math.abs(be-ze);Xe&&gs(),it=Math.cos(de),X=Math.sin(de),Ce=Math.cos(ce),ge=Math.sin(ce);const Je=de+Math.sin(se*.021)*.011,ut=ce+Math.cos(se*.017)*.008;Pe=Math.cos(Je),Le=Math.sin(Je),ye=Math.cos(ut),He=Math.sin(ut),o.setTransform(R,0,0,R,0,0),o.globalAlpha=1,o.globalCompositeOperation="source-over",o.drawImage(D,0,0,k,z);const ot=Math.round(P.length*l.density);Sa(0,ot),Kr(H,.2,.85),Sa(1,ot),Kr(Z,2.4,.46),u.forEach(Ke=>{for(let Pt=0;Pt<3;Pt++)Ke.pos[Pt]+=(Ke.target[Pt]-Ke.pos[Pt])*We,ht+=Math.abs(Ke.target[Pt]-Ke.pos[Pt])*.001;Ke.screen=pr(...Ke.pos)});const lt=Y>=0?Y:G,wt=new Set(lt<0?[]:d.filter(Ke=>Ke.includes(lt)).flat());o.lineWidth=.7,d.forEach(([Ke,Pt],ft)=>{const Vt=u[Ke].screen,qt=u[Pt].screen;if(!Vt.s||!qt.s)return;const mn=St?gt[ft].id===St:lt>=0&&(Ke===lt||Pt===lt),$t=u[Ke].group===u[Pt].group,$r=mn?"#e8c88d":$t?h[u[Ke].group]:"#8ea8c3",mr=mn?.76:lt>=0?.07:$t?.39:.17,vs=Math.max(.18,Math.min(1,Vt.depth*.75)),gr=Math.max(.18,Math.min(1,qt.depth*.75)),Pi=o.createLinearGradient(Vt.x,Vt.y,qt.x,qt.y);Pi.addColorStop(0,$r+Math.round(mr*vs*255).toString(16).padStart(2,"0")),Pi.addColorStop(1,$r+Math.round(mr*gr*255).toString(16).padStart(2,"0")),o.strokeStyle=Pi,o.lineWidth=(mn?1:.7)*Math.max(.6,Math.min(1.35,(Vt.depth+qt.depth)/2)),o.beginPath(),o.moveTo(Vt.x,Vt.y),o.lineTo(qt.x,qt.y),o.stroke()}),o.globalAlpha=1;const Ot=[],Gt=[];let Xt=0;const kt=u.map((Ke,Pt)=>({n:Ke,i:Pt})).sort((Ke,Pt)=>(Pt.i===lt?20:wt.has(Pt.i)?8:Pt.n.main?3:0)-(Ke.i===lt?20:wt.has(Ke.i)?8:Ke.n.main?3:0));for(const{n:Ke,i:Pt}of kt){const ft=Ke.screen,Vt=Pt===lt,qt=wt.has(Pt),mn=Ke.main,$t=Math.max(.52,Math.min(1,ft.depth*.86)),$r=(lt<0||Vt||qt?1:.36)*$t,mr=h[Ke.group],vs=(Vt?5:Pt===0?4.7:mn?3.1:1.9)*Math.max(.55,Math.min(ft.s,1.45));o.globalAlpha=$r;const gr=(Vt?115:Pt===0?145:mn?90:42)*Math.max(.55,ft.s);o.drawImage(T(mr),ft.x-gr/2,ft.y-gr/2,gr,gr),o.fillStyle=mr,o.beginPath(),o.arc(ft.x,ft.y,vs,0,Math.PI*2),o.fill(),o.fillStyle="#fff9ea";const Pi=Math.max(1,vs*.45);if(o.fillRect(Math.round(ft.x-Pi/2),Math.round(ft.y-Pi/2),Pi,Pi),mn||Vt){const Qt=(Vt?18:Pt===0?16:10)*Math.max(.7,ft.s);o.globalAlpha=$r*(.45+l.pixel*.45),o.strokeStyle=mr,o.lineWidth=.65,o.beginPath(),o.moveTo(ft.x-Qt,ft.y),o.lineTo(ft.x+Qt,ft.y),o.moveTo(ft.x,ft.y-Qt),o.lineTo(ft.x,ft.y+Qt),o.stroke()}if(Vt){o.globalAlpha=.85,o.strokeStyle="#d8bc84",o.lineWidth=1;const Qt=20,Zr=5;o.beginPath();for(const[vr,xr]of[[-1,-1],[-1,1],[1,-1],[1,1]])o.moveTo(ft.x+vr*Qt,ft.y+xr*(Qt-Zr)),o.lineTo(ft.x+vr*Qt,ft.y+xr*Qt),o.lineTo(ft.x+vr*(Qt-Zr),ft.y+xr*Qt);o.stroke()}o.globalAlpha=1;const xs=k<=540?44:38,yn={x:ft.x-xs/2,y:ft.y-xs/2,w:xs,h:xs};li(Ke.el,"transform","translate3d("+Math.round(yn.x)+"px,"+Math.round(yn.y)+"px,0)"),li(Ke.el,"opacity",lt<0||Vt||qt?"1":".46");const Vd=ft.s>0&&yn.x>10&&yn.x+yn.w<k-10&&yn.y>92&&yn.y+yn.h<z-90,Hd=Se.some(Qt=>Ri(yn,Qt,2)),Wd=Gt.some(Qt=>Ri(yn,Qt,0));Ke.el.hidden=!Vd||Hd||Wd,Ke.el.hidden||Gt.push(yn);const Xd=Vt||qt||lt<0&&(mn||me>(k<=540?1.5:1.28))||mn&&me>1.8;let _r=null;const qi=Ke.labelWidth,Yi=Ke.labelHeight;if(!Ke.el.hidden&&Xd){const Qt={x:ft.x-qi/2,y:ft.y+22,w:qi,h:Yi},Zr={x:ft.x-qi/2,y:ft.y-23-Yi,w:qi,h:Yi},vr={x:ft.x+28,y:ft.y-Yi/2,w:qi,h:Yi},xr={x:ft.x-28-qi,y:ft.y-Yi/2,w:qi,h:Yi};_r=(Ke.above?[Zr,Qt,vr,xr]:[Qt,Zr,vr,xr]).find(di=>di.x>12&&di.x+di.w<k-12&&di.y>90&&di.y+di.h<z-86&&!Se.some(Ki=>Ri(di,Ki,7))&&!Ot.some(Ki=>Ri(di,Ki,7))&&!u.some((Ki,qd)=>qd!==Pt&&Ki.screen.s>0&&Ri(di,{x:Ki.screen.x-8,y:Ki.screen.y-8,w:16,h:16},3)))}li(Ke.label,"visibility",_r?"visible":"hidden"),_r&&(li(Ke.label,"left",Math.round(_r.x-yn.x)+"px"),li(Ke.label,"top",Math.round(_r.y-yn.y)+"px"),li(Ke.label,"transform","none"),Ot.push(_r),Xt++)}Sa(2,ot),o.globalAlpha=1,o.endFrame?.(),ae++,xe+=performance.now()-W,Ae+=le*1e3,ae%90===0&&(n.dataset.drawMs=(xe/90).toFixed(2),n.dataset.frameMs=(Ae/90).toFixed(2),n.dataset.stars=String(ot),n.dataset.frames=String(ae),xe=0,Ae=0),n.dataset.skyClock=se.toFixed(3),n.dataset.rotation=de.toFixed(3),n.dataset.zoom=me.toFixed(3),n.dataset.labels=String(Xt),n.dataset.calm=be.toFixed(2),n.dataset.camera=[de.toFixed(3),ce.toFixed(3),me.toFixed(3),oe.x.toFixed(1),oe.y.toFixed(1)].join(","),K=ht>(b<f?1e-5:.005)?1:0,l.playing||K||F?Me=requestAnimationFrame(Rl):_e=0}a.addEventListener("sophia-renderer-restored",()=>{K=1,bt()});function bt(){!Me&&ve&&!document.hidden&&(Me=requestAnimationFrame(Rl))}return document.addEventListener("visibilitychange",()=>{document.hidden?(cancelAnimationFrame(Me),Me=0,_e=0):bt()}),new IntersectionObserver(b=>{ve=b[0].isIntersecting,ve?bt():(cancelAnimationFrame(Me),Me=0,_e=0)}).observe(n),new ResizeObserver(Hn).observe(n),c.addEventListener("change",b=>{l.playing=!b.matches,Be()}),nn=Uu(n,Hi,{initialFocus:t,initialLens:i}),S(),Hn(),Be(),Rt(),n.dataset.lens=ne,Pn(),r&&nn.start(),document.fonts?.ready.then(()=>{Xi(),bt()}),ki(),{port:Hi,ui:nn,openSearch:()=>qe("search"),overview:Bt,closeInspector:Fe,invalidate:()=>{Xe=!0,bt()}}}function j_(n,e){const t={id:e.parentHypothesisId,title:e.statement.slice(0,100),body:e.statement,targetId:e.targetId,fromId:e.fromId,toId:e.toId},i=Uc({persistence:!1});i.importPacket(n.exportPacket()),i.addHypothesis(t);const r={...e,createdAt:e.createdAt??new Date().toISOString(),baseWorkspaceRevision:i.summary().revision};return i.stageProposal(r),n.addHypothesis(t),n.stageProposal(r)}const Qe=(n,e="",t="")=>{const i=document.createElement(n);return i.textContent=e,i.className=t,i},An=(n,e)=>{const t=Qe("button",n);return t.type="button",t.addEventListener("click",e),t};function Ws(n){if(/^https?:\/\//i.test(n))try{const e=new URL(n),t=Qe("a",e.hostname+e.pathname,"sc-source-ref");return t.href=e.href,t.target="_blank",t.rel="noreferrer noopener",t}catch{}return Qe("span",n,"sc-source-ref")}function e0(n,e,{selected:t,panels:i,onChange:r}){let s=!1;try{s=Yd(localStorage,"tos-research-workspace-v1")}catch{}const a=Uc({sessionId:"tos-local-research",persistence:s}),o=new Vr,c=new Map;let l=null;const p=jo(async(F,K={})=>{const ae=AbortSignal.any([K.signal||new AbortController().signal,AbortSignal.timeout(6e4)]),xe=await fetch(F,{...K,signal:ae});if(!xe.ok)throw new Error(xe.status===404?"Для этого объекта отдельное досье пока не подготовлено.":"Не удалось загрузить материал. Попробуйте ещё раз.");return xe.json()}),u=An("",()=>Z("notes"));u.className="sc-control sc-workspace-open",u.setAttribute("aria-label","Исследование"),u.setAttribute("aria-expanded","false"),u.innerHTML='<i data-lucide="notebook-pen" aria-hidden="true"></i><span>Исследование</span>',n.querySelector(".sc-header-actions").append(u);const d=Qe("section","","sc-panel sc-workspace");d.hidden=!0,d.setAttribute("aria-label","Исследовательская панель"),d.innerHTML='<div class="sc-panel-top"><span class="sc-eyebrow">РАБОЧЕЕ ПРОСТРАНСТВО</span><button type="button" class="sc-icon sc-workspace-close" aria-label="Закрыть исследование"><i data-lucide="x" aria-hidden="true"></i></button></div><h3>Исследование</h3><div class="sc-workspace-tabs" role="tablist" aria-label="Инструменты исследования"></div><div class="sc-workspace-body" role="tabpanel" id="sc-tool-content"></div><div class="sc-tool-status" role="status"></div><div class="sc-workspace-footer"></div>',n.append(d),i.register("workspace",d,()=>{m.capture(),o.cancelAll(),u.setAttribute("aria-expanded","false")});const h=d.querySelector(".sc-workspace-body"),_=d.querySelector(".sc-tool-status"),x=d.querySelector(".sc-workspace-tabs"),g=d.querySelector(".sc-workspace-footer"),m=as(h);let C="notes",P=null,M=null,I="node",T=u,D="",v="note",S=null;const w={notes:"Записи",sources:"Источники",analysis:"Разбор"},L=Object.entries(w).map(([F,K])=>{const ae=An(K,()=>k(F));return ae.id="sc-tool-"+F,ae.setAttribute("role","tab"),ae.setAttribute("aria-controls","sc-tool-content"),x.append(ae),ae});x.addEventListener("keydown",F=>{if(!["ArrowLeft","ArrowRight","Home","End"].includes(F.key))return;F.preventDefault();const K=L.indexOf(F.target),ae=F.key==="Home"?0:F.key==="End"?2:(K+(F.key==="ArrowLeft"?2:1))%3;k(Object.keys(w)[ae]),L[ae].focus()});function H(){i.close("workspace"),(T?.isConnected&&!T.closest("[hidden]")?T:u).focus()}d.querySelector(".sc-workspace-close").addEventListener("click",H),d.addEventListener("keydown",F=>{F.key==="Escape"&&(F.preventDefault(),F.stopPropagation(),H())});function Z(F="notes",K){m.capture(),T=document.activeElement instanceof HTMLElement?document.activeElement:u,P=K?{id:K.raw.id,label:vt(K.raw.display.title||K.raw.display.label),kind:K.kind==="relation"?"edge":"node",source_refs:K.raw.source_refs}:t(),M=K?.raw||(P?.kind==="edge"?e.port.relation(P.id):e.port.node(P?.id)),I=K?.kind||(P?.kind==="edge"?"relation":"node"),i.open("workspace"),u.setAttribute("aria-expanded","true"),k(F),L[Object.keys(w).indexOf(F)].focus()}function k(F){m.capture(),o.cancelAll(),h.setAttribute("aria-busy","false"),C=F,m.enter(JSON.stringify([e.port.packet?.source_revision,P?.id,F])),d.querySelector("h3").textContent={notes:"Исследование",sources:"Источники",analysis:"Разбор текста"}[F],_.textContent="";for(const[K,ae]of L.entries()){const xe=Object.keys(w)[K]===F;ae.setAttribute("aria-selected",String(xe)),ae.tabIndex=xe?0:-1}h.setAttribute("aria-labelledby","sc-tool-"+F),h.replaceChildren(),F==="notes"?ue():F==="sources"?B():oe(),m.restore(),e.invalidate()}i.configure("workspace",{onResume:()=>{m.restore(),k(C)}}),n.addEventListener("sophia-sources",F=>Z("sources",F.detail));function z(F){F?.name!=="AbortError"&&(_.textContent=F.message||"Не удалось выполнить действие.",e.invalidate())}function R(F){try{return F()}catch(K){z(K)}}function A(...F){const K=Qe("div","","sc-tool-actions");return K.append(...F),K}function G(){h.append(Qe("p",P?"Для: "+P.label:"Общие записи исследования","sc-muted"))}function Y(F){return`${F}:${crypto.randomUUID()}`}function ne(F,K){return a.addNote({id:Y("note"),body:F,targetId:K}),{added:!0,summary:a.summary()}}function de(F,K=P){return a.addHypothesis({id:Y("hypothesis"),title:F.slice(0,100),body:F,targetId:K?.id,...K?.from_id&&K?.to_id?{fromId:K.from_id,toId:K.to_id}:{}})}function ce(F,K=P,ae={}){if(!K?.id)throw new Error("Сначала выберите звезду или отношение.");const xe=ae.source_refs||K.source_refs||[];if(!xe.length)throw new Error("Для предложения нужен хотя бы один источник.");const Ae=ae.kind||"interpretation",be=ae.from_id||K.from_id,ke=ae.to_id||K.to_id;if(["relation","source_route"].includes(Ae)&&(!be||!ke))throw new Error("Для предложения о связи нужны оба участника.");return j_(a,{id:Y("proposal"),kind:Ae,parentHypothesisId:Y("hypothesis"),targetId:K.id,...be&&ke?{fromId:be,toId:ke}:{},statement:F,sourceRefs:xe,evidenceRefs:ae.evidence_refs?.length?ae.evidence_refs:xe,confidencePosture:{value:ae.confidence||"unknown",meaning:"maker_declared_uncertainty_not_truth_probability"},actorOrigin:ae.actor_origin==="agent"?"agent":"human",basePageRevision:ae.context_revision||0,dataFingerprint:e.port.packet?.source_revision||"unavailable"})}function J(){const F=URL.createObjectURL(new Blob([a.exportPacket()],{type:"application/json"})),K=Qe("a");K.href=F,K.download="sophia-research.json",K.click(),setTimeout(()=>URL.revokeObjectURL(F),1e3)}function ue(){const F=D?S:P;h.append(Qe("p",F?"Для: "+F.label:"Общие записи исследования","sc-muted")),h.append(Qe("p","Записи и гипотезы сохраняются в этом браузере. Предложения остаются черновиками до рассмотрения.","sc-muted"));const K=Qe("form"),ae=Qe("label","Новая запись");ae.htmlFor="sc-note-text";const xe=Qe("textarea");xe.id="sc-note-text",xe.maxLength=2e3,xe.placeholder="Мысль, вопрос или наблюдение…",xe.value=D,xe.addEventListener("input",()=>{D||(S=P?{...P}:null),D=xe.value});const Ae=Qe("label","Тип записи");Ae.htmlFor="sc-note-kind";const be=Qe("select");be.id="sc-note-kind";for(const[at,$e]of[["note","Заметка"],["hypothesis","Гипотеза"],["proposal","Предложение к рассмотрению"]]){const E=Qe("option",$e);E.value=at,be.append(E)}be.value=v,be.addEventListener("change",()=>v=be.value);const ke=Qe("button","Сохранить запись");ke.type="submit",K.append(ae,xe,Ae,be,A(ke)),K.addEventListener("submit",at=>{at.preventDefault(),R(()=>{const $e=xe.value.trim();if(!$e)throw new Error("Напишите текст записи.");const E=D?S:P;be.value==="hypothesis"?de($e,E):be.value==="proposal"?ce($e,E):ne($e,E?.id),D="",S=null,k("notes"),_.textContent="Запись сохранена."})}),h.append(K);const Xe=An("Отменить",()=>{a.undo(),k("notes")}),Ze=An("Повторить",()=>{a.redo(),k("notes")});Xe.disabled=!a.canUndo(),Ze.disabled=!a.canRedo();const Ne=Qe("input");Ne.type="file",Ne.accept=".json,application/json",Ne.hidden=!0,Ne.setAttribute("aria-label","Импорт исследования"),Ne.addEventListener("change",async()=>{const at=Ne.files?.[0];if(at){if(at.size>1e6){z(new Error("Файл превышает 1 МБ."));return}try{const $e=await at.text();a.importPacket($e),k("notes"),_.textContent="Исследование импортировано."}catch($e){z($e)}}}),h.append(A(Xe,Ze,An("Экспорт",J),An("Импорт",()=>Ne.click())),Ne);const N=a.getState();for(const[at,$e]of[["Заметка",N.notes],["Гипотеза",N.hypotheses],["Предложение · ожидает рассмотрения",N.proposals]])for(const E of $e.slice().reverse()){const f=Qe("article","","sc-entry");f.append(Qe("small",at),Qe("p",E.body||E.statement)),E.targetId&&f.append(Qe("small",E.targetId)),at==="Заметка"&&f.append(A(An("Удалить",()=>{a.removeNote(E.id),k("notes")}))),h.append(f)}!N.notes.length&&!N.hypotheses.length&&!N.proposals.length&&h.append(Qe("p","Здесь появятся ваши записи.","sc-muted")),a.persistenceError()&&(_.textContent="Браузер не смог сохранить записи на диск. Экспортируйте исследование перед закрытием.")}function me(F){const K=Qe("article","","sc-entry");K.append(Qe("h4",F.label||F.preferred_label||F.node_id));const ae=F.properties||{};(ae.description||ae.notes)&&K.append(Qe("p",ae.description||ae.notes,"sc-source-text"));for(const xe of[...new Set([...F.source_refs||[],ae.url,ae.locator,ae.source_url].filter(Ae=>typeof Ae=="string"))])K.append(Ws(xe));return K}async function B(){if(G(),!M){h.append(Qe("p","Выберите звезду или отношение, чтобы увидеть источники."));return}const F=M;h.append(Qe("p",vt(I==="relation"?F.display.explanation:F.display.summary,"Описание пока не зафиксировано."),"sc-source-text"));const K=Qe("details");K.append(Qe("summary","Происхождение и статус"));for(const[Ae,be]of[["Слой",F.epistemic?.authority_layer],["Рассмотрение",F.epistemic?.review_posture],["Канон",F.epistemic?.canon_status]])K.append(Qe("p",Ae+": "+(be&&be!=="not-recorded"?be:"не указан"),"sc-muted"));for(const Ae of F.source_refs)K.append(Ws(Ae));if(h.append(K),I==="relation")return;const ae=F.native_id;if(!ae)return;const xe=Qe("div");h.append(xe),xe.append(Qe("p","Получаю досье источников…","sc-muted")),h.setAttribute("aria-busy","true");try{const Ae=await o.run("source",Xe=>p.invoke("tos.dossier.inspect",{object_id:ae,limit:40},{signal:Xe}));if(!Ae.current||d.hidden||C!=="sources")return;xe.replaceChildren();const be=Ae.value;for(const[Xe,Ze]of[["work","Произведение"],["expression","Редакции и переводы"],["edition","Издания"],["file","Файлы"],["item","Экземпляры"],["link","Ссылки"]]){const Ne=be.chain?.[Xe]||[];if(!Ne.length)continue;const N=Qe("details");N.append(Qe("summary",Ze+" · "+Ne.length));for(const at of Ne)N.append(me(at));xe.append(N)}const ke=be.agent_summary;ke&&xe.append(Qe("p","Доступность ссылки и право использования — отдельные сведения. Статус прав: "+(ke.rights_posture&&ke.rights_posture!=="unknown"?ke.rights_posture:"не указан")+".","sc-muted")),xe.children.length||xe.append(Qe("p","Дополнительные маршруты источников пока не записаны.","sc-muted")),h.setAttribute("aria-busy","false"),m.restore(),e.invalidate()}catch(Ae){h.setAttribute("aria-busy","false"),xe.replaceChildren(Qe("p",Ae.message,"sc-muted")),xe.append(A(An("Повторить",()=>k("sources")))),e.invalidate()}}function oe(){h.append(Qe("p","Ищите недостающие источники или подготовьте разбор слова в «Заратустре».","sc-muted"));const F=Qe("label","Запрос");F.htmlFor="sc-analysis-query";const K=Qe("input");K.id="sc-analysis-query",K.placeholder="Название источника или слово…",K.maxLength=256;const ae=Qe("div");h.append(F,K,A(An("Пробелы в источниках",()=>$("gaps",K.value,ae).catch(()=>{})),An("Разобрать слово",()=>$("word",K.value,ae).catch(()=>{}))),ae)}async function $(F,K,ae,xe,Ae={}){_.textContent="Получаю материал…",ae.replaceChildren();try{const be=F==="gaps"?"tos.source-gaps.search":"tos.zarathustra.word-analysis.prepare",ke=F==="gaps"?{query:K,limit:Ae.limit??12}:{query:K,language:Ae.language||"ru",rank:Ae.rank??1,include_semantic_neighbors:Ae.include_semantic_neighbors===!0},Xe=await o.run("analysis",Ne=>p.invoke(be,ke,{signal:xe?AbortSignal.any([Ne,xe]):Ne}));if(!Xe.current||d.hidden||C!=="analysis")throw xe?.throwIfAborted(),new DOMException("Panel closed","AbortError");xe?.throwIfAborted();const Ze=Xe.value;if(_.textContent="",F==="gaps"){c.clear();for(const Ne of Ze.gaps||[]){c.set(Ne.edge_id,Ne);const N=Qe("article","","sc-entry");N.append(Qe("h4",Ne.to_label||Ne.label),Qe("p",Ne.properties?.public_summary_en||Ne.summary||""),Qe("small","Доступ: "+Ne.access_status+" · Запрос: "+Ne.request_status));for(const at of Ne.source_refs||[])N.append(Ws(at));N.append(A(An("Рассмотреть",()=>_e(Ne.edge_id)))),ae.append(N)}Ze.gaps?.length||ae.append(Qe("p","По этому запросу пробелов не найдено."))}else if(Ze.available!==!0)ae.append(Qe("p","Разбор для этого запроса сейчас недоступен."),Qe("p",Ze.reason||"","sc-muted"));else{const Ne=Ze.task?.source||{};ae.append(Qe("h4",Ne.surface||Ne.text||K),Qe("p",Ne.context||Ne.excerpt||Ne.sentence||"")),Ne.source_ref&&ae.append(Ws(Ne.source_ref)),ae.append(Qe("p","Подготовлен разбор по исходному тексту. Результат требует рассмотрения.","sc-muted")),ae.append(A(An("Сохранить задание",()=>{const N=URL.createObjectURL(new Blob([JSON.stringify(Ze,null,2)],{type:"application/json"})),at=Qe("a");at.href=N,at.download="sophia-word-analysis.json",at.click(),setTimeout(()=>URL.revokeObjectURL(N),1e3)})))}return e.invalidate(),Ze}catch(be){throw z(be),be}}function se(){}function _e(F){const K=c.get(F);return K?(l={id:K.edge_id,kind:"edge",semantic_kind:"source_access_gap",label:K.to_label,from_id:K.from_id,to_id:K.to_id,predicate_id:K.predicate_id,source_refs:K.source_refs,authority_posture:K.authority_posture,review_posture:K.review_posture,canon_status:K.canon_status,reroutable:!1},P=l,i.open("workspace"),u.setAttribute("aria-expanded","true"),k("notes"),r(),!0):!1}const Me={"tos.page.research-workspace":()=>({packet:JSON.parse(a.exportPacket()),summary:a.summary()}),"tos.page.add-research-note":F=>ne(String(F.text||""),F.target_id?String(F.target_id):void 0),"tos.page.add-session-hypothesis":F=>({hypothesis:de(String(F.statement||""),t()),summary:a.summary()}),"tos.page.stage-proposal":F=>({proposal:ce(String(F.statement||""),t(),F),summary:a.summary()}),"tos.page.workspace-undo":()=>({changed:a.undo(),summary:a.summary()}),"tos.page.workspace-redo":()=>({changed:a.redo(),summary:a.summary()}),"tos.page.workspace-export":()=>({packet:JSON.parse(a.exportPacket())}),"tos.page.workspace-import":F=>({imported:a.importPacket(typeof F.packet=="string"?F.packet:JSON.stringify(F.packet)),summary:a.summary()}),"tos.page.find-source-gaps":async(F,{signal:K})=>{Z("analysis");const ae=Qe("div");h.append(ae);const xe=await $("gaps",String(F.query||""),ae,K,F);return{...xe,gaps:xe.gaps.map(Ae=>({...Ae,id:Ae.edge_id,label:Ae.to_label,summary:Ae.properties?.public_summary_en}))}},"tos.page.prepare-word-analysis":async(F,{signal:K})=>{Z("analysis");const ae=Qe("div");return h.append(ae),$("word",String(F.query||""),ae,K,F)}};let ve=!1;return a.subscribe(()=>{r(),!ve&&(ve=!0,queueMicrotask(()=>{if(ve=!1,d.hidden||C!=="notes")return;const F=document.activeElement,K=h.querySelector("textarea"),ae=F===K,xe=K?.selectionStart,Ae=K?.selectionEnd;if(h.replaceChildren(),ue(),ae){const be=h.querySelector("textarea");be.focus(),be.setSelectionRange(xe,Ae)}e.invalidate()}))}),ki(),window.addEventListener("pagehide",()=>o.cancelAll(),{once:!0}),{workspace:a,handlers:Me,selectionChanged:se,chooseGap:_e,get auxiliarySelection(){return l},clearAuxiliarySelection(){l=null},agentStatus(F){g.textContent=F.registered?"Агент подключён к текущему пространству":F.supported?"Подключаю агента…":"Записи хранятся локально"}}}function t0(n,e,{onUserAction:t=()=>{}}={}){const i=new Map,r=new Map,s=[];let a=structuredClone(al),o=null,c="",l=!1;try{o=localStorage,a=du(o)}catch(S){c=S.message}const p=()=>JSON.stringify([e.port.packet?.source_revision,e.port.packet?.fingerprint,e.port.selection]),u=S=>S==="inspector"?"К карточке":{evidence:"К основаниям",workspace:"К источникам",navigation:"К маршруту",builder:"К линзе",studio:"К рабочему месту"}[S]||"Назад";function d(){for(const[S,w]of i)if(!w.element.hidden)return S;return null}function h(){try{o?.setItem(Xc,JSON.stringify(a)),c=o?"":"Настройки действуют до закрытия страницы: хранилище недоступно."}catch{c="Браузер не сохранил настройки. Они действуют до закрытия страницы."}}function _(){if(a.dock!=="auto")return a.dock;const S=n.getBoundingClientRect(),w=S.left+S.width/2,L=n.querySelector(".sc-inspector");if(!L.hidden&&S.width>650){const Z=L.getBoundingClientRect();return Z.left+Z.width/2<w?"left":"right"}for(const{element:Z}of i.values())if(!Z.hidden&&Z.dataset.dock)return Z.dataset.dock;const H=[...n.querySelectorAll(".sc-node")].find(Z=>Z.dataset.id===n.dataset.selected&&!Z.hidden);if(H){const Z=H.getBoundingClientRect();if(Z.width)return Z.left+Z.width/2>w?"left":"right"}return"right"}function x(S){const w=i.get(S);!w||w.element.hidden||(w.onHide(),w.element.hidden=!0,e.invalidate())}const g=new ResizeObserver(()=>{e.port.cardChanged(),e.invalidate()});function m(S){const w=i.get(S),L=a.sizes[S];if(w)for(const H of["width","height"])L?w.element.style.setProperty("--sc-panel-"+H,L[H]+"px"):w.element.style.removeProperty("--sc-panel-"+H)}function C(S,w,L){a.sizes[S]={width:Math.max(280,Math.min(760,w)),height:Math.max(240,Math.min(800,L))},m(S),e.invalidate()}function P(){t();const S=p();let w;for(;s.length;){const H=s.pop();if(H.key===S){w=H;break}}if(!w){M();return}l=!0,I(w.id,!1),l=!1,i.get(w.id).onResume?.();const L=w.focus;L?.isConnected&&!L.closest("[hidden]")?L.focus():i.get(w.id).element.querySelector("button")?.focus()}function M(){for(const S of i.values()){const w=[...s].reverse().find(L=>L.key===p());S.back.hidden=!w,S.back.textContent=w?"← "+u(w.id):""}}function I(S,w=!0){if(!i.has(S))throw new Error("Unknown panel: "+S);const L=d(),H=_();w&&!l&&L&&L!==S&&(s.push({id:L,key:p(),focus:document.activeElement}),s.length>8&&s.shift());for(const k of i.keys())k!==S&&x(k);S!=="inspector"&&(e.closeInspector(!1),n.querySelector(".sc-search-close").click(),n.querySelector(".sc-lenses-close").click());const Z=i.get(S).element;if(S!=="inspector"){const k=n.querySelector(".sc-context").getBoundingClientRect();Z.style.setProperty("--sc-tool-top",`${k.bottom-n.getBoundingClientRect().top+18}px`),Z.dataset.dock=H}Z.hidden=!1,m(S),M(),e.invalidate()}function T(S,w,L=()=>{},H={}){if(i.has(S))throw new Error("Duplicate panel: "+S);w.dataset.panelId=S;const Z=document.createElement("div");Z.className="sc-reading-return";const k=document.createElement("button");k.type="button",k.hidden=!0,k.addEventListener("click",P),Z.append(k),w.querySelector(".sc-panel-top").after(Z);const z=document.createElement("button");z.type="button",z.className="sc-panel-size",z.textContent="↔",z.setAttribute("aria-label","Изменить размер окна"),z.title="Размер окна: обычный / просторный",z.addEventListener("click",()=>{t();const Y=a.sizes[S];C(S,Y?.width>=560?420:640,Y?.width>=560?440:620),h()}),w.querySelector(".sc-panel-top").insertBefore(z,w.querySelector(".sc-panel-top").lastElementChild);const R=document.createElement("button");R.type="button",R.className="sc-panel-resize",R.textContent="⌟",R.setAttribute("aria-label","Размер окна: стрелки меняют ширину и высоту"),R.title="Потяните угол; стрелки меняют размер, Home сбрасывает";let A=null;R.addEventListener("pointerdown",Y=>{if(Y.button!==0)return;t();const ne=w.getBoundingClientRect();A={id:Y.pointerId,x:Y.clientX,y:Y.clientY,w:ne.width,h:ne.height},R.setPointerCapture(Y.pointerId),Y.preventDefault()}),R.addEventListener("pointermove",Y=>{A?.id===Y.pointerId&&C(S,A.w+(Y.clientX-A.x)*(w.dataset.dock==="right"?-1:1),A.h+Y.clientY-A.y)});const G=()=>{A&&(A=null,h())};R.addEventListener("pointerup",G),R.addEventListener("pointercancel",G),R.addEventListener("lostpointercapture",G),R.addEventListener("keydown",Y=>{const ne={ArrowLeft:[-20,0],ArrowRight:[20,0],ArrowUp:[0,-20],ArrowDown:[0,20]}[Y.key];if(Y.key==="Home")t(),Y.preventDefault(),delete a.sizes[S],m(S),h();else if(ne){t(),Y.preventDefault();const de=w.getBoundingClientRect();C(S,de.width+ne[0],de.height+ne[1]),h()}}),w.append(R),i.set(S,{element:w,onHide:L,...H,back:k}),m(S),g.observe(w)}T("inspector",n.querySelector(".sc-inspector"),()=>{e.ui.captureReading(),e.ui.cancelInspector()},{onResume:()=>e.ui.restoreReading()});const D=new MutationObserver(()=>{if([".sc-inspector",".sc-search",".sc-lenses"].some(S=>!n.querySelector(S).hidden))for(const[S,w]of i)S!=="inspector"&&!w.element.hidden&&x(S);M()});for(const S of[".sc-inspector",".sc-search",".sc-lenses"])D.observe(n.querySelector(S),{attributes:!0,attributeFilter:["hidden"]});D.observe(n,{attributes:!0,attributeFilter:["data-graph-revision","data-selected"]});function v(){n.dataset.readingSize=a.text,n.dataset.labelSize=a.labels;for(const[w,L]of r)L.opener.hidden=!a.pinned.includes(w),a.pinned.includes(w)&&n.querySelector(".sc-header-actions").append(L.opener);for(const w of a.pinned){const L=r.get(w);L&&n.querySelector(".sc-header-actions").append(L.opener)}const S=n.querySelector(".sc-studio-open");S&&n.querySelector(".sc-header-actions").append(S);for(const[w,L]of i)m(w),w!=="inspector"&&!L.element.hidden&&a.dock!=="auto"&&(L.element.dataset.dock=a.dock);e.port.refreshTypography?.(),e.invalidate()}return v(),{register:T,open:I,close:x,back:P,configure(S,w){Object.assign(i.get(S),w)},get preferences(){return structuredClone(a)},get storageError(){return c},setPreferences(S){a=qc(S),h(),v()},addTool(S,w){if(r.has(S))throw new Error("Duplicate tool: "+S);r.set(S,w),v()},toolList:()=>[...r].map(([S,w])=>({id:S,title:w.title,available:w.available?.()!==!1})),launch(S){const w=r.get(S);if(!w||w.available?.()===!1)throw new Error("Сначала выберите звезду или связь.");w.launch()}}}const Vi=n=>[...new Set([n?.source_ref,...n?.source_refs||[]].filter(e=>typeof e=="string"&&e))];function Fd(n){return n?.native_id?n.source_graph==="philosophy"?{mode:"philosophy",item_id:n.native_id}:n.source_graph==="canon"?{mode:"corpus",item_id:n.native_id,view_id:"route-graph"}:null:null}function n0(n,e,t,i){const r=n?.selection,s=n?.authority_boundary;if(n?.schema!=="tos_evidence_lens_packet_v1"||n.mode!==i.mode||n.item_id!==e.native_id||r?.[t==="relation"?"edge_id":"node_id"]!==e.native_id||!["is_source","is_canon","is_semantic_truth","is_rights_clearance"].every(a=>s?.[a]===!1)||!Vi(r).some(a=>Vi(e).includes(a))||!["challenge_relations","context_relations","neighbor_nodes","source_refs","routes","source_anchors","gaps"].every(a=>Array.isArray(n[a]))||typeof n.conclusion?.can_conclude!="boolean")throw new Wt("Основания не удалось связать с выбранным объектом. Обновите область.");return n}async function i0(n,e,t,{client:i,queries:r,signal:s,limit:a=60}){const{match:o}=await i.inspect(e,n.id,s,t);if(s?.throwIfAborted(),o.content_revision!==n.content_revision)throw new Ti;const c=Fd(o);if(!c)return{raw:o,availability:"not_connected",packet:null};let l;try{l=await r.invoke("tos.epistemic.inspect",{...c,limit:a},{signal:s})}catch(u){if(u.status!==404)throw u;return s?.throwIfAborted(),{raw:o,availability:"outside_route",packet:null}}s?.throwIfAborted(),n0(l,o,e,c);const p=await i.inspect(e,n.id,s,t);if(s?.throwIfAborted(),p.match.content_revision!==o.content_revision)throw new Ti;return{raw:o,availability:"available",packet:l,binding:{knowledge_id:n.id,native_id:o.native_id,source_graph:o.source_graph,source_revision:t,content_revision:o.content_revision}}}function r0(n,e=[]){const t=n.properties||{},i=n.edge_id||n.node_id,r=s=>{const a=e.find(o=>o.node_id===s);return a?.label_ru||a?.preferred_label||a?.label||s};return{id:i,label:n.label_ru||n.label||t.relation_label||n.predicate_id||i,statement:n.summary_ru||n.summary||t.comment||t.description||"",route:n.from_id&&n.to_id?r(n.from_id)+" → "+r(n.to_id):"",predicate_id:n.predicate_id,from_id:n.from_id,to_id:n.to_id,source_refs:Vi(n),authority_posture:t.authority_posture,canon_status:t.canon_status,review_posture:t.review_posture,confidence:t.confidence||t.master_confidence}}function Cc(n,e){const t=n.packet;if(!t)throw new Error("Для этого объекта сравнение прочтений пока не подключено.");const i=a=>a.filter(o=>(o.edge_id||o.node_id)!==t.item_id).map(o=>r0(o,[t.selection,...t.neighbor_nodes])),r=i(t.challenge_relations),s=i(t.context_relations);return{schema:"tos_interpretation_comparison_v1",selection:e,binding:n.binding,posture:t.posture,can_conclude:t.conclusion.can_conclude===!0,competing_reading_count:r.length,competing_readings:r,contextual_readings:s,coverage:t.coverage,gaps:t.gaps_ru||t.gaps,authority_note:t.authority_note}}function s0(n,e){return{id:n.id,kind:e==="relation"?"edge":"node",label:vt(n.display.title||n.display.label,n.id),source_refs:Vi(n)}}const st=(n,e="",t="")=>{const i=document.createElement(n);return i.textContent=e,i.className=t,i},Xs=(n,e,t="")=>{const i=st("button",n,t);return i.type="button",i.addEventListener("click",e),i},a0={"pre-canon":"До канона",canon:"Канон","derived-export":"Проекция источников",prepared_research_candidate:"Исследовательский кандидат",prepared_branch_candidate:"Кандидат ветви",contested_review_required:"Требует рассмотрения",pending_human_review:"Ожидает рассмотрения","not-recorded":"Не указан",unresolved:"Не разрешено",review_status_unresolved:"Статус рассмотрения не установлен",contested_by:"Оспаривается",uncertain_relation:"Неопределённая связь",polemicizes_with:"Полемизирует с"},ji=n=>a0[n]||n||"Не указан";function o0(n,e,t,{selected:i,onUserAction:r}){const s=new or,a=new Vr,o=jo(async(J,ue={})=>{const me=AbortSignal.any([ue.signal||new AbortController().signal,AbortSignal.timeout(6e4)]);try{const B=await fetch(J,{...ue,signal:me});if(!B.ok)throw new Ys(B.status,"Не удалось получить основания. Попробуйте ещё раз.");return await B.json()}catch(B){throw me.aborted?me.reason:B instanceof TypeError?new Error("Нет связи с данными. Повторите запрос после подключения."):B}}),c=st("section","","sc-panel sc-evidence");c.hidden=!0,c.setAttribute("aria-label","Основания и прочтения"),c.innerHTML='<div class="sc-panel-top"><span class="sc-eyebrow">ЛИСТ ИССЛЕДОВАНИЯ</span><button type="button" class="sc-icon sc-evidence-close" aria-label="Закрыть основания"><i data-lucide="x" aria-hidden="true"></i></button></div><div class="sc-evidence-heading"><span class="sc-evidence-symbol" aria-hidden="true">✧</span><div><p class="sc-evidence-kind"></p><h3></h3></div></div><div class="sc-evidence-tabs" role="tablist" aria-label="Основания и сравнение"></div><div class="sc-evidence-body" id="sc-evidence-content" role="tabpanel" tabindex="0"></div><div class="sc-evidence-status" role="status"></div><div class="sc-evidence-footer"><span>От мысли — к источнику</span></div>',n.append(c);const l=c.querySelector(".sc-evidence-body"),p=c.querySelector(".sc-evidence-status"),u=c.querySelector(".sc-evidence-tabs"),d=as(l),h=new Map;let _=0,x=null,g=null,m=null,C="grounds",P=null,M="",I=0;t.register("evidence",c,()=>{d.capture(),a.cancelAll(),l.setAttribute("aria-busy","false")});function T(){t.close("evidence"),r();const J=[...n.querySelectorAll(".sc-node")].find(ue=>ue.dataset.id===x?.raw.id&&!ue.hidden);(P?.isConnected&&!P.closest("[hidden]")?P:J||n.querySelector(".sc-overview")).focus()}c.querySelector(".sc-evidence-close").addEventListener("click",T),c.addEventListener("keydown",J=>{J.key==="Escape"&&(J.preventDefault(),J.stopPropagation(),T())});const D=["grounds","compare"],v=["Основания","Сравнение"].map((J,ue)=>{const me=Xs(J,()=>{r(),S(D[ue])});return me.id="sc-evidence-"+D[ue],me.setAttribute("role","tab"),me.setAttribute("aria-controls",l.id),u.append(me),me});u.addEventListener("keydown",J=>{if(!["ArrowLeft","ArrowRight","Home","End"].includes(J.key))return;J.preventDefault();const ue=J.key==="Home"?0:J.key==="End"?1:1-v.indexOf(J.target);r(),S(D[ue]),v[ue].focus()});function S(J){d.capture(),C=J,h.set(M,J),h.size>48&&h.delete(h.keys().next().value),c.dataset.tab=J,v.forEach((ue,me)=>{ue.setAttribute("aria-selected",String(D[me]===J)),ue.tabIndex=D[me]===J?0:-1}),l.setAttribute("aria-labelledby","sc-evidence-"+J),Y()}function w(J,ue,me=""){const B=st("section","","sc-evidence-section "+me);B.append(st("h4",J));for(const oe of ue)B.append(typeof oe=="string"?st("p",oe):oe);return B}function L(J,ue="Источники"){const me=st("details","","sc-evidence-refs");me.append(st("summary",ue+" · "+J.length));for(const B of J){const oe=st("div","","sc-evidence-ref");if(/^https?:\/\//i.test(B))try{const $=new URL(B),se=st("a",$.hostname+$.pathname);se.href=$.href,se.target="_blank",se.rel="noopener noreferrer",oe.append(se)}catch{oe.append(st("span",B))}else oe.append(st("span",B));oe.append(Xs("Копировать",async()=>{try{await navigator.clipboard.writeText(B),p.textContent="Ссылка на источник скопирована."}catch{p.textContent="Выделите и скопируйте путь к источнику."}},"sc-evidence-copy")),me.append(oe)}return me}function H(J){const ue=st("dl","","sc-evidence-posture");for(const[me,B]of[["Слой",J.epistemic?.authority_layer],["Рассмотрение",J.epistemic?.review_posture],["Канон",J.epistemic?.canon_status]]){const oe=st("div");oe.append(st("dt",me),st("dd",ji(B))),ue.append(oe)}return ue}function Z(J,ue,me=""){if(!ue?.length)return null;const B=st("ul");for(const oe of ue)B.append(st("li",oe));return w(J,[B],me)}function k(...J){l.append(...J.filter(Boolean))}function z(){const J=g?.raw||x.raw;k(H(J),L(Vi(J),"Происхождение объекта"));const ue=Xs("Открыть досье источников",()=>{r(),n.dispatchEvent(new CustomEvent("sophia-sources",{detail:{raw:J,kind:x.kind}}))},"sc-evidence-source");l.append(ue)}function R(){const J=g.raw,ue=g.packet;if(!ue){k(w("Происхождение",[vt(x.kind==="relation"?J.display.explanation:J.display.summary,"Описание пока не записано.")],"sc-evidence-finding")),k(w("Маршрут оснований",[g.availability==="outside_route"?"Объект не найден в доступной области Evidence Lens. Это не означает, что у него нет оснований.":"Для этого слоя отдельный маршрут оснований ещё не подключён. Здесь показаны сведения из карточки и её источники."])),z();return}k(w("Что установлено",[ue.finding_ru||ue.finding],"sc-evidence-finding"));const me=st("div","","sc-evidence-conclusions");for(const B of[Z("Можно утверждать",ue.conclusion.allowed_ru||ue.conclusion.allowed,"sc-evidence-allowed"),Z("Вывод пока не следует",ue.conclusion.not_allowed_ru||ue.conclusion.not_allowed,"sc-evidence-limits")])B&&me.append(B);if(k(me),ue.conclusion.can_conclude!==!0&&k(st("p","Материала недостаточно для окончательного вывода в указанной области.","sc-evidence-note")),k(Z("Открытые вопросы",ue.gaps_ru||ue.gaps)),ue.source_anchors.length){const B=st("details","","sc-evidence-refs");B.append(st("summary","Точные фрагменты · "+ue.source_anchors.length));for(const oe of ue.source_anchors){const $=st("div","","sc-evidence-ref");$.append(st("p",(oe.anchor_segment_ids||[]).join(" · ")),st("small",oe.witness_scope||"")),oe.relation_ref&&$.append(L([oe.relation_ref],"Запись связи")),B.append($)}k(B)}if(ue.routes.length){const B=st("details","","sc-evidence-refs");B.append(st("summary","Маршруты к основаниям · "+ue.routes.length));for(const oe of ue.routes){const $=st("div","","sc-evidence-ref");$.append(st("small",ji(oe.route_kind)+" · "+ji(oe.status))),oe.ref&&$.append(L([oe.ref],"Открыть путь")),B.append($)}k(B)}k(L(ue.source_refs,"Источники поля оснований")),z()}function A(J,ue,me=!1){const B=st("article","","sc-reading"+(me?" sc-reading-selected":""));return B.append(st("span",ue,"sc-reading-caption"),st("h4",ji(J.label))),J.route&&B.append(st("p",J.route,"sc-reading-route")),B.append(st("p",J.statement||"Описание этого прочтения пока не записано.","sc-reading-text")),(J.review_posture||J.canon_status)&&B.append(st("p",[J.review_posture,J.canon_status].filter(Boolean).map(ji).join(" · "),"sc-evidence-note")),B.append(L(J.source_refs)),B}function G(){if(!g.packet){k(w("Сопоставление ещё не подключено",[g.availability==="outside_route"?"Объект находится за пределами доступного маршрута оснований.":"В этом слое пока нет подключённого поля прочтений. Соседство на карте само по себе не означает разногласия."])),z();return}const J=Cc(g,s0(g.raw,x.kind)),ue=g.packet,me=g.raw;k(st("p","Сопоставление показывает записанные связи и вопросы к ним. Их истинность определяется рассмотрением источников.","sc-evidence-note"));const B=J.competing_readings,oe={label:vt(me.display.title||me.display.label),statement:vt(x.kind==="relation"?me.display.explanation:me.display.summary),route:vt(me.display.statement),source_refs:Vi(me),review_posture:me.epistemic?.review_posture,canon_status:me.epistemic?.canon_status},$=st("div","","sc-reading-spread");if($.append(A(oe,"ВЫБРАНО",!0)),B.length){const _e=st("div","","sc-reading-alternative"),Me=st("label","Сопоставить с");Me.htmlFor="sc-reading-choice";const ve=st("select");ve.id=Me.htmlFor;for(const[ae,xe]of B.entries()){const Ae=st("option",`${ae+1}. ${ji(xe.label)}${xe.route?" · "+xe.route:""}`);Ae.value=String(ae),ve.append(Ae)}ve.value=String(Math.min(_,B.length-1));const F=st("div"),K=()=>{F.replaceChildren(A(B[Number(ve.value)],"ДРУГОЕ ПРОЧТЕНИЕ")),e.invalidate()};ve.addEventListener("change",()=>{r(),_=Number(ve.value),K()}),_e.append(Me,ve,F),K(),$.append(_e)}else $.append(w("Других прочтений не показано",["В полученной области нет других оспаривающих связей. Это не означает согласия или доказанности."],"sc-reading-empty"));k($);const se=ue.coverage;if(k(st("p",`Получено оспаривающих связей: ${se.returned_challenge_relations??ue.challenge_relations.length} из ${se.available_challenge_relations??ue.challenge_relations.length}.`+(x.kind==="relation"?" Выбранная связь исключена из второго столбца.":""),"sc-evidence-note")),J.contextual_readings.length){const _e=st("details","","sc-evidence-refs");_e.append(st("summary","Контекст · "+J.contextual_readings.length));for(const Me of J.contextual_readings)_e.append(A(Me,"СВЯЗЬ КОНТЕКСТА"));k(_e)}k(Z("Что остаётся открытым",J.gaps))}function Y(){d.capture(),d.enter(M+"|"+C),l.replaceChildren(),p.textContent="",l.setAttribute("aria-busy",String(!g&&!m)),m?k(w("Не удалось прочитать основания",[m.message]),Xs("Повторить",()=>{r(),ne(x,C).catch(()=>{})},"sc-evidence-source")):g?C==="grounds"?R():G():k(st("div","Собираю источники и прочтения…","sc-evidence-loading")),d.restore(),e.invalidate()}async function ne(J,ue=null,{signal:me,limit:B=60}={}){if(!J?.raw)throw new Error("Сначала выберите звезду или отношение.");const oe=++I;d.capture();const $=e.port.packet?.source_revision,se=JSON.stringify([J.raw.id,J.kind,$]);se!==M&&(_=0),P=document.activeElement,t.open("evidence"),x=J,g=null,m=null,M=se,ue=ue||h.get(M)||"grounds",c.dataset.itemId=J.raw.id,c.querySelector("h3").textContent=ji(vt(J.raw.display.title||J.raw.display.label)),c.querySelector(".sc-evidence-kind").textContent=J.kind==="relation"?"ОТНОШЕНИЕ":vt(J.raw.display.kind_label,"УЗЕЛ").toUpperCase(),S(ue),v[D.indexOf(ue)].focus();try{const _e=await a.run("evidence",Me=>i0(J.raw,J.kind,$,{client:s,queries:o,limit:B,signal:me?AbortSignal.any([me,Me]):Me}));if(me?.throwIfAborted(),!_e.current||c.hidden)throw new DOMException("Panel closed","AbortError");return g=_e.value,Y(),g}catch(_e){throw oe===I&&!c.hidden&&(m=_e.name==="AbortError"?new Error("Чтение прервано. Можно повторить запрос."):_e,Y()),_e}}n.addEventListener("sophia-evidence",J=>{r(),ne(J.detail).catch(()=>{})});function de(){const J=i();!c.hidden&&M!==JSON.stringify([J?.id,J?.kind==="edge"?"relation":"node",e.port.packet?.source_revision])&&t.close("evidence")}async function ce(J,ue,{signal:me}){const B=i(),oe=B?.kind==="edge"?"relation":"node",$=oe==="relation"?e.port.relation(B?.id):e.port.node(B?.id),se=await ne({raw:$,kind:oe},J,{signal:me,limit:Number(ue.limit)||60});if(!se.packet)throw new Error("Для этого объекта маршрут Evidence Lens сейчас недоступен.");return J==="compare"?Cc(se,B):{...se.packet,binding:se.binding,agent_summary:{...se.packet.agent_summary,selection:$.id}}}return t.configure("evidence",{onResume:()=>{g?d.restore():ne(x,C).catch(()=>{})}}),ki(),window.addEventListener("pagehide",()=>a.cancelAll()),{selectionChanged:de,handlers:{"tos.page.inspect-epistemic":(J,ue)=>ce("grounds",J,ue),"tos.page.compare-readings":(J,ue)=>ce("compare",J,ue)}}}const bn=n=>n?.source_graph==="philosophy"&&typeof n.native_id=="string"&&!!n.native_id,yi=()=>{throw new Wt("Маршрут не удалось связать с текущими данными. Обновите область.")};function l0(n,{depth:e=2,direction:t="either",profile:i="overview"}={}){return{focus_node_id:n,max_depth:e,direction:t,profile:i,page_nodes:10,page_relations:14}}function c0(n){return{schema_version:"tos_lens_spec_v1",lens_id:"observatory-path-search",sources:["philosophy"],language:"ru",detail:"compact",seed:{text_query:n},traversal:{depth:0,profile:"all"},relation_query:{enabled:!1},limits:{nodes:6,relations:0,groups:1}}}function d0(n,e,t,{direction:i,maxDepth:r,alternativeLimit:s,excluded:a}){(n?.schema!=="tos_philosophy_mcp_path_v2"||n.from_id!==e.native_id||n.to_id!==t.native_id||n.direction!==i||n.max_depth!==r||n.alternative_limit!==s||!Array.isArray(n.paths)||n.paths.length>s||n.path_count!==n.paths.length||n.found!==n.paths.length>0||typeof n.exploration_truncated!="boolean"||JSON.stringify([...n.excluded_edge_ids||[]].sort())!==JSON.stringify(a.map(c=>c.native_id).sort()))&&yi();const o=new Set;for(const c of n.paths){const l=c.node_ids,p=c.edge_ids;(!Array.isArray(l)||!Array.isArray(p)||!Array.isArray(c.nodes)||!Array.isArray(c.edges)||!Array.isArray(c.traversal)||l[0]!==e.native_id||l.at(-1)!==t.native_id||l.length!==p.length+1||p.length>r||new Set(l).size!==l.length||new Set(p).size!==p.length||c.nodes.length!==l.length||c.edges.length!==p.length||c.traversal.length!==p.length)&&yi();const u=JSON.stringify(p);o.has(u)&&yi(),o.add(u);for(let d=0;d<l.length;d++)c.nodes[d].node_id!==l[d]&&yi();for(let d=0;d<p.length;d++){const h=c.edges[d],_=c.traversal[d],x=h.from_id===l[d]&&h.to_id===l[d+1],g=h.to_id===l[d]&&h.from_id===l[d+1];(h.edge_id!==p[d]||a.some(m=>m.native_id===p[d])||!x&&!g||i==="outgoing"&&!x||i==="incoming"&&!g||_.edge_id!==p[d]||_.from_node_id!==l[d]||_.to_node_id!==l[d+1]||_.edge_direction!==(x?"forward":"reverse"))&&yi()}}return n}function u0(n,e){return{schema_version:"tos_lens_spec_v1",lens_id:"observatory-path",sources:["philosophy"],language:"ru",detail:"compact",seed:{focus_node_id:e.id},node_query:{filters:[{field:"native_id",op:"in",value:n.node_ids}]},relation_query:{filters:[{field:"native_id",op:"in",value:n.edge_ids}]},traversal:{depth:0,profile:"all"},limits:{nodes:9,relations:8,groups:1}}}function f0(n,e,t,i){function r(o,c,l){o.length!==c.length&&yi();const p=new Map;for(const u of o){const d=c.find(h=>h[l==="node"?"node_id":"edge_id"]===u.native_id);(!bn(u)||p.has(u.native_id)||!d||!Vi(d).some(h=>Vi(u).includes(h)))&&yi(),p.set(u.native_id,u)}return p}const s=r(e.nodes,n.nodes,"node"),a=r(e.relations,n.edges,"relation");(s.get(t.native_id)?.id!==t.id||s.get(i.native_id)?.id!==i.id)&&yi();for(const o of n.edges){const c=a.get(o.edge_id);(c.from_id!==s.get(o.from_id)?.id||c.to_id!==s.get(o.to_id)?.id)&&yi()}return{packet:e,node_ids:n.node_ids.map(o=>s.get(o).id),edge_ids:n.edge_ids.map(o=>a.get(o).id),nodes:n.node_ids.map(o=>s.get(o)),edges:n.edge_ids.map(o=>a.get(o)),traversal:n.traversal.map(o=>({edge_id:a.get(o.edge_id).id,from_node_id:s.get(o.from_node_id).id,to_node_id:s.get(o.to_node_id).id,edge_direction:o.edge_direction}))}}async function h0(n,e,t,{client:i,queries:r,signal:s,direction:a="either",maxDepth:o=6,alternativeLimit:c=3,excluded:l=[]}){if(!bn(n)||!bn(e)||l.some(x=>!bn(x)))throw new Error("Маршруты пока доступны между объектами философского графа.");if(n.id===e.id)throw new Error("Выберите две разные звезды.");if(!["outgoing","incoming","either"].includes(a)||!Number.isInteger(o)||o<1||o>8||!Number.isInteger(c)||c<1||c>5||l.length>64)throw new Error("Выберите глубину от 1 до 8 и до 5 вариантов.");if(l.some(x=>x.native_id.includes(",")))throw new Error("Эту связь пока нельзя исключить через доступный маршрут поиска.");const p=[[n,"node"],[e,"node"],...l.map(x=>[x,"relation"])],u=()=>Promise.all(p.map(([x,g])=>i.inspect(g,x.id,s,t,x.content_revision)));await u(),s?.throwIfAborted();const d={direction:a,maxDepth:o,alternativeLimit:c,excluded:l},h=d0(await r.invoke("tos.path.find",{from_id:n.native_id,to_id:e.native_id,direction:a,max_depth:o,alternative_limit:c,excluded_edge_ids:l.map(x=>x.native_id)},{signal:s}),n,e,d),_=await Promise.all(h.paths.map(async x=>f0(x,await i.compile(u0(x,n),s,t),n,e)));await u(),s?.throwIfAborted();for(const x of _)for(const g of[n,e])if(x.nodes.find(m=>m.id===g.id)?.content_revision!==g.content_revision)throw new Ti;return{schema:"tos_observatory_paths_v1",from_id:n.id,to_id:e.id,source_revision:t,found:_.length>0,path_count:_.length,paths:_,direction:a,max_depth:o,alternative_limit:c,excluded_edge_ids:l.map(x=>x.id),exploration_truncated:h.exploration_truncated,next_actions:_.length?["inspect a route node or relation","try excluding a relation"]:["change direction or depth","restore an excluded relation"]}}const _t=(n,e="",t="")=>{const i=document.createElement(n);return i.textContent=e,i.className=t,i},gn=(n,e,t="sc-nav-button")=>{const i=_t("button",n,t);return i.type="button",i.addEventListener("click",e),i},Zn=n=>vt(n?.display?.title||n?.display?.label,"Выбрать звезду");function p0(n,e,t,{selected:i,commit:r,onUserAction:s}){const a=new or,o=new or({base:""}),c=new Vr,l=jo((f,U)=>o.request(f,U));let p="neighbors",u=null,d=null,h=null,_=null,x=null,g=null,m=null,C=0,P=2,M="either",I="overview",T=6,D=3,v=[],S=!1,w=null,L="end",H=0,Z=0,k=!1,z=null;const R=_t("section","","sc-panel sc-navigation-panel");R.hidden=!0,R.setAttribute("aria-label","Связи и маршруты"),R.innerHTML='<div class="sc-panel-top"><span class="sc-eyebrow">АТЛАС ПЕРЕХОДОВ</span><button type="button" class="sc-icon sc-nav-close" aria-label="Закрыть маршруты"><i data-lucide="x" aria-hidden="true"></i></button></div><div class="sc-nav-heading"><span aria-hidden="true">⟡</span><h3>Продолжить мысль</h3></div><div class="sc-nav-tabs" role="tablist" aria-label="Способ исследования"></div><div class="sc-nav-body" id="sc-nav-body" role="tabpanel" tabindex="0"></div><div class="sc-nav-status" role="status"></div><div class="sc-nav-footer"></div>',n.append(R);const A=R.querySelector(".sc-nav-body"),G=R.querySelector(".sc-nav-status"),Y=R.querySelector(".sc-nav-footer"),ne=as(A);function de(){ne.capture(),H++,c.cancelAll(),clearTimeout(Z),S=!1}t.register("navigation",R,de);const ce=gn("",()=>{s(),oe()},"sc-control sc-navigation-open");ce.setAttribute("aria-label","Связи и маршруты"),ce.innerHTML='<i data-lucide="route" aria-hidden="true"></i><span>Маршруты</span>',n.querySelector(".sc-header-actions").append(ce);function J(){t.close("navigation"),(z?.isConnected&&!z.closest("[hidden]")?z:ce).focus()}R.querySelector(".sc-nav-close").addEventListener("click",()=>{s(),J()}),R.addEventListener("keydown",f=>{f.key==="Escape"&&(f.preventDefault(),f.stopPropagation(),s(),J())});const ue=["neighbors","paths"].map((f,U)=>{const O=gn(U?"Маршрут":"Связи",()=>{s(),de(),p=f,w=null,U&&!d&&bn(me())&&(d=me()),N()},"");return O.id="sc-nav-tab-"+f,O.setAttribute("role","tab"),O.setAttribute("aria-controls","sc-nav-body"),O.addEventListener("keydown",V=>{["ArrowLeft","ArrowRight","Home","End"].includes(V.key)&&(V.preventDefault(),ue[V.key==="Home"?0:V.key==="End"?1:1-U].click(),ue[p==="paths"?1:0].focus())}),R.querySelector(".sc-nav-tabs").append(O),O}),me=()=>{const f=i();return f?.kind==="node"?e.port.node(f.id):null};function B(){const f=e.port.packet?.source_revision;return f!==_?(de(),_=f,d=null,h=null,u=null,m=null,g=null,v=[],x=null,!0):!1}function oe(f=p){B(),!x&&e.port.packet&&(x=e.port.captureView()),z=document.activeElement,t.open("navigation"),p=f,u=me()||u,g&&g.focus.node_id!==u?.id&&(g=null),p==="paths"&&!d&&bn(me())&&(d=me()),N(),ue[p==="paths"?1:0].focus()}function $(f,{command:U=!1}={}){x||(x=e.port.captureView()),k=!0;try{U?r(()=>e.port.setGraph(f)):e.port.setGraph(f)}finally{k=!1}}async function se(f,U,O){e.ui.cancelPending(),w=null,S=!0;const V=++H;N();try{const fe=await c.run("navigation",he=>f(O?AbortSignal.any([he,O]):he));if(O?.throwIfAborted(),!fe.current||V!==H||R.hidden)throw new DOMException("Navigation cancelled","AbortError");return U(fe.value),fe.value}catch(fe){throw V===H&&!R.hidden&&(w=fe.name==="AbortError"?new Error("Поиск прерван. Можно повторить."):fe),fe}finally{V===H&&(S=!1,N())}}const _e=f=>()=>{s(),f().catch(()=>{})};function Me(f){const U=A.querySelector(f);U&&!R.hidden&&(A.scrollTop+=U.getBoundingClientRect().top-A.getBoundingClientRect().top,e.invalidate())}async function ve(f=!1,U){if(!u)throw new Error("Сначала выберите звезду.");const O=f?g:null,V=u,fe=await se(async he=>{await a.inspect("node",V.id,he,_,V.content_revision);const ee=await a.explore(O?{cursor:O.page.next_cursor}:l0(V.id,{depth:P,direction:M,profile:I}),he,_,O);if(ee.focus.node_id!==V.id||ee.nodes.find(te=>te.id===V.id)?.content_revision!==V.content_revision)throw new Ti;return ee},he=>{g=he,$(he,{command:!!U})},U);return Me(".sc-nav-page"),fe}async function F(f){if(!d||!h)throw new Error("Выберите начало и конец маршрута.");const U=await se(O=>h0(d,h,_,{client:a,queries:l,signal:O,direction:M,maxDepth:T,alternativeLimit:D,excluded:v}),O=>{m=O,C=0,O.paths.length&&$(O.paths[0].packet,{command:!!f})},f);return Me(U.found?".sc-nav-variants":".sc-nav-empty"),U}function K(f,U,O,V){const fe=_t("label","","sc-nav-field");fe.append(_t("span",f));const he=_t("select");for(const[ee,te]of O){const Se=_t("option",te);Se.value=ee,he.append(Se)}return he.value=U,he.disabled=S,he.addEventListener("change",()=>{s(),de(),w=null,V(he.value),N()}),fe.append(he),fe}function ae(f){const U=_t("div","","sc-nav-options");return U.append(K("Направление",M,[["either","В обе стороны"],["outgoing","По связям →"],["incoming","Против связей ←"]],O=>{M=O,m=null,g=null})),U.append(K("Глубина",String(f?T:P),Array.from({length:f?8:3},(O,V)=>[String(V+1),String(V+1)+" "+(V===0?"шаг":V<4?"шага":"шагов")]),O=>{f?(T=Number(O),m=null):(P=Number(O),g=null)})),f?U.append(K("Варианты",String(D),[1,2,3,4,5].map(O=>[String(O),"До "+O]),O=>{D=Number(O),m=null})):U.append(K("Содержание",I,[["overview","Обзор связей"],["all","Все типы связей"]],O=>{I=O,g=null})),U}function xe(f){return _t("p",f,"sc-nav-note")}function Ae(f,U="node"){s(),!(U==="node"?e.port.node(f.id):e.port.relation(f.id))&&m?.paths[C]&&$(m.paths[C].packet),t.close("navigation"),U==="node"?e.port.selectNode(f.id):e.port.selectRelation(f.id)}function be(){if(A.append(_t("div","ОТ ВЫБРАННОЙ ЗВЕЗДЫ","sc-nav-caption"),_t("h4",u?Zn(u):"Выберите звезду в пространстве","sc-nav-origin")),!u){A.append(xe("Откройте её карточку, затем «Окрестность»."));return}A.append(ae(!1));const f=gn(S?"Раскрываю…":"Раскрыть связи",_e(()=>ve()),"sc-nav-primary");if(f.disabled=S,A.append(f),g){const U=_t("div","","sc-nav-page");if(U.append(_t("span","ОБЛАСТЬ "+String(g.page.number).padStart(2,"0"),"sc-nav-caption"),_t("p",`Звёзд: ${g.nodes.length} · связей: ${g.relations.length}`)),A.append(U),A.append(xe(`За этот обход обнаружено узлов: ${g.counts.discovered_nodes}; показано связей: ${g.counts.emitted_relations}. На экране — текущая порция.`)),g.status==="paused"){const V=gn("Продолжить раскрытие →",_e(()=>ve(!0)));V.disabled=S,A.append(V)}else A.append(xe(g.status==="complete"?"Обход завершён в выбранных пределах.":"Достигнут предел обхода. Выберите более близкий центр."));const O=_t("div","","sc-nav-discoveries");for(const V of g.page.primary_node_ids){const fe=g.nodes.find(he=>he.id===V);V!==u.id&&O.append(gn(Zn(fe),()=>Ae(fe),"sc-nav-discovery"))}A.append(O)}else A.append(xe("Связи раскрываются небольшими областями. Сохраняются положение камеры и места уже знакомых звёзд."))}function ke(f){L=f,m=null,w=null,N(),A.querySelector("input")?.focus()}function Xe(f,U,O){const V=gn("",()=>{s(),ke(O)},"sc-nav-endpoint");return V.disabled=S,V.append(_t("small",f),_t("span",Zn(U))),V.dataset.empty=String(!U),V}function Ze(){const f=_t("div","","sc-nav-search"),U=_t("label",L==="start"?"Найти начало":"Найти конечную звезду");U.htmlFor="sc-nav-query";const O=_t("input");O.id="sc-nav-query",O.type="search",O.placeholder="Имя или понятие…",O.autocomplete="off",O.disabled=S;const V=_t("div","","sc-nav-search-results");V.setAttribute("aria-live","polite"),f.append(U,O,V),A.append(f),O.addEventListener("input",()=>{s(),clearTimeout(Z),c.cancel("search"),V.replaceChildren();const fe=O.value.trim().slice(0,256);if(!fe)return;const he=L;V.append(xe("Ищу…")),Z=setTimeout(async()=>{try{const ee=await c.run("search",Se=>a.compile(c0(fe),Se,_));if(!ee.current||!O.isConnected||R.hidden)return;V.replaceChildren();const te=ee.value.nodes.filter(bn);for(const Se of te){const Ue=gn("",()=>{s(),de(),he==="start"?(d=Se,h||(L="end")):h=Se,m=null,v=[],w=null,N()},"sc-nav-search-result");Ue.dataset.itemId=Se.id,Ue.append(_t("span",Zn(Se)),_t("small",vt(Se.display.kind_label)),_t("span",vt(Se.display.summary),"sc-nav-search-context"),_t("small",Se.native_id,"sc-nav-search-identity")),V.append(Ue)}V.append(xe(te.length===6?"Первые 6 совпадений. Уточните название для более точного поиска.":te.length?"Объекты философского графа":"Совпадений в философском графе нет.")),e.invalidate()}catch(ee){O.isConnected&&!R.hidden&&(V.replaceChildren(xe(ee.message)),e.invalidate())}},200)})}function Ne(){const f=_t("div","","sc-nav-endpoints");if(f.append(Xe("01 / НАЧАЛО",d,"start"),_t("span","↓","sc-nav-connector"),Xe("02 / НАЗНАЧЕНИЕ",h,"end")),A.append(f),A.append(xe("Поиск между объектами философского графа. Связность сама по себе не означает согласия.")),m||Ze(),A.append(ae(!0)),v.length){const he=_t("div","","sc-nav-exclusions");he.append(_t("span","Обходим связи:","sc-nav-caption"));for(const ee of v){const te=gn(Zn(ee)+" · вернуть",_e(async()=>{v=v.filter(Se=>Se.id!==ee.id),await F()}));te.disabled=S,he.append(te)}A.append(he)}const U=gn(S?"Ищу пути…":m?"Найти заново":"Найти пути",_e(()=>F()),"sc-nav-primary");if(U.disabled=S||!d||!h||d.id===h.id,A.append(U),!m||(m.found||A.append(_t("h4","Здесь путь не найден","sc-nav-origin sc-nav-empty"),xe("В пределах выбранного направления, глубины и исключений. Можно изменить условия и повторить поиск.")),m.exploration_truncated&&A.append(xe("Поиск достиг вычислительного предела; другие пути могли остаться за ним.")),!m.found))return;const O=_t("div","","sc-nav-variants");O.setAttribute("role","group"),O.setAttribute("aria-label","Варианты маршрута"),m.paths.forEach((he,ee)=>{const te=gn(String(ee+1).padStart(2,"0")+" · "+he.edges.length+" св.",()=>{s(),C=ee,$(he.packet),N()},"sc-nav-variant");te.setAttribute("aria-pressed",String(ee===C)),te.disabled=S,O.append(te)}),A.append(O),A.append(xe(`Путь ${C+1} из ${m.path_count} · поиск до ${m.alternative_limit} вариантов.`));const V=m.paths[C],fe=_t("ol","","sc-nav-itinerary");V.nodes.forEach((he,ee)=>{const te=_t("li");if(te.append(gn(Zn(he),()=>Ae(he),"sc-nav-stop")),V.edges[ee]){const Se=V.edges[ee],Ue=_t("div","","sc-nav-hop");Ue.append(gn(Zn(Se),()=>Ae(Se,"relation"),"sc-nav-relation")),V.traversal[ee].edge_direction==="reverse"&&Ue.append(_t("small","← против направления связи"));const we=gn("Обойти",_e(async()=>{v.some(Te=>Te.id===Se.id)||(v=[...v,Se]),await F()}),"sc-nav-skip");we.setAttribute("aria-label","Обойти связь: "+Zn(Se)),we.disabled=S,Ue.append(we),te.append(Ue)}fe.append(te)}),A.append(fe)}function N(){ne.capture(),ne.enter(JSON.stringify([_,u?.id,p,C])),ue.forEach((f,U)=>{const O=p===(U?"paths":"neighbors");f.setAttribute("aria-selected",String(O)),f.tabIndex=O?0:-1}),A.setAttribute("aria-labelledby","sc-nav-tab-"+p),A.setAttribute("aria-busy",String(S)),A.replaceChildren(),p==="paths"?Ne():be(),G.textContent=w?.message||"",R.dataset.state=S?"loading":w?"error":"ready",Y.replaceChildren(),x?Y.append(gn("↶ К исходному виду",()=>{s();const f=x;x=null,t.close("navigation"),k=!0;try{e.port.restoreView(f)}finally{k=!1}},"sc-nav-return")):Y.append(_t("span","От звезды — к созвездию")),ne.restore(),e.invalidate()}async function at({raw:f,kind:U,tab:O}){if(B(),x||(x=e.port.captureView()),oe(O||"paths"),U==="node"){u=f,p==="paths"&&bn(f)?(d&&d.id!==f.id?h=f:d=f,m=null,v=[]):p==="paths"&&(d=null,h=null,m=null,v=[],w=new Error("Для этой звезды поиск путей пока не подключён. Можно раскрыть её связи или выбрать объекты философского графа.")),N();return}if(!bn(f)){w=new Error("Поиск обходного пути пока доступен для связей философского графа."),N();return}await se(async V=>(await Promise.all([f.from_id,f.to_id].map(he=>a.inspect("node",he,V,_)))).map(he=>he.match),V=>{[d,h]=V,v=[f],m=null})}n.addEventListener("sophia-navigate",f=>{s(),at(f.detail).catch(()=>{})});function $e(){k||(B()&&!R.hidden&&(w=new Error("Область обновилась. Выберите звезду для нового исследования."),N()),S&&(de(),R.hidden||(w=new Error("Выбор изменился. Повторите поиск из нужной звезды."),N())))}async function E(f,{signal:U},O=!1){if(f.constrain_to_view)throw new Error("Ограничение маршрута текущим видом пока не подключено. Доступен философский граф целиком.");const V=i(),fe=O?e.port.relation(V?.id):me();if(!fe||!bn(fe))throw new Error("Выберите объект философского графа.");if(B(),x||(x=e.port.captureView()),oe("paths"),O){const he=await Promise.all([fe.from_id,fe.to_id].map(ee=>a.inspect("node",ee,U,_)));U.throwIfAborted(),[d,h]=he.map(ee=>ee.match),v=[fe]}else{if(!d)throw new Error("Сначала задайте начало маршрута.");h=fe,v=[]}return f.excluded_edge_ids?.length&&(v=(await Promise.all(f.excluded_edge_ids.map(he=>a.inspect("relation",he,U,_)))).map(he=>he.match)),M=f.direction||"outgoing",T=Number(f.max_depth)||6,D=Number(f.alternative_limit)||3,F(U)}return t.configure("navigation",{onResume:()=>{ne.restore(),N()}}),ki(),window.addEventListener("pagehide",de),{selectionChanged:$e,get startId(){return d?.id||null},handlers:{"tos.page.start-path":()=>{const f=me();if(!bn(f))throw new Error("Выберите звезду философского графа.");return B(),x||(x=e.port.captureView()),d=f,h=null,m=null,v=[],oe("paths"),{path_start_node_id:d.id}},"tos.page.find-path":(f,U)=>E(f,U),"tos.page.reroute-without-selection":(f,U)=>E(f,U,!0),"tos.page.show-neighborhood":async(f,{signal:U})=>{if(B(),u=me(),!u)throw new Error("Сначала выберите звезду.");x||(x=e.port.captureView()),oe("neighbors"),P=Math.max(1,Math.min(3,Number(f.depth)||1));const O=await ve(!1,U);return{node:{node_id:u.id,label:Zn(u)},neighbors:O.nodes.filter(V=>V.id!==u.id).map(V=>({node_id:V.id,label:Zn(V)})),edges:O.relations.map(V=>({edge_id:V.id})),page:O.page,status:O.status}}}}}const Od={meaning:"Понятия и смыслы",identity:"Люди и произведения",history:"История и традиции",authorship:"Авторство и передача",evidence:"Источники и свидетельства",structure:"Структура источников",other:"Другие типы",technical:"Технические типы",unavailable:"Выбрано вне этих источников"},m0=Object.keys(Od),Pc=new Intl.Collator("ru",{numeric:!0,sensitivity:"base"});function g0(n,e){const t=e==="predicates",i=n.semantic_registries||{},r=new Map((i.entity_types?.entries||[]).map(c=>[c.type_id,c])),s=t?new Map((i.relation_types?.entries||[]).map(c=>[c.relation_type_id,c])):r,a=t?"predicate_id":"kind_id",o=t?"source_predicate_id":"source_kind_id";return(t?n.predicates:n.node_kinds).map(c=>{const l=(c[t?"relation_type_ids":"type_ids"]||[]).map(g=>s.get(g)),p=l.flatMap(g=>(g?.source_mappings||[]).filter(m=>m[o]===c[a]&&(!t||m.scope==="edge"))),u=[...new Set(p.map(g=>g.source_graph).filter(g=>typeof g=="string"))],d=l.length>0&&l.every(Boolean)&&u.length>0&&!c.mapping_statuses?.includes("unmapped");function h(g){if(!g)return"other";if(!t)return{semantic:"meaning",identity:"identity",navigation:"history",evidence:"evidence",assertion:"evidence",activity:"evidence",literal:"evidence",projection:"technical"}[g.object_role]||"other";const m=g.domain_type_ids||[],C=g.range_type_ids||[];return g.assertion_mode==="derived-projection"||[...m,...C].length>0&&[...m,...C].every(P=>r.get(P)?.object_role==="projection")?"technical":g.parent_relation_type_ids?.includes("tos.relation.responsibility")?"authorship":g.assertion_mode==="structural"?"structure":g.assertion_mode==="reified-claim"||g.parent_relation_type_ids?.includes("tos.relation.claim-structure")?"evidence":g.assertion_mode==="direct"?"meaning":"other"}const _=l.map(h),x=_.find(g=>g!=="technical")||_[0]||"other";return{id:c[a],title:vt(c.display,c[a]),group:x,sources:u,sourceKnown:d,count:c.count||0}})}function _0(n,{sources:e,selected:t=[],query:i="",sort:r="alphabet"}={}){const s=i.trim().toLocaleLowerCase("ru"),a=new Set(t),o=new Map,c=[...n];for(const l of a)n.some(p=>p.id===l)||c.push({id:l,title:l,group:"other",sources:[],sourceKnown:!1,count:0});for(const l of c){const p=!l.sourceKnown||l.sources.some(d=>e.includes(d));if(!p&&!a.has(l.id)||s&&!(l.title+" "+l.id).toLocaleLowerCase("ru").includes(s))continue;const u=p?l.group:"unavailable";o.has(u)||o.set(u,[]),o.get(u).push({...l,selected:a.has(l.id),available:p})}return m0.filter(l=>o.has(l)).map(l=>({key:l,title:Od[l],items:o.get(l).sort((p,u)=>Number(u.selected)-Number(p.selected)||(r==="frequency"?u.count-p.count:0)||Pc.compare(p.title,u.title)||Pc.compare(p.id,u.id))}))}const et=(n,e="",t="")=>{const i=document.createElement(n);return i.textContent=e,i.className=t,i},gi=(n,e,t="sc-builder-button")=>{const i=et("button",n,t);return i.type="button",i.addEventListener("click",e),i},v0=new Intl.PluralRules("ru"),is=(n,e,t,i)=>`${n} ${{one:e,few:t,many:i}[v0.select(n)]||i}`,x0={philosophy:"Философский атлас",canon:"Канон","candidate-intake":"Исследовательские кандидаты","source-navigation":"Произведения и источники","source-claims":"Утверждения источников","semantic-interchange":"Понятия и типы",repository:"Карта проекта"};function y0(n,e,t,{onUserAction:i}){const r=new or,s=new Vr;let a=null,o=null,c=null,l=null,p=null,u=null,d=!1,h="",_="",x=!1,g=!1,m=[],C=null,P=0,M=!1,I="",T=null,D=!1,v=null;const S=new Map,w=new Map,L=et("section","","sc-panel sc-builder");L.hidden=!0,L.setAttribute("aria-label","Конструктор линз"),L.innerHTML='<div class="sc-panel-top"><span class="sc-eyebrow">ОПТИКА МЫСЛИ</span><button class="sc-icon sc-builder-close" type="button" aria-label="Закрыть конструктор"><i data-lucide="x" aria-hidden="true"></i></button></div><div class="sc-builder-heading"><span aria-hidden="true">◈</span><div><h3>Собрать линзу</h3><p>Настройки сразу меняют пространство.</p></div></div><div class="sc-builder-body"></div><div class="sc-builder-result" aria-live="polite"></div><div class="sc-builder-status" role="status"></div><div class="sc-builder-footer"></div>',n.append(L);const H=L.querySelector(".sc-builder-body"),Z=L.querySelector(".sc-builder-result"),k=L.querySelector(".sc-builder-status"),z=L.querySelector(".sc-builder-footer"),R=gi("Конструктор линз",()=>{i(),de()},"sc-builder-open");n.querySelector(".sc-lenses").append(R);const A=n.querySelector(".sc-lenses-open"),G=()=>{P++,clearTimeout(T),T=null,D=!1,s.cancelAll(),d=!1};t.register("builder",L,G);function Y(){t.close("builder"),(C?.isConnected&&!C.closest("[hidden]")?C:A).focus()}L.querySelector(".sc-builder-close").addEventListener("click",()=>{i(),Y()}),L.addEventListener("keydown",ve=>{ve.key==="Escape"&&(ve.stopPropagation(),ve.preventDefault(),i(),Y())});function ne(){p=e.port.packet,u=p,l=p?e.port.captureView():null,c=null,x=!1,o=null,M=!1,v=null,S.clear()}async function de(){C=document.activeElement,(M||!o||e.port.packet!==u)&&ne(),t.open("builder"),h="",I="";try{m=Hc(localStorage),_=""}catch(ve){m=[],_=ve.message||"Локальное хранилище недоступно."}if(a&&a.catalog.source_revision===e.port.packet?.source_revision){ce(),$();return}await J()}function ce(){o||(o=structuredClone(ha(e.port.packet)||nu(p,a)));const ve=e.port.selection.nodeId;o.scope==="area"&&ve&&p?.nodes.some(F=>F.id===ve)&&(o.focusId=ve)}async function J(){i(),G();const ve=P;d=!0,a=null,I="",$();try{const F=await s.run("catalog",K=>il(r,K));if(!F.current||ve!==P||L.hidden)return;a=F.value,ce(),h=""}catch(F){ve===P&&(h=F.message||"Не удалось загрузить словарь данных.")}finally{ve===P&&(d=!1,$())}}function ue(){i(),G(),h="",I="",c=null,x=!1,v=null,a&&!M&&(D=!0,T=setTimeout(()=>{T=null,_e()},400)),se()}function me(ve,F){const K=et("label","","sc-builder-field");return K.append(et("span",ve),F),K}function B(ve,F,K){K.some(([xe])=>String(xe)===String(o[F]))||(K=[...K,[o[F],String(o[F])]]);const ae=et("select");for(const[xe,Ae]of K){const be=et("option",Ae);be.value=String(xe),ae.append(be)}return ae.value=String(o[F]),ae.addEventListener("change",()=>{o[F]=["limit","depth"].includes(F)?Number(ae.value):ae.value,ue(),F==="scope"&&$()}),me(ve,ae)}function oe(ve,F){const K=S.get(F)||{open:!1,query:"",sort:"alphabet",expanded:new Map,limits:new Map};S.set(F,K);const ae=et("details","","sc-builder-choices"),xe=et("summary"),Ae=et("div","","sc-builder-options"),be=et("input");ae.open=K.open,ae.addEventListener("toggle",()=>K.open=ae.open),be.type="search",be.placeholder="Найти в списке…",be.setAttribute("aria-label","Найти: "+ve),be.value=K.query;const ke=et("select");ke.setAttribute("aria-label","Порядок: "+ve);for(const[$e,E]of[["alphabet","По алфавиту"],["frequency","Сначала частые"]]){const f=et("option",E);f.value=$e,ke.append(f)}ke.value=K.sort;const Xe=g0(a.catalog,F),Ze=new Map;for(const $e of Xe)Ze.set($e.title,(Ze.get($e.title)||0)+1);const Ne=()=>xe.textContent=ve+" · "+(o[F].length?o[F].length+" выбрано":"любые");Ne();function N(){const $e=Ae.scrollTop;Ae.replaceChildren();const E=_0(Xe,{sources:o.sources,selected:o[F],query:K.query,sort:K.sort});for(const f of E){const U=et("details","","sc-builder-choice-group"),O=et("summary",f.title+" · "+f.items.length);U.dataset.group=f.key,U.open=K.query.trim()!==""||f.items.some(fe=>fe.selected)||K.expanded.get(f.key)===!0,U.addEventListener("toggle",()=>K.expanded.set(f.key,U.open)),U.append(O),f.key==="unavailable"&&U.append(et("p","Эти условия сохраняются. Снимите их или включите соответствующий источник.","sc-builder-note"));const V=K.limits.get(f.key)||40;for(const fe of f.items.slice(0,V)){const he=et("input");he.type="checkbox",he.value=fe.id,he.checked=fe.selected,he.addEventListener("change",()=>{o[F]=he.checked?[...o[F],fe.id]:o[F].filter(Se=>Se!==fe.id),Ne(),ue()});const ee=et("label","","sc-builder-choice"),te=et("span",fe.title);Ze.get(fe.title)>1&&te.append(et("small",fe.id)),ee.append(he,te),U.append(ee)}f.items.length>V&&U.append(gi("Ещё варианты · "+(f.items.length-V),()=>{K.limits.set(f.key,V+40),N()},"sc-builder-link")),Ae.append(U)}E.length||Ae.append(et("p","Нет вариантов для этих источников и поиска.","sc-builder-note")),Ae.scrollTop=$e}be.addEventListener("input",()=>{K.query=be.value,N()}),ke.addEventListener("change",()=>{K.sort=ke.value,N()}),w.set(F,N),N();const at=et("div","","sc-builder-choice-controls");return at.append(be,ke),ae.append(xe,at,Ae,et("p","Типы для выбранных источников. Технические — в отдельной группе.","sc-builder-note"),gi("Сбросить выбор",()=>{o[F]=[],Ne(),N(),ue()},"sc-builder-link")),ae}function $(){const ve=H.scrollTop;if(H.replaceChildren(),w.clear(),!a){H.append(et("p",d?"Загружаю доступные источники и условия…":"Словарь данных пока недоступен.","sc-builder-note")),d||H.append(gi("Повторить загрузку",()=>{J()})),se();return}const F=et("input");if(F.type="text",F.maxLength=64,F.value=o.name,F.addEventListener("input",()=>{o.name=F.value,ue()}),H.append(me("Название линзы",F)),m.length){const be=et("select");be.append(et("option","Выбрать сохранённую…"));for(const ke of m){const Xe=et("option",ke.name);Xe.value=ke.name,be.append(Xe)}be.addEventListener("change",()=>{const ke=m.find(Xe=>Xe.name===be.value);ke&&(o=structuredClone(ke),ue(),$())}),H.append(me("Мои линзы",be))}if(H.append(B("Отправная точка","scope",[["area","Из исходной области"],["focus","От выбранной звезды"],["all","По всему древу"]])),o.scope==="area"&&H.append(et("p",`Исходная область: ${is(o.nodeIds.length,"звезда","звезды","звёзд")}. Фильтры выбирают начало; глубина добавляет окружение.`,"sc-builder-note")),o.scope==="focus"){const be=e.port.node(o.focusId)||p?.nodes.find(Xe=>Xe.id===o.focusId);H.append(et("p",be?vt(be.display.title):o.focusId?"Звезда из сохранённой линзы.":"Сначала выберите звезду в пространстве.","sc-builder-focus"));const ke=e.port.selection.nodeId;ke&&ke!==o.focusId&&H.append(gi("Взять выбранную звезду",()=>{o.focusId=ke,ue(),$()},"sc-builder-link")),H.append(et("p","Центр остаётся в области. Условия ниже выбирают связи вокруг него.","sc-builder-note"))}const K=et("fieldset","","sc-builder-sources");K.append(et("legend","Источники"));for(const be of a.catalog.capabilities.sources){const ke=et("input");ke.type="checkbox",ke.checked=o.sources.includes(be),ke.addEventListener("change",()=>{o.sources=ke.checked?[...o.sources,be]:o.sources.filter(Ze=>Ze!==be),ue();for(const Ze of w.values())Ze()});const Xe=et("label");Xe.append(ke,et("span",x0[be]||be)),K.append(Xe)}if(H.append(K),o.scope!=="focus"){const be=et("input");be.type="search",be.maxLength=256,be.value=o.query,be.placeholder="Имя, произведение, понятие…",be.addEventListener("input",()=>{o.query=be.value,ue()}),H.append(me("Слова в исходных узлах",be)),H.append(oe("Типы узлов","kinds"))}const ae=et("input");ae.type="checkbox",ae.checked=o.relations,ae.addEventListener("change",()=>{o.relations=ae.checked,ue(),$()});const xe=et("label","","sc-builder-toggle");xe.append(ae,et("span","Показывать связи и окружение")),H.append(xe),o.relations&&H.append(oe("Типы связей","predicates"));const Ae=et("div","","sc-builder-grid");o.relations&&Ae.append(B("Глубина","depth",[[0,"Только исходные"],[1,"1 шаг"],[2,"2 шага"],[3,"3 шага"]]),B("Направление","direction",[["either","В обе стороны"],["outgoing","По связям →"],["incoming","Против связей ←"]]),B("Подробность связей","profile",[["all","Все типы, включая текст"],["overview","Обзор без структуры текста"]])),Ae.append(B("Звёзд в области","limit",[[10,"До 10"],[20,"До 20"],[40,"До 40"]])),H.append(Ae),H.append(et("p","Линза меняет способ просмотра. Фильтры не меняют источники, связи или их статус.","sc-builder-note")),se(),H.scrollTop=ve}function se(){if(Z.parentElement!==H&&H.append(Z),Z.replaceChildren(),z.replaceChildren(),k.textContent=M?"Область изменилась. Откройте конструктор заново для нового вида.":h||_||I||(D?"Обновлю пространство…":d?"Обновляю пространство…":x?v&&Object.values(v).every(F=>F.added===0&&F.removed===0)?"Условия применены. Состав этой области совпал.":`В пространстве: ${is(c.nodes.length,"звезда","звезды","звёзд")} · ${is(c.relations.length,"связь","связи","связей")}`:c&&!c.nodes.length?"Ничего не найдено. Предыдущий вид сохранён.":"Измените условие — результат появится в пространстве."),a){if(c){const ae=Vc(c);Z.append(et("strong",`${is(ae.nodes,"звезда","звезды","звёзд")} · ${is(ae.relations,"связь","связи","связей")}`)),Z.append(et("p",`Условиями выбрано: ${ae.matched}. Из показанных узлов добавлено окружением: ${ae.context}.`)),ae.limited&&Z.append(et("p","Результат ограничен размером области. Для другого среза уточните условия.","sc-builder-warning")),v&&Z.append(et("p",`Изменение области: звёзды +${v.nodes.added} / −${v.nodes.removed}; связи +${v.relations.added} / −${v.relations.removed}.`)),ae.nodes||Z.append(et("p","Ничего не найдено. Пространство сохранено. Измените условия."))}else Z.append(et("p","Изменения применяются автоматически; исходный вид можно вернуть."));const F=gi(d?"Обновляю…":"Обновить пространство",()=>{_e()},"sc-builder-primary");F.disabled=d||M,z.append(F);const K=gi("Сохранить линзу",()=>{i();try{Gc(o,a),m=iu(localStorage,o),_="",h="",I="Линза сохранена в этом браузере.",$()}catch(ae){h=ae.message||"Не удалось сохранить линзу.",se()}});K.disabled=d||D||M,z.append(K),h&&z.append(gi("Обновить каталог",()=>{J()},"sc-builder-link"))}const ve=gi("↶ К исходному виду",()=>{i(),G(),g=!0;try{l&&e.port.restoreView(l),u=e.port.packet,x=!1}finally{g=!1}Y()},"sc-builder-link");ve.disabled=!l,z.append(ve),e.invalidate()}async function _e(){if(M)return;i(),G(),e.ui.cancelPending(),h="",I="",x=!1,v=null;const ve=P;d=!0,se();try{nl(o);const F=structuredClone(o),K=await s.run("compile",ae=>rl(r,F,a,ae));if(!K.current||ve!==P||L.hidden)return;if(c=K.value,c.nodes.length){v=ru(e.port.packet,c),g=!0;try{e.port.setGraph(c),u=e.port.packet,x=!0}finally{g=!1}}}catch(F){ve===P&&(h=F.message||"Не удалось собрать линзу.",c=null)}finally{ve===P&&(d=!1,se(),e.invalidate())}}function Me(){g||L.hidden||e.port.packet===u||(G(),c=null,M=!0,se())}return t.configure("builder",{onResume:()=>{a?se():J()}}),addEventListener("pagehide",G),ki(),{selectionChanged:Me}}const Bd=document.getElementById("app");Bd.innerHTML=Zd;const an=Bd.firstElementChild,kd=location.search;let mt,Vn,yl,us,zd,Sl,oi,ca=!1,Lc="";const ro=new or;function jn(){if(Vn?.auxiliarySelection)return Vn.auxiliarySelection;const n=mt?.port.selection;if(!n)return null;const e=n.relationId?mt.port.relation(n.relationId):mt.port.node(n.nodeId);return e?{id:e.id,kind:n.relationId?"edge":"node",semantic_kind:e.kind_id||"relation",label:vt(e.display.title||e.display.label),subtitle:vt(e.display.statement),from_id:e.from_id,to_id:e.to_id,predicate_id:e.predicate_id,source_refs:e.source_refs,authority_posture:e.epistemic?.authority_layer,review_posture:e.epistemic?.review_posture,canon_status:e.epistemic?.canon_status,reroutable:bn(e),path_available:bn(e),evidence_available:!!Fd(e)}:null}function Ml(){if(!mt)return;const n=jn(),e=mt.port.packet,t=new URL(location.href);if(e?.focus?.node_id?t.searchParams.set("focus",e.focus.node_id):e&&t.searchParams.delete("focus"),e){const r=ha(e);r?t.searchParams.set("lens",nl(r)):t.searchParams.delete("lens")}n&&!Vn?.auxiliarySelection?t.searchParams.set("selection",n.id):t.searchParams.delete("selection"),history.replaceState(null,"",t);const i=JSON.stringify([e?.source_revision,e?.fingerprint,e?.focus,n,an.dataset.lens,us?.startId]);i!==Lc&&(Lc=i,ca||oi?.notifyStateChange()),Vn?.selectionChanged(),yl?.selectionChanged(),us?.selectionChanged(),zd?.selectionChanged(),Sl?.selectionChanged()}const _i=n=>{ca=!0;try{return n()}finally{ca=!1,Ml()}};mt=Q_(an,{autoStart:!1,initialFocus:new URLSearchParams(location.search).get("focus")||el,initialLens:new URLSearchParams(location.search).get("lens"),onChange:()=>{Vn?.clearAuxiliarySelection(),Ml()}});const fr=t0(an,mt,{onUserAction:()=>oi?.notifyStateChange()});Vn=e0(an,mt,{selected:jn,panels:fr,onChange:()=>{ca||oi?.notifyStateChange(),Ml()}});yl=o0(an,mt,fr,{selected:jn,onUserAction:()=>oi?.notifyStateChange()});us=p0(an,mt,fr,{selected:jn,commit:_i,onUserAction:()=>oi?.notifyStateChange()});zd=y0(an,mt,fr,{onUserAction:()=>oi?.notifyStateChange()});const Gd=()=>oi?.notifyStateChange();for(const[n,e,t]of[["search","Поиск",".sc-search-open"],["lenses","Линзы",".sc-lenses-open"],["workspace","Исследование",".sc-workspace-open"],["navigation","Маршруты",".sc-navigation-open"]]){const i=an.querySelector(t);fr.addTool(n,{title:e,opener:i,launch:()=>i.click()})}function Ic(){const n=mt.port.selection,e=n.relationId?"relation":"node",t=e==="relation"?mt.port.relation(n.relationId):mt.port.node(n.nodeId);return t?{raw:t,kind:e}:null}for(const[n,e,t,i]of[["builder","Конструктор линз","◈",null],["evidence","Основания","✧","sophia-evidence"],["sources","Источники","◇","sophia-sources"]]){const r=document.createElement("button");r.type="button",r.className="sc-control sc-tool-shortcut",r.setAttribute("aria-label",e);const s=document.createElement("b");s.textContent=t;const a=document.createElement("span");a.textContent=e,r.append(s,a),an.querySelector(".sc-header-actions").append(r);const o=()=>{if(Gd(),n==="builder")an.querySelector(".sc-builder-open").click();else{const c=Ic();c?an.dispatchEvent(new CustomEvent(i,{detail:c})):mt.port.announce("Сначала выберите звезду или связь.")}};r.addEventListener("click",o),fr.addTool(n,{title:e,opener:r,launch:o,available:()=>n==="builder"||!!Ic()})}Sl=Lu(an,mt,fr,{initialRoute:kd,onUserAction:Gd});Du(an,mt);const da={...Vn.handlers,...yl.handlers,"tos.page.inspect-selection":()=>jn(),"tos.page.open-view":async(n,{signal:e})=>{if(mt.ui.cancelPending(),n.mode!=="philosophy"||n.graph_mode&&n.graph_mode!=="nodes"||!["constellations","observatory"].includes(String(n.view_id)))throw new Error("Эта линза открывается в расширенном исследовательском режиме.");const t=await ro.compile(ta(String(n.focus_id||el)),e);return e.throwIfAborted(),_i(()=>mt.port.setGraph(t,{selectFocus:!!n.focus_id})),{view_id:"observatory"}},"tos.page.select":async(n,{signal:e})=>{mt.ui.cancelPending();const t=String(n.item_id||"");if(_i(()=>Vn.chooseGap(t)))return jn();if(mt.port.node(t))return _i(()=>mt.port.selectNode(t)),jn();if(mt.port.relation(t))return _i(()=>mt.port.selectRelation(t)),jn();const i=qs.get(t);if(!i)throw new Error("Выберите объект из текущей области или результатов поиска.");const r=await ro.compile(i.from_id?Fc(i):ta(t),e,Dc);return e.throwIfAborted(),_i(()=>{mt.port.setGraph(r,{selectFocus:!i.from_id}),i.from_id&&mt.port.selectRelation(t,{rememberView:!1})}),jn()},"tos.page.search":async(n,{signal:e})=>{mt.ui.cancelPending();const t=String(n.query||"").trim().slice(0,256),i=await ro.search(t,e);e.throwIfAborted(),mt.openSearch(),mt.ui.cancelSearch(),an.querySelector("#sc-query").value=t;const r=an.querySelector(".sc-search-results");r.replaceChildren(),qs.clear(),Dc=i.source_revision;for(const[s,a]of[["node",i.nodes],["relation",i.relations]])for(const o of a)qs.set(o.id,o),r.append(mt.ui.searchRow(o,s,i.source_revision));return mt.invalidate(),{query:t,result_count:i.counts.matching_nodes+i.counts.matching_relations,results:[...qs.values()].map(s=>({id:s.id,label:vt(s.display.title||s.display.label),kind:s.kind_id||"relation",summary:vt(s.display.summary||s.display.statement)}))}},...us.handlers,"tos.page.clear-focus":()=>_i(()=>(mt.closeInspector(!1,!0),mt.overview(),{cleared:!0}))},qs=new Map;let Dc=null;for(const n of Object.keys(Vn.handlers)){const e=da[n];da[n]=(t,i)=>_i(()=>e(t,i))}oi=$d(()=>{const n=ha(mt.port.packet);return{mode:"philosophy",view_id:"observatory",graph_mode:"nodes",selected:jn(),path_start_node_id:us.startId,active_layers:n?[...n.sources]:["knowledge"],active_predicates:n?n.relations?n.predicates.length?[...n.predicates]:[...new Set(mt.port.packet.relations.map(e=>e.predicate_id))]:[]:["overview"],deep_link:location.href,research_workspace:Vn.workspace.summary()}},da);const S0=new Set(["tos.page.context","tos.page.cancel",...Object.keys(da)]);an.querySelector("#sc-query").addEventListener("input",()=>oi.notifyStateChange());const xa=Kd(oi,document,S0);xa.subscribeStatus(n=>Vn.agentStatus(n));xa.start();window.addEventListener("pagehide",()=>xa.stop());window.addEventListener("pageshow",n=>{n.persisted&&xa.start()});Sl.start().then(n=>{if(n)return;const e=new URLSearchParams(kd).get("selection");if(!e)return;const t=()=>{mt.port.packet&&(i.disconnect(),_i(()=>{mt.port.node(e)?mt.port.selectNode(e):mt.port.relation(e)&&mt.port.selectRelation(e)}))},i=new MutationObserver(t);i.observe(an,{attributes:!0,attributeFilter:["data-graph-revision"]}),t()});
