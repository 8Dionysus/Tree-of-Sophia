...
export const TOOL_IDS=['search','lenses','workspace','navigation','builder','evidence','sources'];
...
const panelIds=['inspector','workspace','evidence','navigation','builder','studio'];
