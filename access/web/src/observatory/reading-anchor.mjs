...
export const persistentReadingAnchorKey=value=>typeof value==='string'
  &&/^(?:(?:description|statement):\d{1,6}|form:(?:name|caption|hover|statement|grounds|history|technical):(?:heading|wording|language|metadata|(?:context|binding):\d{1,3}))$(?![\s\S])/.test(value);
