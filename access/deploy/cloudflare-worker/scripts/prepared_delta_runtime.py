...
def _build_prepared_delta_sql(db, before_db, after_db, target, *, expected_d1_revision,
    ...
    return {**lineage, 'target_d1_revision': revision, 'source_revision': header['source_revision'],
            ...
            'prepared_source_pairing_verified': not reconcile,
            'successor_prepared_source_pairing_verified': True,
            'predecessor_prepared_source_pairing_verified': not reconcile,
            'predecessor_source_admission_external': reconcile,
