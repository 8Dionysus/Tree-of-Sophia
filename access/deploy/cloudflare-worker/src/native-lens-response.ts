...
import {NATIVE_LENS_RESPONSE_BYTES, nativePacketJson, type NativeLensResult, type NativePacket} from './native-lens.ts';
...
export function nativePacketResponse(packet: NativePacket, status = 200, method = 'GET'): Response {
