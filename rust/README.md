...
fixtures. The `tos-workspace-probe` binary proves that a native crate can be
linked and installed outside the repository. It is not a Tree of Sophia reader
or release artifact.
...
compilation and native probe installation. It does not prove a released
reader, public adapter or production-scale runtime.
